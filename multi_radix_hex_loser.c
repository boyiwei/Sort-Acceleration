...
void multi_radix_hex_loser(int input[64][batch_size], int output[dataset_size]){
...
#pragma HLS UNROLL
    ...
    loser_tree(temp0, output);

}


void multi_radix_hex_loser_test(){
...
#include "/home/boyiw7/dataset_gen/dataset_1M_1.h"
	...
	multi_radix_hex_loser(input, output);
