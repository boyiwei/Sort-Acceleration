...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.single_heap_sort.autotvin_input_r.dat"
         "c.single_heap_sort.autotvin_output_r.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.single_heap_sort.autotvout_input_r.dat"
         "rtl.single_heap_sort.autotvout_output_r.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
