...
`define AUTOTB_DUT      single_heap_sort
`define AUTOTB_DUT_INST AESL_inst_single_heap_sort
`define AUTOTB_TOP      apatb_single_heap_sort_top
`define AUTOTB_LAT_RESULT_FILE "single_heap_sort.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "single_heap_sort.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_single_heap_sort_top
...
`define AUTOTB_TVIN_input_r_out_wrapc  "../tv/rtldatafile/rtl.single_heap_sort.autotvin_input_r.dat"
`define AUTOTB_TVIN_output_r_out_wrapc  "../tv/rtldatafile/rtl.single_heap_sort.autotvin_output_r.dat"
...
`define AUTOTB_TVOUT_input_r_out_wrapc  "../tv/rtldatafile/rtl.single_heap_sort.autotvout_input_r.dat"
`define AUTOTB_TVOUT_output_r_out_wrapc  "../tv/rtldatafile/rtl.single_heap_sort.autotvout_output_r.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = -1;
parameter LENGTH_input_r = 5000000;
parameter LENGTH_output_r = 5000000;
...
wire    [22 : 0]    arrayinput_r_address0, arrayinput_r_address1;
...
wire    [22 : 0]    arrayoutput_r_address0, arrayoutput_r_address1;
