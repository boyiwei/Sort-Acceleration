...
if {[file isfile single_heap_sort.autotvin.dat]} {
	file delete -force single_heap_sort.autotvin.dat
}

if {[file isfile single_heap_sort.autotvout.dat]} {
	file delete -force single_heap_sort.autotvout.dat
}
