...
// ==============================================================
# 1 "/home/boyiw7/sort_seperate_bucket/merge_sort.c"
# 1 "/home/boyiw7/sort_seperate_bucket/merge_sort.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 149 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/boyiw7/sort_seperate_bucket/merge_sort.c" 2
...
# 2 "/home/boyiw7/sort_seperate_bucket/merge_sort.c" 2
# 1 "/home/boyiw7/sort_seperate_bucket/dataset_size.h" 1
# 3 "/home/boyiw7/sort_seperate_bucket/merge_sort.c" 2
# 1 "/home/boyiw7/sort_seperate_bucket/merge_sort.h" 1

# 1 "/home/boyiw7/sort_seperate_bucket/dataset_size.h" 1
# 3 "/home/boyiw7/sort_seperate_bucket/merge_sort.h" 2
...
# 4 "/home/boyiw7/sort_seperate_bucket/merge_sort.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 5 "/home/boyiw7/sort_seperate_bucket/merge_sort.c" 2
...
void merge_sort(int input1[5000000/64], int input2[5000000/64], int sorted_data[2*5000000/64]){
 int j = 0;
 int k = 0;
 for(int i=0; i<2*5000000/64; i++){
  printf("i=%d, input1[%d] = %d, input2[%d]=%d\n", i, j, input1[j], k, input2[k]);
#pragma HLS PIPELINE
 if((j<5000000/64)&&(k<5000000/64)){
  ...
  else if((j==5000000/64)&&(k<5000000/64)){
   sorted_data[i] = input2[k];
   k = k + 1;
  }
  else{
...
void merge_arrays(int in[5000000/64], int width, int out[5000000/64]){
 int f1 = 0;
 int f2 = width;
 int i2 = width;
 int i3 = 2 * width;
...
#pragma HLS PIPELINE II=1
 int t1 = in[f1];
  ...
  if(f2==i3||(f1<i2&&t1<=t2)){
   ...
   ((void) sizeof ((f2<i3) ? 1 : 0), __extension__ ({ if (f2<i3) ; else __assert_fail ("f2<i3", "/home/boyiw7/sort_seperate_bucket/merge_sort.c", 63, __extension__ __PRETTY_FUNCTION__); }));
   out[i] = t2;
   f2++;
  }
  if(f1==i2 && f2==i3){
...
void merge_sort_parallel(int in[5000000/64], int out[5000000/64]){
#pragma HLS DATAFLOW

 int temp[24 -1][5000000/64];
#pragma HLS ARRAY_PARTITION variable=temp type=complete dim=1
 int width = 1;
 merge_arrays(in, width, temp[0]);
 width *= 2;

 for(int stage=1; stage<24 -1;stage++){
#pragma HLS UNROLL
 merge_arrays(temp[stage-1], width, temp[stage]);
  width *= 2;
 }
 merge_arrays(temp[24 -2], width, out);
}
...
void merge_sort_batch1(int input1[2*5000000/64], int input2[2*5000000/64], int sorted_data[4*5000000/64]){
    int j = 0;
    int k = 0;
    for(int i=0; i<4*5000000/64; i++){
#pragma HLS PIPELINE
 if((j<2*5000000/64)&&(k<2*5000000/64)){
            if(input1[j]<input2[k]){
                sorted_data[i] = input1[j];
                j = j + 1;
            }
        ...
        else if((j==2*5000000/64)&&(k<2*5000000/64)){
            sorted_data[i] = input2[k];
            k = k + 1;
        }
        else{
...
void merge_sort_batch2(int input1[4*5000000/64], int input2[4*5000000/64], int sorted_data[8*5000000/64]){
    int j = 0;
    int k = 0;
    for(int i=0; i<8*5000000/64; i++){
#pragma HLS PIPELINE
 if((j<4*5000000/64)&&(k<4*5000000/64)){
            if(input1[j]<input2[k]){
                sorted_data[i] = input1[j];
                j = j + 1;
            }
        ...
        else if((j==4*5000000/64)&&(k<4*5000000/64)){
            sorted_data[i] = input2[k];
            k = k + 1;
        }
        else{
...
void merge_sort_batch3(int input1[8*5000000/64], int input2[8*5000000/64], int sorted_data[16*5000000/64]){
    int j = 0;
    int k = 0;
    for(int i=0; i<16*5000000/64; i++){
#pragma HLS PIPELINE
 if((j<8*5000000/64)&&(k<8*5000000/64)){
            if(input1[j]<input2[k]){
                sorted_data[i] = input1[j];
                j = j + 1;
            }
        ...
        else if((j==8*5000000/64)&&(k<8*5000000/64)){
            sorted_data[i] = input2[k];
            k = k + 1;
        }
        else{
...
void merge_sort_batch4(int input1[16*5000000/64], int input2[16*5000000/64], int sorted_data[32*5000000/64]){
    int j = 0;
    int k = 0;
    for(int i=0; i<32*5000000/64; i++){
#pragma HLS PIPELINE
 if((j<16*5000000/64)&&(k<16*5000000/64)){
            if(input1[j]<input2[k]){
                sorted_data[i] = input1[j];
                j = j + 1;
            }
        ...
        else if((j==16*5000000/64)&&(k<16*5000000/64)){
            sorted_data[i] = input2[k];
            k = k + 1;
        }
        else{
...
void merge_sort_batch5(int input1[32*5000000/64], int input2[32*5000000/64], int sorted_data[5000000]){
    int j = 0;
    int k = 0;
    for(int i=0; i<5000000; i++){
#pragma HLS PIPELINE
 if((j<32*5000000/64)&&(k<32*5000000/64)){
            if(input1[j]<input2[k]){
                sorted_data[i] = input1[j];
                j = j + 1;
            }
        ...
        else if((j==32*5000000/64)&&(k<32*5000000/64)){
            sorted_data[i] = input2[k];
            k = k + 1;
        }
        else{
...
#pragma HLS UNROLL
 winner_index_stage4[j] = loser_tree[winner_index_stage3[2*j]] < loser_tree[winner_index_stage3[2*j+1]] ? winner_index_stage3[2*j] : winner_index_stage3[2*j+1];
   ...
   winner_value = loser_tree[winner_index];
        ...
        if (current_indices[input_index] < 5000000/64) {
