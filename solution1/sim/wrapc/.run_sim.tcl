...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "single_heap_sort.autotvin.dat"
	set constFileTvOut       "single_heap_sort.autotvout.dat"
	set constFileHdlTvIn     "single_heap_sort.autohdltvin.dat"
	set constFileHdlTvOut    "single_heap_sort.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
