set moduleName single_heap_sort_Pipeline_VITIS_LOOP_44_11
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {single_heap_sort_Pipeline_VITIS_LOOP_44_11}
set C_modelType { int 1 }
set C_modelArgList {
	{ j_1 int 23 regular  }
	{ input_r int 32 regular {array 5000000 { 2 2 } 1 1 }  }
	{ zext_ln79_1 int 23 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "j_1", "interface" : "wire", "bitwidth" : 23, "direction" : "READONLY"} , 
 	{ "Name" : "input_r", "interface" : "memory", "bitwidth" : 32, "direction" : "READWRITE"} , 
 	{ "Name" : "zext_ln79_1", "interface" : "wire", "bitwidth" : 23, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ j_1 sc_in sc_lv 23 signal 0 } 
	{ input_r_address0 sc_out sc_lv 23 signal 1 } 
	...
	{ input_r_address1 sc_out sc_lv 23 signal 1 } 
	{ input_r_ce1 sc_out sc_logic 1 signal 1 } 
	{ input_r_we1 sc_out sc_logic 1 signal 1 } 
	{ input_r_d1 sc_out sc_lv 32 signal 1 } 
	{ input_r_q1 sc_in sc_lv 32 signal 1 } 
	{ zext_ln79_1 sc_in sc_lv 23 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "j_1", "direction": "in", "datatype": "sc_lv", "bitwidth":23, "type": "signal", "bundle":{"name": "j_1", "role": "default" }} , 
 	...
 	{ "name": "zext_ln79_1", "direction": "in", "datatype": "sc_lv", "bitwidth":23, "type": "signal", "bundle":{"name": "zext_ln79_1", "role": "default" }} , 
 	{ "name": "ap_return", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "ap_return", "role": "default" }}  ]}

set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "single_heap_sort_Pipeline_VITIS_LOOP_44_11",
		"Protocol" : "ap_ctrl_hs",
		...
		"Port" : [
			...
			{"Name" : "zext_ln79_1", "Type" : "None", "Direction" : "I"}],
		"Loop" : [
...
set ArgLastReadFirstWriteLatency {
	single_heap_sort_Pipeline_VITIS_LOOP_44_11 {
		j_1 {Type I LastRead 0 FirstWrite -1}
		input_r {Type IO LastRead 4 FirstWrite 4}
		zext_ln79_1 {Type I LastRead 0 FirstWrite -1}}}
...
set Spec2ImplPortList { 
	j_1 { ap_none {  { j_1 in_data 0 23 } } }
	input_r { ap_memory {  { input_r_address0 mem_address 1 23 }  { input_r_ce0 mem_ce 1 1 }  { input_r_we0 mem_we 1 1 }  { input_r_d0 mem_din 1 32 }  { input_r_q0 in_data 0 32 }  { input_r_address1 MemPortADDR2 1 23 }  { input_r_ce1 MemPortCE2 1 1 }  { input_r_we1 MemPortWE2 1 1 }  { input_r_d1 MemPortDIN2 1 32 }  { input_r_q1 in_data 0 32 } } }
	zext_ln79_1 { ap_none {  { zext_ln79_1 in_data 0 23 } } }
}
