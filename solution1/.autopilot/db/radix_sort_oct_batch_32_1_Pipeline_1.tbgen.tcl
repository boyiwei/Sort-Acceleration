set moduleName radix_sort_oct_batch_32_1_Pipeline_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {radix_sort_oct_batch.32.1_Pipeline_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ bucket_sizes_2708_out int 32 regular {pointer 1}  }
	{ bucket_sizes_2707_out int 32 regular {pointer 1}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "bucket_sizes_2708_out", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "bucket_sizes_2707_out", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ bucket_sizes_2708_out sc_out sc_lv 32 signal 0 } 
	{ bucket_sizes_2708_out_ap_vld sc_out sc_logic 1 outvld 0 } 
	{ bucket_sizes_2707_out sc_out sc_lv 32 signal 1 } 
	{ bucket_sizes_2707_out_ap_vld sc_out sc_logic 1 outvld 1 } 
	{ bucket_sizes_2706_out sc_out sc_lv 32 signal 2 } 
	{ bucket_sizes_2706_out_ap_vld sc_out sc_logic 1 outvld 2 } 
	{ bucket_sizes_2705_out sc_out sc_lv 32 signal 3 } 
	{ bucket_sizes_2705_out_ap_vld sc_out sc_logic 1 outvld 3 } 
	{ bucket_sizes_2704_out sc_out sc_lv 32 signal 4 } 
	{ bucket_sizes_2704_out_ap_vld sc_out sc_logic 1 outvld 4 } 
	{ bucket_sizes_2703_out sc_out sc_lv 32 signal 5 } 
	{ bucket_sizes_2703_out_ap_vld sc_out sc_logic 1 outvld 5 } 
	{ bucket_sizes_2702_out sc_out sc_lv 32 signal 6 } 
	{ bucket_sizes_2702_out_ap_vld sc_out sc_logic 1 outvld 6 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "bucket_sizes_2708_out", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_sizes_2708_out", "role": "default" }} , 
 	{ "name": "bucket_sizes_2708_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "bucket_sizes_2708_out", "role": "ap_vld" }} , 
 	{ "name": "bucket_sizes_2707_out", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_sizes_2707_out", "role": "default" }} , 
 	{ "name": "bucket_sizes_2707_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "bucket_sizes_2707_out", "role": "ap_vld" }} , 
...
set Spec2ImplPortList { 
	bucket_sizes_2708_out { ap_vld {  { bucket_sizes_2708_out out_data 1 32 }  { bucket_sizes_2708_out_ap_vld out_vld 1 1 } } }
	bucket_sizes_2707_out { ap_vld {  { bucket_sizes_2707_out out_data 1 32 }  { bucket_sizes_2707_out_ap_vld out_vld 1 1 } } }
