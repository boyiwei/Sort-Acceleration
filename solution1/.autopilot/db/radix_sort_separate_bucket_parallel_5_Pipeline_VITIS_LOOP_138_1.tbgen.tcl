set moduleName radix_sort_separate_bucket_parallel_5_Pipeline_VITIS_LOOP_138_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {radix_sort_separate_bucket_parallel_5_Pipeline_VITIS_LOOP_138_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ sext_ln138 int 32 regular  }
	{ trunc_ln1 int 31 regular  }
	{ add_ln140 int 8 regular  }
	{ bucket0 int 32 regular {array 160 { 1 3 } 1 1 }  }
	{ sorted_data int 32 regular {array 50 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "sext_ln138", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "trunc_ln1", "interface" : "wire", "bitwidth" : 31, "direction" : "READONLY"} , 
 	{ "Name" : "add_ln140", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "bucket0", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln138 sc_in sc_lv 32 signal 0 } 
	{ trunc_ln1 sc_in sc_lv 31 signal 1 } 
	{ add_ln140 sc_in sc_lv 8 signal 2 } 
	{ bucket0_address0 sc_out sc_lv 8 signal 3 } 
	{ bucket0_ce0 sc_out sc_logic 1 signal 3 } 
	{ bucket0_q0 sc_in sc_lv 32 signal 3 } 
	{ sorted_data_address0 sc_out sc_lv 6 signal 4 } 
	{ sorted_data_ce0 sc_out sc_logic 1 signal 4 } 
	{ sorted_data_we0 sc_out sc_logic 1 signal 4 } 
	{ sorted_data_d0 sc_out sc_lv 32 signal 4 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln138", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "sext_ln138", "role": "default" }} , 
 	{ "name": "trunc_ln1", "direction": "in", "datatype": "sc_lv", "bitwidth":31, "type": "signal", "bundle":{"name": "trunc_ln1", "role": "default" }} , 
 	{ "name": "add_ln140", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "add_ln140", "role": "default" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "3", "Max" : "11"}
	, {"Name" : "Interval", "Min" : "3", "Max" : "11"}
]}
...
set Spec2ImplPortList { 
	sext_ln138 { ap_none {  { sext_ln138 in_data 0 32 } } }
	trunc_ln1 { ap_none {  { trunc_ln1 in_data 0 31 } } }
	add_ln140 { ap_none {  { add_ln140 in_data 0 8 } } }
	bucket0 { ap_memory {  { bucket0_address0 mem_address 1 8 }  { bucket0_ce0 mem_ce 1 1 }  { bucket0_q0 in_data 0 32 } } }
