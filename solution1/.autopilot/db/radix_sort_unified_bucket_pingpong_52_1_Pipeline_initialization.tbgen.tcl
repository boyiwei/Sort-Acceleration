set moduleName radix_sort_unified_bucket_pingpong_52_1_Pipeline_initialization
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {radix_sort_unified_bucket_pingpong.52.1_Pipeline_initialization}
...
set portList { 
	...
	{ input_51_address0 sc_out sc_lv 18 signal 17 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		"CDFG" : "radix_sort_unified_bucket_pingpong_52_1_Pipeline_initialization",
		"Protocol" : "ap_ctrl_hs",
...
set ArgLastReadFirstWriteLatency {
	radix_sort_unified_bucket_pingpong_52_1_Pipeline_initialization {
...
set Spec2ImplPortList { 
	...
	input_51 { ap_memory {  { input_51_address0 mem_address 1 18 }  { input_51_ce0 mem_ce 1 1 }  { input_51_q0 in_data 0 32 } } }
