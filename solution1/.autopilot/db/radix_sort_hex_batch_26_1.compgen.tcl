...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler multi_radix_hex_loser_radix_sort_hex_batch_26_1_bucket_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { multi_radix_hex_loser_temp0_25_address0 { O 14 vector } multi_radix_hex_loser_temp0_25_ce0 { O 1 bit } multi_radix_hex_loser_temp0_25_we0 { O 1 bit } multi_radix_hex_loser_temp0_25_d0 { O 32 vector } } \
} "
} else {
