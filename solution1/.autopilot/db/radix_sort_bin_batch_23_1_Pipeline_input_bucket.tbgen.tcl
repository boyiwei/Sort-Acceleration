set moduleName radix_sort_bin_batch_23_1_Pipeline_input_bucket
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {radix_sort_bin_batch.23.1_Pipeline_input_bucket}
set C_modelType { void 0 }
set C_modelArgList {
	{ bucket_sizes_713_reload int 32 regular  }
	{ bucket_sizes_712_reload int 32 regular  }
	...
	{ bucket_pointer_476_out int 32 regular {pointer 2}  }
	{ bucket_pointer_475_out int 32 regular {pointer 2}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "bucket_sizes_713_reload", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "bucket_sizes_712_reload", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "bucket_pointer_476_out", "interface" : "wire", "bitwidth" : 32, "direction" : "READWRITE"} , 
 	{ "Name" : "bucket_pointer_475_out", "interface" : "wire", "bitwidth" : 32, "direction" : "READWRITE"} ]}
...
set portList { 
	...
	{ bucket_sizes_713_reload sc_in sc_lv 32 signal 0 } 
	{ bucket_sizes_712_reload sc_in sc_lv 32 signal 1 } 
	{ bucket_pointer_474_reload sc_in sc_lv 32 signal 2 } 
	{ bucket_pointer_473_reload sc_in sc_lv 32 signal 3 } 
	...
	{ bucket_sizes_717_out_i sc_in sc_lv 32 signal 8 } 
	{ bucket_sizes_717_out_o sc_out sc_lv 32 signal 8 } 
	{ bucket_sizes_717_out_o_ap_vld sc_out sc_logic 1 outvld 8 } 
	{ bucket_sizes_716_out_i sc_in sc_lv 32 signal 9 } 
	{ bucket_sizes_716_out_o sc_out sc_lv 32 signal 9 } 
	{ bucket_sizes_716_out_o_ap_vld sc_out sc_logic 1 outvld 9 } 
	{ bucket_pointer_476_out_i sc_in sc_lv 32 signal 10 } 
	{ bucket_pointer_476_out_o sc_out sc_lv 32 signal 10 } 
	{ bucket_pointer_476_out_o_ap_vld sc_out sc_logic 1 outvld 10 } 
	{ bucket_pointer_475_out_i sc_in sc_lv 32 signal 11 } 
	{ bucket_pointer_475_out_o sc_out sc_lv 32 signal 11 } 
	{ bucket_pointer_475_out_o_ap_vld sc_out sc_logic 1 outvld 11 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "bucket_sizes_713_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_sizes_713_reload", "role": "default" }} , 
 	{ "name": "bucket_sizes_712_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_sizes_712_reload", "role": "default" }} , 
 	...
 	{ "name": "bucket_pointer_476_out_i", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_pointer_476_out", "role": "i" }} , 
 	{ "name": "bucket_pointer_476_out_o", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_pointer_476_out", "role": "o" }} , 
 	{ "name": "bucket_pointer_476_out_o_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "bucket_pointer_476_out", "role": "o_ap_vld" }} , 
 	{ "name": "bucket_pointer_475_out_i", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_pointer_475_out", "role": "i" }} , 
 	{ "name": "bucket_pointer_475_out_o", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_pointer_475_out", "role": "o" }} , 
 	{ "name": "bucket_pointer_475_out_o_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "bucket_pointer_475_out", "role": "o_ap_vld" }}  ]}

set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3"],
		"CDFG" : "radix_sort_bin_batch_23_1_Pipeline_input_bucket",
		"Protocol" : "ap_ctrl_hs",
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "bucket_sizes_713_reload", "Type" : "None", "Direction" : "I"},
			{"Name" : "bucket_sizes_712_reload", "Type" : "None", "Direction" : "I"},
			...
			{"Name" : "bucket_pointer_476_out", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "bucket_pointer_475_out", "Type" : "OVld", "Direction" : "IO"}],
		"Loop" : [
			{"Name" : "input_bucket", "PipelineType" : "UPC",
				"LoopDec" : {"FSMBitwidth" : "1", "FirstState" : "ap_ST_fsm_pp0_stage0", "FirstStateIter" : "ap_enable_reg_pp0_iter0", "FirstStateBlock" : "ap_block_pp0_stage0_subdone", "LastState" : "ap_ST_fsm_pp0_stage0", "LastStateIter" : "ap_enable_reg_pp0_iter1", "LastStateBlock" : "ap_block_pp0_stage0_subdone", "QuitState" : "ap_ST_fsm_pp0_stage0", "QuitStateIter" : "ap_enable_reg_pp0_iter0", "QuitStateBlock" : "ap_block_pp0_stage0_subdone", "OneDepthLoop" : "0", "has_ap_ctrl" : "1", "has_continue" : "0"}}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_21_32_1_1_U787", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_21_32_1_1_U788", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.flow_control_loop_pipe_sequential_init_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	radix_sort_bin_batch_23_1_Pipeline_input_bucket {
		bucket_sizes_713_reload {Type I LastRead 0 FirstWrite -1}
		bucket_sizes_712_reload {Type I LastRead 0 FirstWrite -1}
		...
		bucket_pointer_476_out {Type IO LastRead 1 FirstWrite 0}
		bucket_pointer_475_out {Type IO LastRead 1 FirstWrite 0}}}
...
set Spec2ImplPortList { 
	bucket_sizes_713_reload { ap_none {  { bucket_sizes_713_reload in_data 0 32 } } }
	bucket_sizes_712_reload { ap_none {  { bucket_sizes_712_reload in_data 0 32 } } }
	...
	bucket_pointer_476_out { ap_ovld {  { bucket_pointer_476_out_i in_data 0 32 }  { bucket_pointer_476_out_o out_data 1 32 }  { bucket_pointer_476_out_o_ap_vld out_vld 1 1 } } }
	bucket_pointer_475_out { ap_ovld {  { bucket_pointer_475_out_i in_data 0 32 }  { bucket_pointer_475_out_o out_data 1 32 }  { bucket_pointer_475_out_o_ap_vld out_vld 1 1 } } }
}
