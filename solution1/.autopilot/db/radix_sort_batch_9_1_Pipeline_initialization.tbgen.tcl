set moduleName radix_sort_batch_9_1_Pipeline_initialization
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {radix_sort_batch.9.1_Pipeline_initialization}
...
set portList { 
	...
	{ input_8_address0 sc_out sc_lv 14 signal 17 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		"CDFG" : "radix_sort_batch_9_1_Pipeline_initialization",
		"Protocol" : "ap_ctrl_hs",
...
set ArgLastReadFirstWriteLatency {
	radix_sort_batch_9_1_Pipeline_initialization {
