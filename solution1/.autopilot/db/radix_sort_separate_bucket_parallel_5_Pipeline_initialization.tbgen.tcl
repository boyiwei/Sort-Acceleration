set moduleName radix_sort_separate_bucket_parallel_5_Pipeline_initialization
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {radix_sort_separate_bucket_parallel_5_Pipeline_initialization}
