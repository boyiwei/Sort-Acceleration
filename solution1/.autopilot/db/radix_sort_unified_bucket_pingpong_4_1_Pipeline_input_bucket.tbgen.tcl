set moduleName radix_sort_unified_bucket_pingpong_4_1_Pipeline_input_bucket
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {radix_sort_unified_bucket_pingpong.4.1_Pipeline_input_bucket}
