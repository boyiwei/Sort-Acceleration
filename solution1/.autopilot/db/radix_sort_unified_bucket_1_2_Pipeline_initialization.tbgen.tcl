set moduleName radix_sort_unified_bucket_1_2_Pipeline_initialization
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {radix_sort_unified_bucket.1.2_Pipeline_initialization}
set C_modelType { void 0 }
set C_modelArgList {
	{ input_r int 32 regular {array 1000000 { 3 1 } 1 1 }  }
...
set portList { 
	...
	{ bucket_sizes_address0 sc_out sc_lv 4 signal 2 } 
	{ bucket_sizes_ce0 sc_out sc_logic 1 signal 2 } 
	{ bucket_sizes_we0 sc_out sc_logic 1 signal 2 } 
	{ bucket_sizes_d0 sc_out sc_lv 32 signal 2 } 
	{ bucket_sizes_address1 sc_out sc_lv 4 signal 2 } 
	{ bucket_sizes_ce1 sc_out sc_logic 1 signal 2 } 
	{ bucket_sizes_q1 sc_in sc_lv 32 signal 2 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	input_r { ap_memory {  { input_r_address1 MemPortADDR2 1 20 }  { input_r_ce1 MemPortCE2 1 1 }  { input_r_q1 in_data 0 32 } } }
