set moduleName radix_sort_bin_batch_17_1_Pipeline_initialization
set isTopModule 0
...
set portList { 
	...
	{ input_16_address0 sc_out sc_lv 18 signal 1 } 
	{ input_16_ce0 sc_out sc_logic 1 signal 1 } 
	{ input_16_q0 sc_in sc_lv 32 signal 1 } 
	{ bucket_sizes_811_out_i sc_in sc_lv 32 signal 2 } 
	{ bucket_sizes_811_out_o sc_out sc_lv 32 signal 2 } 
	{ bucket_sizes_811_out_o_ap_vld sc_out sc_logic 1 outvld 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "bucket_sizes_811_out_i", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_sizes_811_out", "role": "i" }} , 
 	{ "name": "bucket_sizes_811_out_o", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_sizes_811_out", "role": "o" }} , 
 	{ "name": "bucket_sizes_811_out_o_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "bucket_sizes_811_out", "role": "o_ap_vld" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		"CDFG" : "radix_sort_bin_batch_17_1_Pipeline_initialization",
		"Protocol" : "ap_ctrl_hs",
		...
		"Port" : [
			...
			{"Name" : "bucket_sizes_811_out", "Type" : "OVld", "Direction" : "IO"},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_21_32_1_1_U563", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.flow_control_loop_pipe_sequential_init_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	radix_sort_bin_batch_17_1_Pipeline_initialization {
		bucket {Type O LastRead -1 FirstWrite 1}
		input_16 {Type I LastRead 0 FirstWrite -1}
		bucket_sizes_811_out {Type IO LastRead 1 FirstWrite 0}
...
set Spec2ImplPortList { 
	...
	input_16 { ap_memory {  { input_16_address0 mem_address 1 18 }  { input_16_ce0 mem_ce 1 1 }  { input_16_q0 in_data 0 32 } } }
	bucket_sizes_811_out { ap_ovld {  { bucket_sizes_811_out_i in_data 0 32 }  { bucket_sizes_811_out_o out_data 1 32 }  { bucket_sizes_811_out_o_ap_vld out_vld 1 1 } } }
