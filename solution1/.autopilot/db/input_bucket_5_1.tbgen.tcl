set moduleName input_bucket_5_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {input_bucket_5.1}
set C_modelType { void 0 }
set C_modelArgList {
	{ i int 3 regular  }
	{ sorted_data int 32 regular {array 10 { 1 3 } 1 1 }  }
	{ bucket int 32 regular {array 160 { 0 3 } 0 1 }  }
...
set portList { 
	...
	{ sorted_data_address0 sc_out sc_lv 4 signal 1 } 
	{ sorted_data_ce0 sc_out sc_logic 1 signal 1 } 
	{ sorted_data_q0 sc_in sc_lv 32 signal 1 } 
	{ bucket_address0 sc_out sc_lv 8 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sorted_data_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "sorted_data", "role": "address0" }} , 
 	...
 	{ "name": "bucket_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "bucket", "role": "address0" }} , 
...
set Spec2ImplPortList { 
	...
	sorted_data { ap_memory {  { sorted_data_address0 mem_address 1 4 }  { sorted_data_ce0 mem_ce 1 1 }  { sorted_data_q0 in_data 0 32 } } }
	bucket { ap_memory {  { bucket_address0 mem_address 1 8 }  { bucket_ce0 mem_ce 1 1 }  { bucket_we0 mem_we 1 1 }  { bucket_d0 mem_din 1 32 } } }
