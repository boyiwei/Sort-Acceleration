...
__attribute__((sdx_kernel("merge_sort", 0))) void merge_sort(int input1[batch_size], int input2[batch_size], int sorted_data[2*batch_size]){
#line 17 "/home/boyiw7/sort_seperate_bucket/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=merge_sort
# 9 "sort_seperate_bucket/merge_sort.c"

 int j = 0;
 int k = 0;
 VITIS_LOOP_12_1: for(int i=0; i<2*batch_size; i++){
#pragma HLS PIPELINE
