...
void radix_sort_batch(int input[5000000/64], int output[5000000/64]);
...
__attribute__((sdx_kernel("multi_radix_oct_kmerge", 0))) void multi_radix_oct_kmerge(int input[64][5000000/64], int output[5000000]){
