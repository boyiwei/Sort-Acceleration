set moduleName radix_sort_bin_batch_26_1_Pipeline_bucket_pointer_initialization
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {radix_sort_bin_batch.26.1_Pipeline_bucket_pointer_initialization}
set C_modelType { void 0 }
set C_modelArgList {
	{ bucket_sizes_666 int 32 regular  }
	{ bucket_sizes_665 int 32 regular  }
	{ bucket_pointer_441 int 32 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "bucket_sizes_666", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "bucket_sizes_665", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "bucket_pointer_441", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ bucket_sizes_666 sc_in sc_lv 32 signal 0 } 
	{ bucket_sizes_665 sc_in sc_lv 32 signal 1 } 
	{ bucket_pointer_441 sc_in sc_lv 32 signal 2 } 
	{ bucket_pointer sc_in sc_lv 32 signal 3 } 
	{ bucket_sizes_668_out sc_out sc_lv 32 signal 4 } 
	{ bucket_sizes_668_out_ap_vld sc_out sc_logic 1 outvld 4 } 
	{ bucket_sizes_667_out sc_out sc_lv 32 signal 5 } 
	{ bucket_sizes_667_out_ap_vld sc_out sc_logic 1 outvld 5 } 
	{ bucket_pointer_444_out sc_out sc_lv 32 signal 6 } 
	{ bucket_pointer_444_out_ap_vld sc_out sc_logic 1 outvld 6 } 
	{ bucket_pointer_443_out sc_out sc_lv 32 signal 7 } 
	{ bucket_pointer_443_out_ap_vld sc_out sc_logic 1 outvld 7 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "bucket_sizes_666", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_sizes_666", "role": "default" }} , 
 	{ "name": "bucket_sizes_665", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_sizes_665", "role": "default" }} , 
 	{ "name": "bucket_pointer_441", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_pointer_441", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_21_32_1_1_U883", "Parent" : "0"},
...
set Spec2ImplPortList { 
	bucket_sizes_666 { ap_none {  { bucket_sizes_666 in_data 0 32 } } }
	bucket_sizes_665 { ap_none {  { bucket_sizes_665 in_data 0 32 } } }
	bucket_pointer_441 { ap_none {  { bucket_pointer_441 in_data 0 32 } } }
