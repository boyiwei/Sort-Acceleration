...
set C_modelArgList {
	...
	{ multi_radix_oct_kmerge_temp0_24 int 32 regular {array 78125 { 0 3 } 0 1 } {global 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "input_24", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "multi_radix_oct_kmerge_temp0_24", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ input_24_address0 sc_out sc_lv 17 signal 0 } 
	{ input_24_ce0 sc_out sc_logic 1 signal 0 } 
	{ input_24_q0 sc_in sc_lv 32 signal 0 } 
	{ multi_radix_oct_kmerge_temp0_24_address0 sc_out sc_lv 17 signal 1 } 
	{ multi_radix_oct_kmerge_temp0_24_ce0 sc_out sc_logic 1 signal 1 } 
	{ multi_radix_oct_kmerge_temp0_24_we0 sc_out sc_logic 1 signal 1 } 
	{ multi_radix_oct_kmerge_temp0_24_d0 sc_out sc_lv 32 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "multi_radix_oct_kmerge_temp0_24_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":17, "type": "signal", "bundle":{"name": "multi_radix_oct_kmerge_temp0_24", "role": "address0" }} , 
 	{ "name": "multi_radix_oct_kmerge_temp0_24_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "multi_radix_oct_kmerge_temp0_24", "role": "ce0" }} , 
 	{ "name": "multi_radix_oct_kmerge_temp0_24_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "multi_radix_oct_kmerge_temp0_24", "role": "we0" }} , 
 	{ "name": "multi_radix_oct_kmerge_temp0_24_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "multi_radix_oct_kmerge_temp0_24", "role": "d0" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "4", "7", "10", "12", "16", "17"],
		...
		"Port" : [
			...
			{"Name" : "multi_radix_oct_kmerge_temp0_24", "Type" : "Memory", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0",
				"SubConnect" : [
					{"ID" : "10", "SubInstance" : "grp_radix_sort_oct_batch_25_1_Pipeline_output_bucket_fu_291", "Port" : "multi_radix_oct_kmerge_temp0_24", "Inst_start_state" : "5", "Inst_end_state" : "10"}]}],
		"Loop" : [
	...
	{"ID" : "10", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_radix_sort_oct_batch_25_1_Pipeline_output_bucket_fu_291", "Parent" : "0", "Child" : ["11"],
		...
		"Port" : [
			...
			{"Name" : "multi_radix_oct_kmerge_temp0_24", "Type" : "Memory", "Direction" : "O"}],
		"Loop" : [
	...
	{"ID" : "16", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_mul_18s_17ns_18_4_1_U2623", "Parent" : "0"},
	{"ID" : "17", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_mul_18s_17ns_18_4_1_U2624", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	radix_sort_oct_batch_25_1 {
		input_24 {Type I LastRead 0 FirstWrite -1}
		multi_radix_oct_kmerge_temp0_24 {Type O LastRead -1 FirstWrite 1}}
...
set Spec2ImplPortList { 
	input_24 { ap_memory {  { input_24_address0 mem_address 1 17 }  { input_24_ce0 mem_ce 1 1 }  { input_24_q0 mem_dout 0 32 } } }
	multi_radix_oct_kmerge_temp0_24 { ap_memory {  { multi_radix_oct_kmerge_temp0_24_address0 mem_address 1 17 }  { multi_radix_oct_kmerge_temp0_24_ce0 mem_ce 1 1 }  { multi_radix_oct_kmerge_temp0_24_we0 mem_we 1 1 }  { multi_radix_oct_kmerge_temp0_24_d0 mem_din 1 32 } } }
}
