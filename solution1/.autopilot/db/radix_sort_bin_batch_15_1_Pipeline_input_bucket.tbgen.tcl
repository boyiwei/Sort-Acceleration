set moduleName radix_sort_bin_batch_15_1_Pipeline_input_bucket
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {radix_sort_bin_batch.15.1_Pipeline_input_bucket}
set C_modelType { void 0 }
set C_modelArgList {
	{ bucket_sizes_848_reload int 32 regular  }
	{ bucket_sizes_847_reload int 32 regular  }
	{ bucket_pointer_564_reload int 32 regular  }
	{ bucket_pointer_563_reload int 32 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "bucket_sizes_848_reload", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "bucket_pointer_564_reload", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "bucket_pointer_563_reload", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ bucket_sizes_848_reload sc_in sc_lv 32 signal 0 } 
	{ bucket_sizes_847_reload sc_in sc_lv 32 signal 1 } 
	{ bucket_pointer_564_reload sc_in sc_lv 32 signal 2 } 
	{ bucket_pointer_563_reload sc_in sc_lv 32 signal 3 } 
	...
	{ bucket_sizes_852_out_i sc_in sc_lv 32 signal 8 } 
	{ bucket_sizes_852_out_o sc_out sc_lv 32 signal 8 } 
	{ bucket_sizes_852_out_o_ap_vld sc_out sc_logic 1 outvld 8 } 
	{ bucket_sizes_851_out_i sc_in sc_lv 32 signal 9 } 
	{ bucket_sizes_851_out_o sc_out sc_lv 32 signal 9 } 
	{ bucket_sizes_851_out_o_ap_vld sc_out sc_logic 1 outvld 9 } 
	{ bucket_pointer_566_out_i sc_in sc_lv 32 signal 10 } 
	{ bucket_pointer_566_out_o sc_out sc_lv 32 signal 10 } 
	{ bucket_pointer_566_out_o_ap_vld sc_out sc_logic 1 outvld 10 } 
	{ bucket_pointer_565_out_i sc_in sc_lv 32 signal 11 } 
	{ bucket_pointer_565_out_o sc_out sc_lv 32 signal 11 } 
	{ bucket_pointer_565_out_o_ap_vld sc_out sc_logic 1 outvld 11 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "bucket_pointer_564_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_pointer_564_reload", "role": "default" }} , 
 	{ "name": "bucket_pointer_563_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_pointer_563_reload", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3"],
		"CDFG" : "radix_sort_bin_batch_15_1_Pipeline_input_bucket",
		"Protocol" : "ap_ctrl_hs",
		...
		"Port" : [
			...
			{"Name" : "bucket_pointer_564_reload", "Type" : "None", "Direction" : "I"},
			{"Name" : "bucket_pointer_563_reload", "Type" : "None", "Direction" : "I"},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_21_32_1_1_U507", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_21_32_1_1_U508", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.flow_control_loop_pipe_sequential_init_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	radix_sort_bin_batch_15_1_Pipeline_input_bucket {
		bucket_sizes_848_reload {Type I LastRead 0 FirstWrite -1}
		bucket_sizes_847_reload {Type I LastRead 0 FirstWrite -1}
		bucket_pointer_564_reload {Type I LastRead 0 FirstWrite -1}
		bucket_pointer_563_reload {Type I LastRead 0 FirstWrite -1}
...
set Spec2ImplPortList { 
	...
	bucket_pointer_564_reload { ap_none {  { bucket_pointer_564_reload in_data 0 32 } } }
	bucket_pointer_563_reload { ap_none {  { bucket_pointer_563_reload in_data 0 32 } } }
