...
define void @apatb_merge_sort_ir(i32* noalias nocapture nonnull readonly %input1, i32* noalias nocapture nonnull readonly %input2, i32* noalias nocapture nonnull %sorted_data) local_unnamed_addr #0 {
entry:
  %input1_copy = alloca i32, align 512
  %input2_copy = alloca i32, align 512
  %sorted_data_copy = alloca i32, align 512
  call fastcc void @copy_in(i32* nonnull %input1, i32* nonnull align 512 %input1_copy, i32* nonnull %input2, i32* nonnull align 512 %input2_copy, i32* nonnull %sorted_data, i32* nonnull align 512 %sorted_data_copy)
  call void @copy_back(i32* %input1, i32* %input1_copy, i32* %input2, i32* %input2_copy, i32* %sorted_data, i32* %sorted_data_copy)
  ret void
}
