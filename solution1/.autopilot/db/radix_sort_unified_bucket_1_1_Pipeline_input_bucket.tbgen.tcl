set moduleName radix_sort_unified_bucket_1_1_Pipeline_input_bucket
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {radix_sort_unified_bucket.1.1_Pipeline_input_bucket}
...
set C_modelArgMapList {[ 
	{ "Name" : "sorted_data", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln39", "interface" : "wire", "bitwidth" : 5, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ bucket_sizes_address0 sc_out sc_lv 4 signal 4 } 
	{ bucket_sizes_ce0 sc_out sc_logic 1 signal 4 } 
	{ bucket_sizes_we0 sc_out sc_logic 1 signal 4 } 
	{ bucket_sizes_d0 sc_out sc_lv 32 signal 4 } 
	{ bucket_sizes_address1 sc_out sc_lv 4 signal 4 } 
	{ bucket_sizes_ce1 sc_out sc_logic 1 signal 4 } 
	{ bucket_sizes_q1 sc_in sc_lv 32 signal 4 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln39", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "zext_ln39", "role": "default" }} , 
 	...
 	{ "name": "bucket_sizes_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "bucket_sizes", "role": "address1" }} , 
 	{ "name": "bucket_sizes_ce1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "bucket_sizes", "role": "ce1" }} , 
 	{ "name": "bucket_sizes_q1", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_sizes", "role": "q1" }}  ]}
