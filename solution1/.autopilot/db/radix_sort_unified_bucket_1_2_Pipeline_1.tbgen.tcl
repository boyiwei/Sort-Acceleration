set moduleName radix_sort_unified_bucket_1_2_Pipeline_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {radix_sort_unified_bucket.1.2_Pipeline_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ bucket_sizes int 32 regular {array 16 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "bucket_sizes", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ bucket_sizes_address0 sc_out sc_lv 4 signal 0 } 
	{ bucket_sizes_ce0 sc_out sc_logic 1 signal 0 } 
	{ bucket_sizes_we0 sc_out sc_logic 1 signal 0 } 
	{ bucket_sizes_d0 sc_out sc_lv 32 signal 0 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	bucket_sizes { ap_memory {  { bucket_sizes_address0 mem_address 1 4 }  { bucket_sizes_ce0 mem_ce 1 1 }  { bucket_sizes_we0 mem_we 1 1 }  { bucket_sizes_d0 mem_din 1 32 } } }
}
