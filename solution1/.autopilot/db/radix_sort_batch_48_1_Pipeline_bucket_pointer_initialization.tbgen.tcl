set moduleName radix_sort_batch_48_1_Pipeline_bucket_pointer_initialization
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {radix_sort_batch.48.1_Pipeline_bucket_pointer_initialization}
set C_modelType { void 0 }
set C_modelArgList {
	{ bucket_sizes_2980 int 32 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "bucket_sizes_2980", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ bucket_sizes_2980 sc_in sc_lv 32 signal 0 } 
	{ bucket_sizes_2979 sc_in sc_lv 32 signal 1 } 
	{ bucket_sizes_2978 sc_in sc_lv 32 signal 2 } 
	{ bucket_sizes_2977 sc_in sc_lv 32 signal 3 } 
	{ bucket_sizes_2976 sc_in sc_lv 32 signal 4 } 
	{ bucket_sizes_2975 sc_in sc_lv 32 signal 5 } 
	{ bucket_sizes_2974 sc_in sc_lv 32 signal 6 } 
	{ bucket_sizes_2973 sc_in sc_lv 32 signal 7 } 
	{ bucket_sizes_2972 sc_in sc_lv 32 signal 8 } 
	{ bucket_sizes_2971 sc_in sc_lv 32 signal 9 } 
	{ bucket_sizes_2970 sc_in sc_lv 32 signal 10 } 
	{ bucket_sizes_2969 sc_in sc_lv 32 signal 11 } 
	{ bucket_sizes_2968 sc_in sc_lv 32 signal 12 } 
	{ bucket_sizes_2967 sc_in sc_lv 32 signal 13 } 
	{ bucket_sizes_2966 sc_in sc_lv 32 signal 14 } 
	{ bucket_sizes_2965 sc_in sc_lv 32 signal 15 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "bucket_sizes_2980", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_sizes_2980", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		"CDFG" : "radix_sort_batch_48_1_Pipeline_bucket_pointer_initialization",
		"Protocol" : "ap_ctrl_hs",
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "bucket_sizes_2980", "Type" : "None", "Direction" : "I"},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_164_32_1_1_U9125", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.flow_control_loop_pipe_sequential_init_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	radix_sort_batch_48_1_Pipeline_bucket_pointer_initialization {
		bucket_sizes_2980 {Type I LastRead 0 FirstWrite -1}
...
set Spec2ImplPortList { 
	bucket_sizes_2980 { ap_none {  { bucket_sizes_2980 in_data 0 32 } } }
