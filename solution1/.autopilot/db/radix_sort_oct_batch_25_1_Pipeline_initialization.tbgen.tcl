set moduleName radix_sort_oct_batch_25_1_Pipeline_initialization
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {radix_sort_oct_batch.25.1_Pipeline_initialization}
set C_modelType { void 0 }
set C_modelArgList {
	{ bucket_sizes_3292_reload int 32 regular  }
	{ bucket_sizes_3291_reload int 32 regular  }
	{ bucket_sizes_3290_reload int 32 regular  }
	{ bucket_sizes_3289_reload int 32 regular  }
	{ bucket_sizes_3288_reload int 32 regular  }
	{ bucket_sizes_3287_reload int 32 regular  }
	...
	{ bucket_sizes_3302_out int 32 regular {pointer 2}  }
	{ bucket_sizes_3301_out int 32 regular {pointer 2}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "bucket_sizes_3292_reload", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "bucket_sizes_3291_reload", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "bucket_sizes_3290_reload", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "bucket_sizes_3289_reload", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "bucket_sizes_3288_reload", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "bucket_sizes_3287_reload", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "bucket_sizes_3302_out", "interface" : "wire", "bitwidth" : 32, "direction" : "READWRITE"} , 
 	{ "Name" : "bucket_sizes_3301_out", "interface" : "wire", "bitwidth" : 32, "direction" : "READWRITE"} ]}
...
set portList { 
	...
	{ bucket_sizes_3292_reload sc_in sc_lv 32 signal 0 } 
	{ bucket_sizes_3291_reload sc_in sc_lv 32 signal 1 } 
	{ bucket_sizes_3290_reload sc_in sc_lv 32 signal 2 } 
	{ bucket_sizes_3289_reload sc_in sc_lv 32 signal 3 } 
	{ bucket_sizes_3288_reload sc_in sc_lv 32 signal 4 } 
	{ bucket_sizes_3287_reload sc_in sc_lv 32 signal 5 } 
	{ bucket_sizes_3286_reload sc_in sc_lv 32 signal 6 } 
	...
	{ input_24_address0 sc_out sc_lv 18 signal 9 } 
	{ input_24_ce0 sc_out sc_logic 1 signal 9 } 
	{ input_24_q0 sc_in sc_lv 32 signal 9 } 
	{ bucket_sizes_3308_out_i sc_in sc_lv 32 signal 10 } 
	{ bucket_sizes_3308_out_o sc_out sc_lv 32 signal 10 } 
	{ bucket_sizes_3308_out_o_ap_vld sc_out sc_logic 1 outvld 10 } 
	{ bucket_sizes_3307_out_i sc_in sc_lv 32 signal 11 } 
	{ bucket_sizes_3307_out_o sc_out sc_lv 32 signal 11 } 
	{ bucket_sizes_3307_out_o_ap_vld sc_out sc_logic 1 outvld 11 } 
	{ bucket_sizes_3306_out_i sc_in sc_lv 32 signal 12 } 
	{ bucket_sizes_3306_out_o sc_out sc_lv 32 signal 12 } 
	{ bucket_sizes_3306_out_o_ap_vld sc_out sc_logic 1 outvld 12 } 
	{ bucket_sizes_3305_out_i sc_in sc_lv 32 signal 13 } 
	{ bucket_sizes_3305_out_o sc_out sc_lv 32 signal 13 } 
	{ bucket_sizes_3305_out_o_ap_vld sc_out sc_logic 1 outvld 13 } 
	{ bucket_sizes_3304_out_i sc_in sc_lv 32 signal 14 } 
	{ bucket_sizes_3304_out_o sc_out sc_lv 32 signal 14 } 
	{ bucket_sizes_3304_out_o_ap_vld sc_out sc_logic 1 outvld 14 } 
	{ bucket_sizes_3303_out_i sc_in sc_lv 32 signal 15 } 
	{ bucket_sizes_3303_out_o sc_out sc_lv 32 signal 15 } 
	{ bucket_sizes_3303_out_o_ap_vld sc_out sc_logic 1 outvld 15 } 
	{ bucket_sizes_3302_out_i sc_in sc_lv 32 signal 16 } 
	{ bucket_sizes_3302_out_o sc_out sc_lv 32 signal 16 } 
	{ bucket_sizes_3302_out_o_ap_vld sc_out sc_logic 1 outvld 16 } 
	{ bucket_sizes_3301_out_i sc_in sc_lv 32 signal 17 } 
	{ bucket_sizes_3301_out_o sc_out sc_lv 32 signal 17 } 
	{ bucket_sizes_3301_out_o_ap_vld sc_out sc_logic 1 outvld 17 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "bucket_sizes_3292_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_sizes_3292_reload", "role": "default" }} , 
 	{ "name": "bucket_sizes_3291_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_sizes_3291_reload", "role": "default" }} , 
 	{ "name": "bucket_sizes_3290_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_sizes_3290_reload", "role": "default" }} , 
 	{ "name": "bucket_sizes_3289_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_sizes_3289_reload", "role": "default" }} , 
 	{ "name": "bucket_sizes_3288_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_sizes_3288_reload", "role": "default" }} , 
 	{ "name": "bucket_sizes_3287_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_sizes_3287_reload", "role": "default" }} , 
 	...
 	{ "name": "bucket_sizes_3302_out_i", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_sizes_3302_out", "role": "i" }} , 
 	{ "name": "bucket_sizes_3302_out_o", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_sizes_3302_out", "role": "o" }} , 
 	{ "name": "bucket_sizes_3302_out_o_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "bucket_sizes_3302_out", "role": "o_ap_vld" }} , 
 	{ "name": "bucket_sizes_3301_out_i", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_sizes_3301_out", "role": "i" }} , 
 	{ "name": "bucket_sizes_3301_out_o", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_sizes_3301_out", "role": "o" }} , 
 	{ "name": "bucket_sizes_3301_out_o_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "bucket_sizes_3301_out", "role": "o_ap_vld" }}  ]}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_83_32_1_1_U2531", "Parent" : "0"},
...
set Spec2ImplPortList { 
	bucket_sizes_3292_reload { ap_none {  { bucket_sizes_3292_reload in_data 0 32 } } }
	bucket_sizes_3291_reload { ap_none {  { bucket_sizes_3291_reload in_data 0 32 } } }
	bucket_sizes_3290_reload { ap_none {  { bucket_sizes_3290_reload in_data 0 32 } } }
	bucket_sizes_3289_reload { ap_none {  { bucket_sizes_3289_reload in_data 0 32 } } }
	bucket_sizes_3288_reload { ap_none {  { bucket_sizes_3288_reload in_data 0 32 } } }
	bucket_sizes_3287_reload { ap_none {  { bucket_sizes_3287_reload in_data 0 32 } } }
	...
	input_24 { ap_memory {  { input_24_address0 mem_address 1 18 }  { input_24_ce0 mem_ce 1 1 }  { input_24_q0 in_data 0 32 } } }
	...
	bucket_sizes_3302_out { ap_ovld {  { bucket_sizes_3302_out_i in_data 0 32 }  { bucket_sizes_3302_out_o out_data 1 32 }  { bucket_sizes_3302_out_o_ap_vld out_vld 1 1 } } }
	bucket_sizes_3301_out { ap_ovld {  { bucket_sizes_3301_out_i in_data 0 32 }  { bucket_sizes_3301_out_o out_data 1 32 }  { bucket_sizes_3301_out_o_ap_vld out_vld 1 1 } } }
}
