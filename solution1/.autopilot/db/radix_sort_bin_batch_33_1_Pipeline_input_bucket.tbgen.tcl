set moduleName radix_sort_bin_batch_33_1_Pipeline_input_bucket
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {radix_sort_bin_batch.33.1_Pipeline_input_bucket}
set C_modelType { void 0 }
set C_modelArgList {
	{ bucket_sizes_548_reload int 32 regular  }
	{ bucket_sizes_547_reload int 32 regular  }
	{ bucket_pointer_364_reload int 32 regular  }
	{ bucket_pointer_363_reload int 32 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "bucket_sizes_548_reload", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "bucket_sizes_547_reload", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "bucket_pointer_364_reload", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "bucket_pointer_363_reload", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ bucket_sizes_548_reload sc_in sc_lv 32 signal 0 } 
	{ bucket_sizes_547_reload sc_in sc_lv 32 signal 1 } 
	{ bucket_pointer_364_reload sc_in sc_lv 32 signal 2 } 
	{ bucket_pointer_363_reload sc_in sc_lv 32 signal 3 } 
	...
	{ bucket_sizes_552_out_i sc_in sc_lv 32 signal 8 } 
	{ bucket_sizes_552_out_o sc_out sc_lv 32 signal 8 } 
	{ bucket_sizes_552_out_o_ap_vld sc_out sc_logic 1 outvld 8 } 
	{ bucket_sizes_551_out_i sc_in sc_lv 32 signal 9 } 
	{ bucket_sizes_551_out_o sc_out sc_lv 32 signal 9 } 
	{ bucket_sizes_551_out_o_ap_vld sc_out sc_logic 1 outvld 9 } 
	{ bucket_pointer_366_out_i sc_in sc_lv 32 signal 10 } 
	{ bucket_pointer_366_out_o sc_out sc_lv 32 signal 10 } 
	{ bucket_pointer_366_out_o_ap_vld sc_out sc_logic 1 outvld 10 } 
	{ bucket_pointer_365_out_i sc_in sc_lv 32 signal 11 } 
	{ bucket_pointer_365_out_o sc_out sc_lv 32 signal 11 } 
	{ bucket_pointer_365_out_o_ap_vld sc_out sc_logic 1 outvld 11 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "bucket_sizes_548_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_sizes_548_reload", "role": "default" }} , 
 	{ "name": "bucket_sizes_547_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_sizes_547_reload", "role": "default" }} , 
 	{ "name": "bucket_pointer_364_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_pointer_364_reload", "role": "default" }} , 
 	{ "name": "bucket_pointer_363_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_pointer_363_reload", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_21_32_1_1_U1137", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_21_32_1_1_U1138", "Parent" : "0"},
...
set Spec2ImplPortList { 
	bucket_sizes_548_reload { ap_none {  { bucket_sizes_548_reload in_data 0 32 } } }
	bucket_sizes_547_reload { ap_none {  { bucket_sizes_547_reload in_data 0 32 } } }
	bucket_pointer_364_reload { ap_none {  { bucket_pointer_364_reload in_data 0 32 } } }
	bucket_pointer_363_reload { ap_none {  { bucket_pointer_363_reload in_data 0 32 } } }
