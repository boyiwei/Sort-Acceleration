...
void radix_sort_seperate_bucket(int data[10000000], int sorted_data[10000000]);

void radix_sort_unified_bucket(int data[10000000], int sorted_data[10000000]);
...
void sort_top(int input[2][10000000], int output[2*10000000]){
 printf("batch_size = %d\n", 10000000/2);
 int half_sorted0[10000000];
 int half_sorted1[10000000];
