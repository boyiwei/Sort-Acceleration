...
void maxHeapify(int arr[1000000], int n, int i) {
...
void heap_sort(int input[1000000], int output[1000000]) {
 int data[1000000];
 int i = 0;
 int j = 0;
 initialization:
...
#pragma HLS PIPELINE
 ...
 heap_sort_procedure:
    ...
    for (i = 1000000 / 2 - 1; i >= 0; i--)
        maxHeapify(data, 1000000, i);


    VITIS_LOOP_59_1: for (j = 1000000 - 1; j >= 0; j--) {
