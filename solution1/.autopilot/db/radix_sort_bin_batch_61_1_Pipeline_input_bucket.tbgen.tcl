set moduleName radix_sort_bin_batch_61_1_Pipeline_input_bucket
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {radix_sort_bin_batch.61.1_Pipeline_input_bucket}
set C_modelType { void 0 }
set C_modelArgList {
	{ bucket_sizes_83_reload int 32 regular  }
	{ bucket_sizes_82_reload int 32 regular  }
	{ bucket_pointer_54_reload int 32 regular  }
	{ bucket_pointer_53_reload int 32 regular  }
	{ mul_ln41 int 19 regular  }
	{ bucket int 32 regular {array 312500 { 0 1 } 1 1 }  }
	{ zext_ln27 int 5 regular  }
	{ mul_ln43 int 19 regular  }
	{ bucket_sizes_87_out int 32 regular {pointer 2}  }
	{ bucket_sizes_86_out int 32 regular {pointer 2}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "bucket_sizes_83_reload", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "bucket_pointer_54_reload", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "bucket_pointer_53_reload", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "bucket_sizes_87_out", "interface" : "wire", "bitwidth" : 32, "direction" : "READWRITE"} , 
 	{ "Name" : "bucket_sizes_86_out", "interface" : "wire", "bitwidth" : 32, "direction" : "READWRITE"} , 
...
set portList { 
	...
	{ bucket_sizes_83_reload sc_in sc_lv 32 signal 0 } 
	{ bucket_sizes_82_reload sc_in sc_lv 32 signal 1 } 
	{ bucket_pointer_54_reload sc_in sc_lv 32 signal 2 } 
	{ bucket_pointer_53_reload sc_in sc_lv 32 signal 3 } 
	...
	{ bucket_sizes_87_out_i sc_in sc_lv 32 signal 8 } 
	{ bucket_sizes_87_out_o sc_out sc_lv 32 signal 8 } 
	{ bucket_sizes_87_out_o_ap_vld sc_out sc_logic 1 outvld 8 } 
	{ bucket_sizes_86_out_i sc_in sc_lv 32 signal 9 } 
	{ bucket_sizes_86_out_o sc_out sc_lv 32 signal 9 } 
	{ bucket_sizes_86_out_o_ap_vld sc_out sc_logic 1 outvld 9 } 
	{ bucket_pointer_56_out_i sc_in sc_lv 32 signal 10 } 
	{ bucket_pointer_56_out_o sc_out sc_lv 32 signal 10 } 
	{ bucket_pointer_56_out_o_ap_vld sc_out sc_logic 1 outvld 10 } 
	{ bucket_pointer_55_out_i sc_in sc_lv 32 signal 11 } 
	{ bucket_pointer_55_out_o sc_out sc_lv 32 signal 11 } 
	{ bucket_pointer_55_out_o_ap_vld sc_out sc_logic 1 outvld 11 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "bucket_pointer_54_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_pointer_54_reload", "role": "default" }} , 
 	{ "name": "bucket_pointer_53_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_pointer_53_reload", "role": "default" }} , 
 	...
 	{ "name": "bucket_sizes_87_out_i", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_sizes_87_out", "role": "i" }} , 
 	{ "name": "bucket_sizes_87_out_o", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_sizes_87_out", "role": "o" }} , 
 	{ "name": "bucket_sizes_87_out_o_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "bucket_sizes_87_out", "role": "o_ap_vld" }} , 
 	{ "name": "bucket_sizes_86_out_i", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_sizes_86_out", "role": "i" }} , 
 	{ "name": "bucket_sizes_86_out_o", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_sizes_86_out", "role": "o" }} , 
 	{ "name": "bucket_sizes_86_out_o_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "bucket_sizes_86_out", "role": "o_ap_vld" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_21_32_1_1_U2117", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_21_32_1_1_U2118", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	bucket_pointer_54_reload { ap_none {  { bucket_pointer_54_reload in_data 0 32 } } }
	bucket_pointer_53_reload { ap_none {  { bucket_pointer_53_reload in_data 0 32 } } }
	...
	bucket_sizes_87_out { ap_ovld {  { bucket_sizes_87_out_i in_data 0 32 }  { bucket_sizes_87_out_o out_data 1 32 }  { bucket_sizes_87_out_o_ap_vld out_vld 1 1 } } }
	bucket_sizes_86_out { ap_ovld {  { bucket_sizes_86_out_i in_data 0 32 }  { bucket_sizes_86_out_o out_data 1 32 }  { bucket_sizes_86_out_o_ap_vld out_vld 1 1 } } }
