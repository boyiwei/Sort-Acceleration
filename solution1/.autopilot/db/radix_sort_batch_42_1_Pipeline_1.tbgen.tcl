set moduleName radix_sort_batch_42_1_Pipeline_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {radix_sort_batch.42.1_Pipeline_1}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "radix_sort_batch_42_1_Pipeline_1",
		"Protocol" : "ap_ctrl_hs",
...
set ArgLastReadFirstWriteLatency {
	radix_sort_batch_42_1_Pipeline_1 {
