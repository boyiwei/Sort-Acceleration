set moduleName sort_seperate_bucket_Pipeline_VITIS_LOOP_34_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {sort_seperate_bucket_Pipeline_VITIS_LOOP_34_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ sext_ln34 int 32 regular  }
	{ trunc_ln int 31 regular  }
	{ phi_mul int 10 regular  }
	{ bucket int 32 regular {array 784 { 1 3 } 1 1 }  }
	{ sorted_data int 32 regular {array 49 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "sext_ln34", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln34 sc_in sc_lv 32 signal 0 } 
	{ trunc_ln sc_in sc_lv 31 signal 1 } 
	{ phi_mul sc_in sc_lv 10 signal 2 } 
	{ bucket_address0 sc_out sc_lv 10 signal 3 } 
	{ bucket_ce0 sc_out sc_logic 1 signal 3 } 
	{ bucket_q0 sc_in sc_lv 32 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln34", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "sext_ln34", "role": "default" }} , 
...
set Spec2ImplPortList { 
	sext_ln34 { ap_none {  { sext_ln34 in_data 0 32 } } }
	trunc_ln { ap_none {  { trunc_ln in_data 0 31 } } }
	phi_mul { ap_none {  { phi_mul in_data 0 10 } } }
	bucket { ap_memory {  { bucket_address0 mem_address 1 10 }  { bucket_ce0 mem_ce 1 1 }  { bucket_q0 in_data 0 32 } } }
