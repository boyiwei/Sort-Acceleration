...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { bucket_sizes_522_out_i { I 32 vector } bucket_sizes_522_out_o { O 32 vector } bucket_sizes_522_out_o_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { bucket_sizes_521_out_i { I 32 vector } bucket_sizes_521_out_o { O 32 vector } bucket_sizes_521_out_o_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { bucket_pointer_346_out_i { I 32 vector } bucket_pointer_346_out_o { O 32 vector } bucket_pointer_346_out_o_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { bucket_pointer_345_out_i { I 32 vector } bucket_pointer_345_out_o { O 32 vector } bucket_pointer_345_out_o_ap_vld { O 1 bit } } \
} "
}
