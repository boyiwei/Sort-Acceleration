set moduleName radix_sort_batch_26_1_Pipeline_bucket_pointer_initialization
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {radix_sort_batch.26.1_Pipeline_bucket_pointer_initialization}
