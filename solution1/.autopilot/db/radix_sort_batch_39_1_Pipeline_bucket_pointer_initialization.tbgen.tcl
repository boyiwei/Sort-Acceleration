set moduleName radix_sort_batch_39_1_Pipeline_bucket_pointer_initialization
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {radix_sort_batch.39.1_Pipeline_bucket_pointer_initialization}
