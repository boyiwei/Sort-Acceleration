set moduleName radix_sort_unified_bucket_pingpong_9_1_Pipeline_input_bucket
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {radix_sort_unified_bucket_pingpong.9.1_Pipeline_input_bucket}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3"],
		"CDFG" : "radix_sort_unified_bucket_pingpong_9_1_Pipeline_input_bucket",
		"Protocol" : "ap_ctrl_hs",
...
set ArgLastReadFirstWriteLatency {
	radix_sort_unified_bucket_pingpong_9_1_Pipeline_input_bucket {
