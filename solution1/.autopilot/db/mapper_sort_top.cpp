...
using hls::sim::Byte;
extern "C" void sort_top(Byte<4>*, Byte<4>*);
extern "C" void apatb_sort_top_hw(volatile void * __xlx_apatb_param_input_r, volatile void * __xlx_apatb_param_output_r) {
...
__xlx_input_r__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_input_r)[i]);
  ...
  int __xlx_size_param_input_r = 1000000;
...
__xlx_output_r__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_output_r)[i]);
  ...
  // DUT call
  sort_top(__xlx_input_r__tmp_vec.data(), __xlx_output_r__tmp_vec.data());
