set moduleName radix_sort_separate_bucket_parallel_2_Pipeline_clear_bucket_pointer
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {radix_sort_separate_bucket_parallel_2_Pipeline_clear_bucket_pointer}
