set moduleName radix_sort_bin_batch_29_1_Pipeline_initialization
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {radix_sort_bin_batch.29.1_Pipeline_initialization}
...
set portList { 
	...
	{ input_28_address0 sc_out sc_lv 18 signal 1 } 
	{ input_28_ce0 sc_out sc_logic 1 signal 1 } 
	{ input_28_q0 sc_in sc_lv 32 signal 1 } 
	{ bucket_sizes_616_out_i sc_in sc_lv 32 signal 2 } 
	{ bucket_sizes_616_out_o sc_out sc_lv 32 signal 2 } 
	{ bucket_sizes_616_out_o_ap_vld sc_out sc_logic 1 outvld 2 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		"CDFG" : "radix_sort_bin_batch_29_1_Pipeline_initialization",
		"Protocol" : "ap_ctrl_hs",
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_21_32_1_1_U983", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.flow_control_loop_pipe_sequential_init_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	radix_sort_bin_batch_29_1_Pipeline_initialization {
...
set Spec2ImplPortList { 
	...
	input_28 { ap_memory {  { input_28_address0 mem_address 1 18 }  { input_28_ce0 mem_ce 1 1 }  { input_28_q0 in_data 0 32 } } }
