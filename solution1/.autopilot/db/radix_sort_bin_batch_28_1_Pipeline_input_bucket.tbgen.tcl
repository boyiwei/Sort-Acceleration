set moduleName radix_sort_bin_batch_28_1_Pipeline_input_bucket
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {radix_sort_bin_batch.28.1_Pipeline_input_bucket}
set C_modelType { void 0 }
set C_modelArgList {
	{ bucket_sizes_638_reload int 32 regular  }
	{ bucket_sizes_637_reload int 32 regular  }
	{ bucket_pointer_424_reload int 32 regular  }
	{ bucket_pointer_423_reload int 32 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "bucket_sizes_638_reload", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "bucket_sizes_637_reload", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "bucket_pointer_424_reload", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "bucket_pointer_423_reload", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ bucket_sizes_638_reload sc_in sc_lv 32 signal 0 } 
	{ bucket_sizes_637_reload sc_in sc_lv 32 signal 1 } 
	{ bucket_pointer_424_reload sc_in sc_lv 32 signal 2 } 
	{ bucket_pointer_423_reload sc_in sc_lv 32 signal 3 } 
	...
	{ bucket_sizes_642_out_i sc_in sc_lv 32 signal 8 } 
	{ bucket_sizes_642_out_o sc_out sc_lv 32 signal 8 } 
	{ bucket_sizes_642_out_o_ap_vld sc_out sc_logic 1 outvld 8 } 
	{ bucket_sizes_641_out_i sc_in sc_lv 32 signal 9 } 
	{ bucket_sizes_641_out_o sc_out sc_lv 32 signal 9 } 
	{ bucket_sizes_641_out_o_ap_vld sc_out sc_logic 1 outvld 9 } 
	{ bucket_pointer_426_out_i sc_in sc_lv 32 signal 10 } 
	{ bucket_pointer_426_out_o sc_out sc_lv 32 signal 10 } 
	{ bucket_pointer_426_out_o_ap_vld sc_out sc_logic 1 outvld 10 } 
	{ bucket_pointer_425_out_i sc_in sc_lv 32 signal 11 } 
	{ bucket_pointer_425_out_o sc_out sc_lv 32 signal 11 } 
	{ bucket_pointer_425_out_o_ap_vld sc_out sc_logic 1 outvld 11 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "bucket_sizes_638_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_sizes_638_reload", "role": "default" }} , 
 	{ "name": "bucket_sizes_637_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_sizes_637_reload", "role": "default" }} , 
 	{ "name": "bucket_pointer_424_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_pointer_424_reload", "role": "default" }} , 
 	{ "name": "bucket_pointer_423_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_pointer_423_reload", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_21_32_1_1_U962", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_21_32_1_1_U963", "Parent" : "0"},
...
set Spec2ImplPortList { 
	bucket_sizes_638_reload { ap_none {  { bucket_sizes_638_reload in_data 0 32 } } }
	bucket_sizes_637_reload { ap_none {  { bucket_sizes_637_reload in_data 0 32 } } }
	bucket_pointer_424_reload { ap_none {  { bucket_pointer_424_reload in_data 0 32 } } }
	bucket_pointer_423_reload { ap_none {  { bucket_pointer_423_reload in_data 0 32 } } }
