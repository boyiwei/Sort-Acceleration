set moduleName merge_arrays_1_2
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {merge_arrays.1.2}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "10000003", "Max" : "10000003"}
...
set Spec2ImplPortList { 
	in_r { ap_memory {  { in_r_address0 mem_address 1 24 }  { in_r_ce0 mem_ce 1 1 }  { in_r_q0 in_data 0 32 }  { in_r_address1 MemPortADDR2 1 24 }  { in_r_ce1 MemPortCE2 1 1 }  { in_r_q1 in_data 0 32 } } }
	out_r { ap_memory {  { out_r_address0 mem_address 1 24 }  { out_r_ce0 mem_ce 1 1 }  { out_r_we0 mem_we 1 1 }  { out_r_d0 mem_din 1 32 } } }
}
