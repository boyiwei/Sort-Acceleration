set moduleName radix_sort_oct_batch_58_1_Pipeline_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {radix_sort_oct_batch.58.1_Pipeline_1}
...
set C_modelArgList {
	...
	{ bucket_sizes_660_out int 32 regular {pointer 1}  }
	{ bucket_sizes_659_out int 32 regular {pointer 1}  }
	{ bucket_sizes_658_out int 32 regular {pointer 1}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "bucket_sizes_664_out", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	...
 	{ "Name" : "bucket_sizes_660_out", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "bucket_sizes_659_out", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "bucket_sizes_658_out", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ bucket_sizes_664_out sc_out sc_lv 32 signal 0 } 
	{ bucket_sizes_664_out_ap_vld sc_out sc_logic 1 outvld 0 } 
	{ bucket_sizes_663_out sc_out sc_lv 32 signal 1 } 
	{ bucket_sizes_663_out_ap_vld sc_out sc_logic 1 outvld 1 } 
	{ bucket_sizes_662_out sc_out sc_lv 32 signal 2 } 
	{ bucket_sizes_662_out_ap_vld sc_out sc_logic 1 outvld 2 } 
	{ bucket_sizes_661_out sc_out sc_lv 32 signal 3 } 
	{ bucket_sizes_661_out_ap_vld sc_out sc_logic 1 outvld 3 } 
	{ bucket_sizes_660_out sc_out sc_lv 32 signal 4 } 
	{ bucket_sizes_660_out_ap_vld sc_out sc_logic 1 outvld 4 } 
	{ bucket_sizes_659_out sc_out sc_lv 32 signal 5 } 
	{ bucket_sizes_659_out_ap_vld sc_out sc_logic 1 outvld 5 } 
	{ bucket_sizes_658_out sc_out sc_lv 32 signal 6 } 
	{ bucket_sizes_658_out_ap_vld sc_out sc_logic 1 outvld 6 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "bucket_sizes_660_out", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_sizes_660_out", "role": "default" }} , 
 	{ "name": "bucket_sizes_660_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "bucket_sizes_660_out", "role": "ap_vld" }} , 
 	{ "name": "bucket_sizes_659_out", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_sizes_659_out", "role": "default" }} , 
 	{ "name": "bucket_sizes_659_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "bucket_sizes_659_out", "role": "ap_vld" }} , 
 	{ "name": "bucket_sizes_658_out", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_sizes_658_out", "role": "default" }} , 
 	{ "name": "bucket_sizes_658_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "bucket_sizes_658_out", "role": "ap_vld" }} , 
...
set Spec2ImplPortList { 
	...
	bucket_sizes_660_out { ap_vld {  { bucket_sizes_660_out out_data 1 32 }  { bucket_sizes_660_out_ap_vld out_vld 1 1 } } }
	bucket_sizes_659_out { ap_vld {  { bucket_sizes_659_out out_data 1 32 }  { bucket_sizes_659_out_ap_vld out_vld 1 1 } } }
	bucket_sizes_658_out { ap_vld {  { bucket_sizes_658_out out_data 1 32 }  { bucket_sizes_658_out_ap_vld out_vld 1 1 } } }
