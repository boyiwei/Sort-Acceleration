set moduleName radix_sort_bin_batch_44_1_Pipeline_bucket_pointer_initialization
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {radix_sort_bin_batch.44.1_Pipeline_bucket_pointer_initialization}
set C_modelType { void 0 }
set C_modelArgList {
	{ bucket_sizes_366 int 32 regular  }
	{ bucket_sizes_365 int 32 regular  }
	{ bucket_pointer_241 int 32 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "bucket_sizes_366", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "bucket_pointer_241", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ bucket_sizes_366 sc_in sc_lv 32 signal 0 } 
	{ bucket_sizes_365 sc_in sc_lv 32 signal 1 } 
	{ bucket_pointer_241 sc_in sc_lv 32 signal 2 } 
	...
	{ bucket_pointer_244_out sc_out sc_lv 32 signal 6 } 
	{ bucket_pointer_244_out_ap_vld sc_out sc_logic 1 outvld 6 } 
	{ bucket_pointer_243_out sc_out sc_lv 32 signal 7 } 
	{ bucket_pointer_243_out_ap_vld sc_out sc_logic 1 outvld 7 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "bucket_pointer_241", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_pointer_241", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		"CDFG" : "radix_sort_bin_batch_44_1_Pipeline_bucket_pointer_initialization",
		"Protocol" : "ap_ctrl_hs",
		...
		"Port" : [
			...
			{"Name" : "bucket_pointer_241", "Type" : "None", "Direction" : "I"},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_21_32_1_1_U1513", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.flow_control_loop_pipe_sequential_init_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	radix_sort_bin_batch_44_1_Pipeline_bucket_pointer_initialization {
		bucket_sizes_366 {Type I LastRead 0 FirstWrite -1}
		bucket_sizes_365 {Type I LastRead 0 FirstWrite -1}
		bucket_pointer_241 {Type I LastRead 0 FirstWrite -1}
		bucket_pointer {Type I LastRead 0 FirstWrite -1}
		bucket_sizes_368_out {Type O LastRead -1 FirstWrite 1}
		bucket_sizes_367_out {Type O LastRead -1 FirstWrite 1}
...
set Spec2ImplPortList { 
	...
	bucket_pointer_241 { ap_none {  { bucket_pointer_241 in_data 0 32 } } }
