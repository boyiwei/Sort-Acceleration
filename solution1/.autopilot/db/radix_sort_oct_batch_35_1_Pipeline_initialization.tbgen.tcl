set moduleName radix_sort_oct_batch_35_1_Pipeline_initialization
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {radix_sort_oct_batch.35.1_Pipeline_initialization}
set C_modelType { void 0 }
set C_modelArgList {
	{ bucket_sizes_2489_reload int 32 regular  }
	{ bucket_sizes_2488_reload int 32 regular  }
	{ bucket_sizes_2487_reload int 32 regular  }
	{ bucket_sizes_2486_reload int 32 regular  }
	{ bucket_sizes_2485_reload int 32 regular  }
	{ bucket_sizes_2484_reload int 32 regular  }
	{ bucket_sizes_2483_reload int 32 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "bucket_sizes_2489_reload", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "bucket_sizes_2488_reload", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "bucket_sizes_2487_reload", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "bucket_sizes_2486_reload", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "bucket_sizes_2485_reload", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "bucket_sizes_2484_reload", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "bucket_sizes_2483_reload", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ bucket_sizes_2489_reload sc_in sc_lv 32 signal 0 } 
	{ bucket_sizes_2488_reload sc_in sc_lv 32 signal 1 } 
	{ bucket_sizes_2487_reload sc_in sc_lv 32 signal 2 } 
	{ bucket_sizes_2486_reload sc_in sc_lv 32 signal 3 } 
	{ bucket_sizes_2485_reload sc_in sc_lv 32 signal 4 } 
	{ bucket_sizes_2484_reload sc_in sc_lv 32 signal 5 } 
	{ bucket_sizes_2483_reload sc_in sc_lv 32 signal 6 } 
	...
	{ input_34_address0 sc_out sc_lv 17 signal 9 } 
	{ input_34_ce0 sc_out sc_logic 1 signal 9 } 
	{ input_34_q0 sc_in sc_lv 32 signal 9 } 
	{ bucket_sizes_2505_out_i sc_in sc_lv 32 signal 10 } 
	{ bucket_sizes_2505_out_o sc_out sc_lv 32 signal 10 } 
	{ bucket_sizes_2505_out_o_ap_vld sc_out sc_logic 1 outvld 10 } 
	{ bucket_sizes_2504_out_i sc_in sc_lv 32 signal 11 } 
	{ bucket_sizes_2504_out_o sc_out sc_lv 32 signal 11 } 
	{ bucket_sizes_2504_out_o_ap_vld sc_out sc_logic 1 outvld 11 } 
	{ bucket_sizes_2503_out_i sc_in sc_lv 32 signal 12 } 
	{ bucket_sizes_2503_out_o sc_out sc_lv 32 signal 12 } 
	{ bucket_sizes_2503_out_o_ap_vld sc_out sc_logic 1 outvld 12 } 
	{ bucket_sizes_2502_out_i sc_in sc_lv 32 signal 13 } 
	{ bucket_sizes_2502_out_o sc_out sc_lv 32 signal 13 } 
	{ bucket_sizes_2502_out_o_ap_vld sc_out sc_logic 1 outvld 13 } 
	{ bucket_sizes_2501_out_i sc_in sc_lv 32 signal 14 } 
	{ bucket_sizes_2501_out_o sc_out sc_lv 32 signal 14 } 
	{ bucket_sizes_2501_out_o_ap_vld sc_out sc_logic 1 outvld 14 } 
	{ bucket_sizes_2500_out_i sc_in sc_lv 32 signal 15 } 
	{ bucket_sizes_2500_out_o sc_out sc_lv 32 signal 15 } 
	{ bucket_sizes_2500_out_o_ap_vld sc_out sc_logic 1 outvld 15 } 
	{ bucket_sizes_2499_out_i sc_in sc_lv 32 signal 16 } 
	{ bucket_sizes_2499_out_o sc_out sc_lv 32 signal 16 } 
	{ bucket_sizes_2499_out_o_ap_vld sc_out sc_logic 1 outvld 16 } 
	{ bucket_sizes_2498_out_i sc_in sc_lv 32 signal 17 } 
	{ bucket_sizes_2498_out_o sc_out sc_lv 32 signal 17 } 
	{ bucket_sizes_2498_out_o_ap_vld sc_out sc_logic 1 outvld 17 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "bucket_sizes_2489_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_sizes_2489_reload", "role": "default" }} , 
 	{ "name": "bucket_sizes_2488_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_sizes_2488_reload", "role": "default" }} , 
 	{ "name": "bucket_sizes_2487_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_sizes_2487_reload", "role": "default" }} , 
 	{ "name": "bucket_sizes_2486_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_sizes_2486_reload", "role": "default" }} , 
 	{ "name": "bucket_sizes_2485_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_sizes_2485_reload", "role": "default" }} , 
 	{ "name": "bucket_sizes_2484_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_sizes_2484_reload", "role": "default" }} , 
 	{ "name": "bucket_sizes_2483_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_sizes_2483_reload", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		"CDFG" : "radix_sort_oct_batch_35_1_Pipeline_initialization",
		"Protocol" : "ap_ctrl_hs",
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "bucket_sizes_2489_reload", "Type" : "None", "Direction" : "I"},
			{"Name" : "bucket_sizes_2488_reload", "Type" : "None", "Direction" : "I"},
			{"Name" : "bucket_sizes_2487_reload", "Type" : "None", "Direction" : "I"},
			{"Name" : "bucket_sizes_2486_reload", "Type" : "None", "Direction" : "I"},
			{"Name" : "bucket_sizes_2485_reload", "Type" : "None", "Direction" : "I"},
			{"Name" : "bucket_sizes_2484_reload", "Type" : "None", "Direction" : "I"},
			{"Name" : "bucket_sizes_2483_reload", "Type" : "None", "Direction" : "I"},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_83_32_1_1_U3581", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.flow_control_loop_pipe_sequential_init_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	radix_sort_oct_batch_35_1_Pipeline_initialization {
		bucket_sizes_2489_reload {Type I LastRead 0 FirstWrite -1}
		bucket_sizes_2488_reload {Type I LastRead 0 FirstWrite -1}
		bucket_sizes_2487_reload {Type I LastRead 0 FirstWrite -1}
		bucket_sizes_2486_reload {Type I LastRead 0 FirstWrite -1}
		bucket_sizes_2485_reload {Type I LastRead 0 FirstWrite -1}
		bucket_sizes_2484_reload {Type I LastRead 0 FirstWrite -1}
		bucket_sizes_2483_reload {Type I LastRead 0 FirstWrite -1}
...
set Spec2ImplPortList { 
	bucket_sizes_2489_reload { ap_none {  { bucket_sizes_2489_reload in_data 0 32 } } }
	bucket_sizes_2488_reload { ap_none {  { bucket_sizes_2488_reload in_data 0 32 } } }
	bucket_sizes_2487_reload { ap_none {  { bucket_sizes_2487_reload in_data 0 32 } } }
	bucket_sizes_2486_reload { ap_none {  { bucket_sizes_2486_reload in_data 0 32 } } }
	bucket_sizes_2485_reload { ap_none {  { bucket_sizes_2485_reload in_data 0 32 } } }
	bucket_sizes_2484_reload { ap_none {  { bucket_sizes_2484_reload in_data 0 32 } } }
	bucket_sizes_2483_reload { ap_none {  { bucket_sizes_2483_reload in_data 0 32 } } }
	...
	input_34 { ap_memory {  { input_34_address0 mem_address 1 17 }  { input_34_ce0 mem_ce 1 1 }  { input_34_q0 in_data 0 32 } } }
