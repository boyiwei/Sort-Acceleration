...
set hasInterrupt 0
set C_modelName {merge_sort.105}
set C_modelType { void 0 }
set C_modelArgList {
	{ input1 int 32 regular {array 312500 { 1 3 } 1 1 }  }
	{ input2 int 32 regular {array 312500 { 1 3 } 1 1 }  }
	{ sorted_data int 32 regular {array 625000 { 0 3 } 0 1 }  }
}
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "input1_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":19, "type": "signal", "bundle":{"name": "input1", "role": "address0" }} , 
 	...
 	{ "name": "input2_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":19, "type": "signal", "bundle":{"name": "input2", "role": "address0" }} , 
 	...
 	{ "name": "sorted_data_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":20, "type": "signal", "bundle":{"name": "sorted_data", "role": "address0" }} , 
...
set Spec2ImplPortList { 
	input1 { ap_memory {  { input1_address0 mem_address 1 19 }  { input1_ce0 mem_ce 1 1 }  { input1_q0 in_data 0 32 } } }
	input2 { ap_memory {  { input2_address0 mem_address 1 19 }  { input2_ce0 mem_ce 1 1 }  { input2_q0 in_data 0 32 } } }
	sorted_data { ap_memory {  { sorted_data_address0 mem_address 1 20 }  { sorted_data_ce0 mem_ce 1 1 }  { sorted_data_we0 mem_we 1 1 }  { sorted_data_d0 mem_din 1 32 } } }
}
