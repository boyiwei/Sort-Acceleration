...
using hls::sim::Byte;
extern "C" void merge_sort_parallel(Byte<4>*, Byte<4>*);
extern "C" void apatb_merge_sort_parallel_hw(volatile void * __xlx_apatb_param_in_r, volatile void * __xlx_apatb_param_out_r) {
...
__xlx_in_r__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_in_r)[i]);
  ...
  int __xlx_size_param_in_r = 10000000;
...
__xlx_out_r__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_out_r)[i]);
  ...
  int __xlx_size_param_out_r = 10000000;
  int __xlx_offset_param_out_r = 0;
  int __xlx_offset_byte_param_out_r = 0*4;
  // DUT call
  merge_sort_parallel(__xlx_in_r__tmp_vec.data(), __xlx_out_r__tmp_vec.data());
