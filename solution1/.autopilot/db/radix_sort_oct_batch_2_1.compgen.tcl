...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler multi_radix_oct_loser_64_radix_sort_oct_batch_2_1_bucket_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { multi_radix_oct_loser_64_temp0_1_address0 { O 18 vector } multi_radix_oct_loser_64_temp0_1_ce0 { O 1 bit } multi_radix_oct_loser_64_temp0_1_we0 { O 1 bit } multi_radix_oct_loser_64_temp0_1_d0 { O 32 vector } } \
} "
} else {
