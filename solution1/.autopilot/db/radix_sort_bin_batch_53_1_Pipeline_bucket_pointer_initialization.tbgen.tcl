set moduleName radix_sort_bin_batch_53_1_Pipeline_bucket_pointer_initialization
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {radix_sort_bin_batch.53.1_Pipeline_bucket_pointer_initialization}
...
set C_modelArgList {
	...
	{ bucket_sizes_218_out int 32 regular {pointer 1}  }
	{ bucket_sizes_217_out int 32 regular {pointer 1}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "bucket_sizes_216", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "bucket_sizes_218_out", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "bucket_sizes_217_out", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ bucket_sizes_216 sc_in sc_lv 32 signal 0 } 
	{ bucket_sizes_215 sc_in sc_lv 32 signal 1 } 
	{ bucket_pointer_141 sc_in sc_lv 32 signal 2 } 
	{ bucket_pointer sc_in sc_lv 32 signal 3 } 
	{ bucket_sizes_218_out sc_out sc_lv 32 signal 4 } 
	{ bucket_sizes_218_out_ap_vld sc_out sc_logic 1 outvld 4 } 
	{ bucket_sizes_217_out sc_out sc_lv 32 signal 5 } 
	{ bucket_sizes_217_out_ap_vld sc_out sc_logic 1 outvld 5 } 
	{ bucket_pointer_144_out sc_out sc_lv 32 signal 6 } 
	{ bucket_pointer_144_out_ap_vld sc_out sc_logic 1 outvld 6 } 
	{ bucket_pointer_143_out sc_out sc_lv 32 signal 7 } 
	{ bucket_pointer_143_out_ap_vld sc_out sc_logic 1 outvld 7 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "bucket_sizes_218_out", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_sizes_218_out", "role": "default" }} , 
 	{ "name": "bucket_sizes_218_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "bucket_sizes_218_out", "role": "ap_vld" }} , 
 	{ "name": "bucket_sizes_217_out", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_sizes_217_out", "role": "default" }} , 
 	{ "name": "bucket_sizes_217_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "bucket_sizes_217_out", "role": "ap_vld" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_21_32_1_1_U1828", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	bucket_sizes_218_out { ap_vld {  { bucket_sizes_218_out out_data 1 32 }  { bucket_sizes_218_out_ap_vld out_vld 1 1 } } }
	bucket_sizes_217_out { ap_vld {  { bucket_sizes_217_out out_data 1 32 }  { bucket_sizes_217_out_ap_vld out_vld 1 1 } } }
