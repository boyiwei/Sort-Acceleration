set moduleName sort_seperate_bucket_Pipeline_initialization
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {sort_seperate_bucket_Pipeline_initialization}
set C_modelType { void 0 }
set C_modelArgList {
	{ data int 32 regular {array 49 { 1 3 } 1 1 }  }
	{ sorted_data int 32 regular {array 49 { 0 3 } 0 1 }  }
}
