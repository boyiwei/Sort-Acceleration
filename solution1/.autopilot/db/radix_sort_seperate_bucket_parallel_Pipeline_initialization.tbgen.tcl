set moduleName radix_sort_seperate_bucket_parallel_Pipeline_initialization
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {radix_sort_seperate_bucket_parallel_Pipeline_initialization}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "radix_sort_seperate_bucket_parallel_Pipeline_initialization",
		"Protocol" : "ap_ctrl_hs",
...
set ArgLastReadFirstWriteLatency {
	radix_sort_seperate_bucket_parallel_Pipeline_initialization {
...
set Spec2ImplPortList { 
	data { ap_memory {  { data_address0 mem_address 1 6 }  { data_ce0 mem_ce 1 1 }  { data_q0 in_data 0 32 } } }
