...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename data \
    op interface \
    ports { data_address0 { O 23 vector } data_ce0 { O 1 bit } data_we0 { O 1 bit } data_d0 { O 32 vector } } \
} "
} else {
...
set InstName single_heap_sort_flow_control_loop_pipe_sequential_init_U
set CompName single_heap_sort_flow_control_loop_pipe_sequential_init
set name flow_control_loop_pipe_sequential_init
if {${::AESL::PGuard_autocg_gen} && ${::AESL::PGuard_autocg_ipmgen}} {
if {[info proc ::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control] == "::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control"} {
eval "::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control { \
    name ${name} \
    prefix single_heap_sort_ \
}"
} else {
