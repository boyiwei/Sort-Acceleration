...
set C_modelArgList {
	...
	{ multi_radix_oct_kmerge_temp0_1 int 32 regular {array 78125 { 0 3 } 0 1 } {global 1}  }
}
...
set portList { 
	...
	{ input_1_address0 sc_out sc_lv 17 signal 0 } 
	{ input_1_ce0 sc_out sc_logic 1 signal 0 } 
	{ input_1_q0 sc_in sc_lv 32 signal 0 } 
	{ multi_radix_oct_kmerge_temp0_1_address0 sc_out sc_lv 17 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "multi_radix_oct_kmerge_temp0_1_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":17, "type": "signal", "bundle":{"name": "multi_radix_oct_kmerge_temp0_1", "role": "address0" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "16", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_mul_18s_17ns_18_4_1_U208", "Parent" : "0"},
	{"ID" : "17", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_mul_18s_17ns_18_4_1_U209", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	input_1 { ap_memory {  { input_1_address0 mem_address 1 17 }  { input_1_ce0 mem_ce 1 1 }  { input_1_q0 mem_dout 0 32 } } }
	multi_radix_oct_kmerge_temp0_1 { ap_memory {  { multi_radix_oct_kmerge_temp0_1_address0 mem_address 1 17 }  { multi_radix_oct_kmerge_temp0_1_ce0 mem_ce 1 1 }  { multi_radix_oct_kmerge_temp0_1_we0 mem_we 1 1 }  { multi_radix_oct_kmerge_temp0_1_d0 mem_din 1 32 } } }
}
