set moduleName radix_sort_bin_batch_40_1_Pipeline_input_bucket
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {radix_sort_bin_batch.40.1_Pipeline_input_bucket}
set C_modelType { void 0 }
set C_modelArgList {
	{ bucket_sizes_428_reload int 32 regular  }
	{ bucket_sizes_427_reload int 32 regular  }
	...
	{ bucket_sizes_432_out int 32 regular {pointer 2}  }
	{ bucket_sizes_431_out int 32 regular {pointer 2}  }
	{ bucket_pointer_286_out int 32 regular {pointer 2}  }
	{ bucket_pointer_285_out int 32 regular {pointer 2}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "bucket_sizes_428_reload", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "bucket_sizes_427_reload", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "bucket_sizes_432_out", "interface" : "wire", "bitwidth" : 32, "direction" : "READWRITE"} , 
 	{ "Name" : "bucket_sizes_431_out", "interface" : "wire", "bitwidth" : 32, "direction" : "READWRITE"} , 
...
set portList { 
	...
	{ bucket_sizes_428_reload sc_in sc_lv 32 signal 0 } 
	{ bucket_sizes_427_reload sc_in sc_lv 32 signal 1 } 
	{ bucket_pointer_284_reload sc_in sc_lv 32 signal 2 } 
	{ bucket_pointer_283_reload sc_in sc_lv 32 signal 3 } 
	...
	{ bucket_sizes_432_out_i sc_in sc_lv 32 signal 8 } 
	{ bucket_sizes_432_out_o sc_out sc_lv 32 signal 8 } 
	{ bucket_sizes_432_out_o_ap_vld sc_out sc_logic 1 outvld 8 } 
	{ bucket_sizes_431_out_i sc_in sc_lv 32 signal 9 } 
	{ bucket_sizes_431_out_o sc_out sc_lv 32 signal 9 } 
	{ bucket_sizes_431_out_o_ap_vld sc_out sc_logic 1 outvld 9 } 
	{ bucket_pointer_286_out_i sc_in sc_lv 32 signal 10 } 
	{ bucket_pointer_286_out_o sc_out sc_lv 32 signal 10 } 
	{ bucket_pointer_286_out_o_ap_vld sc_out sc_logic 1 outvld 10 } 
	{ bucket_pointer_285_out_i sc_in sc_lv 32 signal 11 } 
	{ bucket_pointer_285_out_o sc_out sc_lv 32 signal 11 } 
	{ bucket_pointer_285_out_o_ap_vld sc_out sc_logic 1 outvld 11 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "bucket_sizes_428_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_sizes_428_reload", "role": "default" }} , 
 	{ "name": "bucket_sizes_427_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_sizes_427_reload", "role": "default" }} , 
 	...
 	{ "name": "bucket_sizes_432_out_i", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_sizes_432_out", "role": "i" }} , 
 	{ "name": "bucket_sizes_432_out_o", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_sizes_432_out", "role": "o" }} , 
 	{ "name": "bucket_sizes_432_out_o_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "bucket_sizes_432_out", "role": "o_ap_vld" }} , 
 	{ "name": "bucket_sizes_431_out_i", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_sizes_431_out", "role": "i" }} , 
 	{ "name": "bucket_sizes_431_out_o", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_sizes_431_out", "role": "o" }} , 
 	{ "name": "bucket_sizes_431_out_o_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "bucket_sizes_431_out", "role": "o_ap_vld" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_21_32_1_1_U1382", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_21_32_1_1_U1383", "Parent" : "0"},
...
set Spec2ImplPortList { 
	bucket_sizes_428_reload { ap_none {  { bucket_sizes_428_reload in_data 0 32 } } }
	bucket_sizes_427_reload { ap_none {  { bucket_sizes_427_reload in_data 0 32 } } }
	...
	bucket_sizes_432_out { ap_ovld {  { bucket_sizes_432_out_i in_data 0 32 }  { bucket_sizes_432_out_o out_data 1 32 }  { bucket_sizes_432_out_o_ap_vld out_vld 1 1 } } }
	bucket_sizes_431_out { ap_ovld {  { bucket_sizes_431_out_i in_data 0 32 }  { bucket_sizes_431_out_o out_data 1 32 }  { bucket_sizes_431_out_o_ap_vld out_vld 1 1 } } }
