...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { bucket_sizes_732_out_i { I 32 vector } bucket_sizes_732_out_o { O 32 vector } bucket_sizes_732_out_o_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { bucket_sizes_731_out_i { I 32 vector } bucket_sizes_731_out_o { O 32 vector } bucket_sizes_731_out_o_ap_vld { O 1 bit } } \
} "
}
