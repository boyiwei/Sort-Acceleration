...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { bucket_sizes_4387_out { O 32 vector } bucket_sizes_4387_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { bucket_sizes_4386_out { O 32 vector } bucket_sizes_4386_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { bucket_sizes_4385_out { O 32 vector } bucket_sizes_4385_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { bucket_sizes_4384_out { O 32 vector } bucket_sizes_4384_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { bucket_sizes_4383_out { O 32 vector } bucket_sizes_4383_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { bucket_sizes_4382_out { O 32 vector } bucket_sizes_4382_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 1059 \
    name bucket_sizes_4381_out \
    type other \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_bucket_sizes_4381_out \
    op interface \
    ports { bucket_sizes_4381_out { O 32 vector } bucket_sizes_4381_out_ap_vld { O 1 bit } } \
} "
}
