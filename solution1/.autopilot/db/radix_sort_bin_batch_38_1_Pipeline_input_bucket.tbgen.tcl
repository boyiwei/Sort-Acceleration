set moduleName radix_sort_bin_batch_38_1_Pipeline_input_bucket
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {radix_sort_bin_batch.38.1_Pipeline_input_bucket}
set C_modelType { void 0 }
set C_modelArgList {
	{ bucket_sizes_473_reload int 32 regular  }
	{ bucket_sizes_472_reload int 32 regular  }
	{ bucket_pointer_314_reload int 32 regular  }
	{ bucket_pointer_313_reload int 32 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "bucket_sizes_473_reload", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "bucket_sizes_472_reload", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "bucket_pointer_314_reload", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "bucket_pointer_313_reload", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ bucket_sizes_473_reload sc_in sc_lv 32 signal 0 } 
	{ bucket_sizes_472_reload sc_in sc_lv 32 signal 1 } 
	{ bucket_pointer_314_reload sc_in sc_lv 32 signal 2 } 
	{ bucket_pointer_313_reload sc_in sc_lv 32 signal 3 } 
	...
	{ bucket_sizes_477_out_i sc_in sc_lv 32 signal 8 } 
	{ bucket_sizes_477_out_o sc_out sc_lv 32 signal 8 } 
	{ bucket_sizes_477_out_o_ap_vld sc_out sc_logic 1 outvld 8 } 
	{ bucket_sizes_476_out_i sc_in sc_lv 32 signal 9 } 
	{ bucket_sizes_476_out_o sc_out sc_lv 32 signal 9 } 
	{ bucket_sizes_476_out_o_ap_vld sc_out sc_logic 1 outvld 9 } 
	{ bucket_pointer_316_out_i sc_in sc_lv 32 signal 10 } 
	{ bucket_pointer_316_out_o sc_out sc_lv 32 signal 10 } 
	{ bucket_pointer_316_out_o_ap_vld sc_out sc_logic 1 outvld 10 } 
	{ bucket_pointer_315_out_i sc_in sc_lv 32 signal 11 } 
	{ bucket_pointer_315_out_o sc_out sc_lv 32 signal 11 } 
	{ bucket_pointer_315_out_o_ap_vld sc_out sc_logic 1 outvld 11 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "bucket_sizes_473_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_sizes_473_reload", "role": "default" }} , 
 	{ "name": "bucket_sizes_472_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_sizes_472_reload", "role": "default" }} , 
 	{ "name": "bucket_pointer_314_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_pointer_314_reload", "role": "default" }} , 
 	{ "name": "bucket_pointer_313_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_pointer_313_reload", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3"],
		"CDFG" : "radix_sort_bin_batch_38_1_Pipeline_input_bucket",
		"Protocol" : "ap_ctrl_hs",
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "bucket_sizes_473_reload", "Type" : "None", "Direction" : "I"},
			{"Name" : "bucket_sizes_472_reload", "Type" : "None", "Direction" : "I"},
			{"Name" : "bucket_pointer_314_reload", "Type" : "None", "Direction" : "I"},
			{"Name" : "bucket_pointer_313_reload", "Type" : "None", "Direction" : "I"},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_21_32_1_1_U1312", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_21_32_1_1_U1313", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.flow_control_loop_pipe_sequential_init_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	radix_sort_bin_batch_38_1_Pipeline_input_bucket {
		bucket_sizes_473_reload {Type I LastRead 0 FirstWrite -1}
		bucket_sizes_472_reload {Type I LastRead 0 FirstWrite -1}
		bucket_pointer_314_reload {Type I LastRead 0 FirstWrite -1}
		bucket_pointer_313_reload {Type I LastRead 0 FirstWrite -1}
...
set Spec2ImplPortList { 
	bucket_sizes_473_reload { ap_none {  { bucket_sizes_473_reload in_data 0 32 } } }
	bucket_sizes_472_reload { ap_none {  { bucket_sizes_472_reload in_data 0 32 } } }
	bucket_pointer_314_reload { ap_none {  { bucket_pointer_314_reload in_data 0 32 } } }
	bucket_pointer_313_reload { ap_none {  { bucket_pointer_313_reload in_data 0 32 } } }
