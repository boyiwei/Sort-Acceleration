...
define void @apatb_radix_sort_seperate_bucket_parallel_ir(i32* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="50" %data, i32* noalias nocapture nonnull "fpga.decayed.dim.hint"="50" %sorted_data) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_radix_sort_seperate_bucket_parallel_hw(i32* %2, i32* %3)
...
declare void @apatb_radix_sort_seperate_bucket_parallel_hw(i32*, i32*)
...
define void @radix_sort_seperate_bucket_parallel_hw_stub_wrapper(i32*, i32*) #4 {
entry:
  ...
  call void @radix_sort_seperate_bucket_parallel_hw_stub(i32* %4, i32* %5)
  call void @copy_in([50 x i32]* null, [50 x i32]* %2, [50 x i32]* null, [50 x i32]* %3)
  ret void
}

declare void @radix_sort_seperate_bucket_parallel_hw_stub(i32*, i32*)
