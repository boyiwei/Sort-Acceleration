set moduleName single_heap_sort_Pipeline_initialization
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {single_heap_sort_Pipeline_initialization}
set C_modelType { void 0 }
set C_modelArgList {
	{ input_r int 32 regular {array 5000000 { 1 3 } 1 1 }  }
	{ data int 32 regular {array 5000000 { 0 3 } 0 1 }  }
}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "single_heap_sort_Pipeline_initialization",
		"Protocol" : "ap_ctrl_hs",
...
set ArgLastReadFirstWriteLatency {
	single_heap_sort_Pipeline_initialization {
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "5000002", "Max" : "5000002"}
	, {"Name" : "Interval", "Min" : "5000002", "Max" : "5000002"}
]}
...
set Spec2ImplPortList { 
	...
	data { ap_memory {  { data_address0 mem_address 1 23 }  { data_ce0 mem_ce 1 1 }  { data_we0 mem_we 1 1 }  { data_d0 mem_din 1 32 } } }
}
