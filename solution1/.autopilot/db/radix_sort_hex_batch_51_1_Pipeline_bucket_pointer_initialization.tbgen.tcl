set moduleName radix_sort_hex_batch_51_1_Pipeline_bucket_pointer_initialization
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {radix_sort_hex_batch.51.1_Pipeline_bucket_pointer_initialization}
