set moduleName radix_sort_hex_batch_46_1_Pipeline_initialization
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {radix_sort_hex_batch.46.1_Pipeline_initialization}
...
set C_modelArgList {
	...
	{ input_45 int 32 regular {array 15625 { 1 3 } 1 1 }  }
...
set portList { 
	...
	{ input_45_address0 sc_out sc_lv 14 signal 17 } 
	{ input_45_ce0 sc_out sc_logic 1 signal 17 } 
	{ input_45_q0 sc_in sc_lv 32 signal 17 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		"CDFG" : "radix_sort_hex_batch_46_1_Pipeline_initialization",
		"Protocol" : "ap_ctrl_hs",
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_164_32_1_1_U8704", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.flow_control_loop_pipe_sequential_init_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	radix_sort_hex_batch_46_1_Pipeline_initialization {
