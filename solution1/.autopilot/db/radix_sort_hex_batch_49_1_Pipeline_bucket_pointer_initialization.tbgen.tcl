set moduleName radix_sort_hex_batch_49_1_Pipeline_bucket_pointer_initialization
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {radix_sort_hex_batch.49.1_Pipeline_bucket_pointer_initialization}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		"CDFG" : "radix_sort_hex_batch_49_1_Pipeline_bucket_pointer_initialization",
		"Protocol" : "ap_ctrl_hs",
...
set ArgLastReadFirstWriteLatency {
	radix_sort_hex_batch_49_1_Pipeline_bucket_pointer_initialization {
