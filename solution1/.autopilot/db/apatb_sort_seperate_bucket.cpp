...
// wrapc file define:
#define AUTOTB_TVIN_data "../tv/cdatafile/c.sort_seperate_bucket.autotvin_data.dat"
#define AUTOTB_TVOUT_data "../tv/cdatafile/c.sort_seperate_bucket.autotvout_data.dat"
#define AUTOTB_TVIN_sorted_data "../tv/cdatafile/c.sort_seperate_bucket.autotvin_sorted_data.dat"
#define AUTOTB_TVOUT_sorted_data "../tv/cdatafile/c.sort_seperate_bucket.autotvout_sorted_data.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_sorted_data "../tv/rtldatafile/rtl.sort_seperate_bucket.autotvout_sorted_data.dat"
...
extern "C"
void sort_seperate_bucket_hw_stub_wrapper(void*, void*);

extern "C"
void apatb_sort_seperate_bucket_hw(void* __xlx_apatb_param_data, void* __xlx_apatb_param_sorted_data)
{
#ifdef USE_BINARY_TV_FILE
...
#ifdef POST_CHECK
#ifdef USE_BINARY_TV_FILE
    .reader = new hls::sim::Input(AUTOTB_TVOUT_PC_sorted_data),
#else
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_sorted_data),
#endif
#else
#ifdef USE_BINARY_TV_FILE
    .owriter = new hls::sim::Output(AUTOTB_TVOUT_sorted_data),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_sorted_data),
#endif
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_sorted_data),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_sorted_data),
#endif
#endif
  };
  port1.param = { __xlx_apatb_param_sorted_data };
  port1.depth = { 49 };
  port1.offset = {  };
  port1.hasWrite = { true };
  ...
  try {
    ...
    sort_seperate_bucket_hw_stub_wrapper(__xlx_apatb_param_data, __xlx_apatb_param_sorted_data);
