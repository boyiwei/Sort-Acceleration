set moduleName radix_sort_oct_batch_22_1_Pipeline_initialization
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {radix_sort_oct_batch.22.1_Pipeline_initialization}
set C_modelType { void 0 }
set C_modelArgList {
	{ bucket_sizes_3511_reload int 32 regular  }
	{ bucket_sizes_3510_reload int 32 regular  }
	{ bucket_sizes_3509_reload int 32 regular  }
	{ bucket_sizes_3508_reload int 32 regular  }
	{ bucket_sizes_3507_reload int 32 regular  }
	{ bucket_sizes_3506_reload int 32 regular  }
	{ bucket_sizes_3505_reload int 32 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "bucket_sizes_3511_reload", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "bucket_sizes_3510_reload", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "bucket_sizes_3509_reload", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "bucket_sizes_3508_reload", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "bucket_sizes_3507_reload", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "bucket_sizes_3506_reload", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "bucket_sizes_3505_reload", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ bucket_sizes_3511_reload sc_in sc_lv 32 signal 0 } 
	{ bucket_sizes_3510_reload sc_in sc_lv 32 signal 1 } 
	{ bucket_sizes_3509_reload sc_in sc_lv 32 signal 2 } 
	{ bucket_sizes_3508_reload sc_in sc_lv 32 signal 3 } 
	{ bucket_sizes_3507_reload sc_in sc_lv 32 signal 4 } 
	{ bucket_sizes_3506_reload sc_in sc_lv 32 signal 5 } 
	{ bucket_sizes_3505_reload sc_in sc_lv 32 signal 6 } 
	...
	{ input_21_address0 sc_out sc_lv 17 signal 9 } 
	{ input_21_ce0 sc_out sc_logic 1 signal 9 } 
	{ input_21_q0 sc_in sc_lv 32 signal 9 } 
	{ bucket_sizes_3527_out_i sc_in sc_lv 32 signal 10 } 
	{ bucket_sizes_3527_out_o sc_out sc_lv 32 signal 10 } 
	{ bucket_sizes_3527_out_o_ap_vld sc_out sc_logic 1 outvld 10 } 
	{ bucket_sizes_3526_out_i sc_in sc_lv 32 signal 11 } 
	{ bucket_sizes_3526_out_o sc_out sc_lv 32 signal 11 } 
	{ bucket_sizes_3526_out_o_ap_vld sc_out sc_logic 1 outvld 11 } 
	{ bucket_sizes_3525_out_i sc_in sc_lv 32 signal 12 } 
	{ bucket_sizes_3525_out_o sc_out sc_lv 32 signal 12 } 
	{ bucket_sizes_3525_out_o_ap_vld sc_out sc_logic 1 outvld 12 } 
	{ bucket_sizes_3524_out_i sc_in sc_lv 32 signal 13 } 
	{ bucket_sizes_3524_out_o sc_out sc_lv 32 signal 13 } 
	{ bucket_sizes_3524_out_o_ap_vld sc_out sc_logic 1 outvld 13 } 
	{ bucket_sizes_3523_out_i sc_in sc_lv 32 signal 14 } 
	{ bucket_sizes_3523_out_o sc_out sc_lv 32 signal 14 } 
	{ bucket_sizes_3523_out_o_ap_vld sc_out sc_logic 1 outvld 14 } 
	{ bucket_sizes_3522_out_i sc_in sc_lv 32 signal 15 } 
	{ bucket_sizes_3522_out_o sc_out sc_lv 32 signal 15 } 
	{ bucket_sizes_3522_out_o_ap_vld sc_out sc_logic 1 outvld 15 } 
	{ bucket_sizes_3521_out_i sc_in sc_lv 32 signal 16 } 
	{ bucket_sizes_3521_out_o sc_out sc_lv 32 signal 16 } 
	{ bucket_sizes_3521_out_o_ap_vld sc_out sc_logic 1 outvld 16 } 
	{ bucket_sizes_3520_out_i sc_in sc_lv 32 signal 17 } 
	{ bucket_sizes_3520_out_o sc_out sc_lv 32 signal 17 } 
	{ bucket_sizes_3520_out_o_ap_vld sc_out sc_logic 1 outvld 17 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "bucket_sizes_3511_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_sizes_3511_reload", "role": "default" }} , 
 	{ "name": "bucket_sizes_3510_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_sizes_3510_reload", "role": "default" }} , 
 	{ "name": "bucket_sizes_3509_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_sizes_3509_reload", "role": "default" }} , 
 	{ "name": "bucket_sizes_3508_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_sizes_3508_reload", "role": "default" }} , 
 	{ "name": "bucket_sizes_3507_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_sizes_3507_reload", "role": "default" }} , 
 	{ "name": "bucket_sizes_3506_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_sizes_3506_reload", "role": "default" }} , 
 	{ "name": "bucket_sizes_3505_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_sizes_3505_reload", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		"CDFG" : "radix_sort_oct_batch_22_1_Pipeline_initialization",
		"Protocol" : "ap_ctrl_hs",
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "bucket_sizes_3511_reload", "Type" : "None", "Direction" : "I"},
			{"Name" : "bucket_sizes_3510_reload", "Type" : "None", "Direction" : "I"},
			{"Name" : "bucket_sizes_3509_reload", "Type" : "None", "Direction" : "I"},
			{"Name" : "bucket_sizes_3508_reload", "Type" : "None", "Direction" : "I"},
			{"Name" : "bucket_sizes_3507_reload", "Type" : "None", "Direction" : "I"},
			{"Name" : "bucket_sizes_3506_reload", "Type" : "None", "Direction" : "I"},
			{"Name" : "bucket_sizes_3505_reload", "Type" : "None", "Direction" : "I"},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_83_32_1_1_U2216", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.flow_control_loop_pipe_sequential_init_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	radix_sort_oct_batch_22_1_Pipeline_initialization {
		bucket_sizes_3511_reload {Type I LastRead 0 FirstWrite -1}
		bucket_sizes_3510_reload {Type I LastRead 0 FirstWrite -1}
		bucket_sizes_3509_reload {Type I LastRead 0 FirstWrite -1}
		bucket_sizes_3508_reload {Type I LastRead 0 FirstWrite -1}
		bucket_sizes_3507_reload {Type I LastRead 0 FirstWrite -1}
		bucket_sizes_3506_reload {Type I LastRead 0 FirstWrite -1}
		bucket_sizes_3505_reload {Type I LastRead 0 FirstWrite -1}
...
set Spec2ImplPortList { 
	bucket_sizes_3511_reload { ap_none {  { bucket_sizes_3511_reload in_data 0 32 } } }
	bucket_sizes_3510_reload { ap_none {  { bucket_sizes_3510_reload in_data 0 32 } } }
	bucket_sizes_3509_reload { ap_none {  { bucket_sizes_3509_reload in_data 0 32 } } }
	bucket_sizes_3508_reload { ap_none {  { bucket_sizes_3508_reload in_data 0 32 } } }
	bucket_sizes_3507_reload { ap_none {  { bucket_sizes_3507_reload in_data 0 32 } } }
	bucket_sizes_3506_reload { ap_none {  { bucket_sizes_3506_reload in_data 0 32 } } }
	bucket_sizes_3505_reload { ap_none {  { bucket_sizes_3505_reload in_data 0 32 } } }
	...
	input_21 { ap_memory {  { input_21_address0 mem_address 1 17 }  { input_21_ce0 mem_ce 1 1 }  { input_21_q0 in_data 0 32 } } }
