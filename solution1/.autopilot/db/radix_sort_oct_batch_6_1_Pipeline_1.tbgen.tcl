set moduleName radix_sort_oct_batch_6_1_Pipeline_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {radix_sort_oct_batch.6.1_Pipeline_1}
...
set C_modelArgList {
	...
	{ bucket_sizes_515_out int 32 regular {pointer 1}  }
	{ bucket_sizes_514_out int 32 regular {pointer 1}  }
	{ bucket_sizes_513_out int 32 regular {pointer 1}  }
	{ bucket_sizes_512_out int 32 regular {pointer 1}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "bucket_sizes_518_out", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	...
 	{ "Name" : "bucket_sizes_515_out", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "bucket_sizes_514_out", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "bucket_sizes_513_out", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "bucket_sizes_512_out", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ bucket_sizes_518_out sc_out sc_lv 32 signal 0 } 
	{ bucket_sizes_518_out_ap_vld sc_out sc_logic 1 outvld 0 } 
	{ bucket_sizes_517_out sc_out sc_lv 32 signal 1 } 
	{ bucket_sizes_517_out_ap_vld sc_out sc_logic 1 outvld 1 } 
	{ bucket_sizes_516_out sc_out sc_lv 32 signal 2 } 
	{ bucket_sizes_516_out_ap_vld sc_out sc_logic 1 outvld 2 } 
	{ bucket_sizes_515_out sc_out sc_lv 32 signal 3 } 
	{ bucket_sizes_515_out_ap_vld sc_out sc_logic 1 outvld 3 } 
	{ bucket_sizes_514_out sc_out sc_lv 32 signal 4 } 
	{ bucket_sizes_514_out_ap_vld sc_out sc_logic 1 outvld 4 } 
	{ bucket_sizes_513_out sc_out sc_lv 32 signal 5 } 
	{ bucket_sizes_513_out_ap_vld sc_out sc_logic 1 outvld 5 } 
	{ bucket_sizes_512_out sc_out sc_lv 32 signal 6 } 
	{ bucket_sizes_512_out_ap_vld sc_out sc_logic 1 outvld 6 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "bucket_sizes_515_out", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_sizes_515_out", "role": "default" }} , 
 	{ "name": "bucket_sizes_515_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "bucket_sizes_515_out", "role": "ap_vld" }} , 
 	{ "name": "bucket_sizes_514_out", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_sizes_514_out", "role": "default" }} , 
 	{ "name": "bucket_sizes_514_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "bucket_sizes_514_out", "role": "ap_vld" }} , 
 	{ "name": "bucket_sizes_513_out", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_sizes_513_out", "role": "default" }} , 
 	{ "name": "bucket_sizes_513_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "bucket_sizes_513_out", "role": "ap_vld" }} , 
 	{ "name": "bucket_sizes_512_out", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_sizes_512_out", "role": "default" }} , 
 	{ "name": "bucket_sizes_512_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "bucket_sizes_512_out", "role": "ap_vld" }} , 
...
set Spec2ImplPortList { 
	...
	bucket_sizes_515_out { ap_vld {  { bucket_sizes_515_out out_data 1 32 }  { bucket_sizes_515_out_ap_vld out_vld 1 1 } } }
	bucket_sizes_514_out { ap_vld {  { bucket_sizes_514_out out_data 1 32 }  { bucket_sizes_514_out_ap_vld out_vld 1 1 } } }
	bucket_sizes_513_out { ap_vld {  { bucket_sizes_513_out out_data 1 32 }  { bucket_sizes_513_out_ap_vld out_vld 1 1 } } }
	bucket_sizes_512_out { ap_vld {  { bucket_sizes_512_out out_data 1 32 }  { bucket_sizes_512_out_ap_vld out_vld 1 1 } } }
