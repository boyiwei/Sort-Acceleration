set moduleName radix_sort_bin_batch_22_1_Pipeline_bucket_pointer_initialization
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {radix_sort_bin_batch.22.1_Pipeline_bucket_pointer_initialization}
set C_modelType { void 0 }
set C_modelArgList {
	{ bucket_sizes_726 int 32 regular  }
	{ bucket_sizes_725 int 32 regular  }
	{ bucket_pointer_481 int 32 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "bucket_sizes_726", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "bucket_sizes_725", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "bucket_pointer_481", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ bucket_sizes_726 sc_in sc_lv 32 signal 0 } 
	{ bucket_sizes_725 sc_in sc_lv 32 signal 1 } 
	{ bucket_pointer_481 sc_in sc_lv 32 signal 2 } 
	{ bucket_pointer sc_in sc_lv 32 signal 3 } 
	{ bucket_sizes_728_out sc_out sc_lv 32 signal 4 } 
	{ bucket_sizes_728_out_ap_vld sc_out sc_logic 1 outvld 4 } 
	{ bucket_sizes_727_out sc_out sc_lv 32 signal 5 } 
	{ bucket_sizes_727_out_ap_vld sc_out sc_logic 1 outvld 5 } 
	{ bucket_pointer_484_out sc_out sc_lv 32 signal 6 } 
	{ bucket_pointer_484_out_ap_vld sc_out sc_logic 1 outvld 6 } 
	{ bucket_pointer_483_out sc_out sc_lv 32 signal 7 } 
	{ bucket_pointer_483_out_ap_vld sc_out sc_logic 1 outvld 7 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "bucket_sizes_726", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_sizes_726", "role": "default" }} , 
 	{ "name": "bucket_sizes_725", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_sizes_725", "role": "default" }} , 
 	{ "name": "bucket_pointer_481", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_pointer_481", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_21_32_1_1_U743", "Parent" : "0"},
...
set Spec2ImplPortList { 
	bucket_sizes_726 { ap_none {  { bucket_sizes_726 in_data 0 32 } } }
	bucket_sizes_725 { ap_none {  { bucket_sizes_725 in_data 0 32 } } }
	bucket_pointer_481 { ap_none {  { bucket_pointer_481 in_data 0 32 } } }
