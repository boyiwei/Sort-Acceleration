set moduleName radix_sort_oct_batch_12_1_Pipeline_initialization
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {radix_sort_oct_batch.12.1_Pipeline_initialization}
set C_modelType { void 0 }
set C_modelArgList {
	{ bucket_sizes_4314_reload int 32 regular  }
	{ bucket_sizes_4313_reload int 32 regular  }
	{ bucket_sizes_4312_reload int 32 regular  }
	{ bucket_sizes_4311_reload int 32 regular  }
	{ bucket_sizes_4310_reload int 32 regular  }
	{ bucket_sizes_4309_reload int 32 regular  }
	{ bucket_sizes_4308_reload int 32 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "bucket_sizes_4314_reload", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "bucket_sizes_4313_reload", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "bucket_sizes_4312_reload", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "bucket_sizes_4311_reload", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "bucket_sizes_4310_reload", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "bucket_sizes_4309_reload", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "bucket_sizes_4308_reload", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ bucket_sizes_4314_reload sc_in sc_lv 32 signal 0 } 
	{ bucket_sizes_4313_reload sc_in sc_lv 32 signal 1 } 
	{ bucket_sizes_4312_reload sc_in sc_lv 32 signal 2 } 
	{ bucket_sizes_4311_reload sc_in sc_lv 32 signal 3 } 
	{ bucket_sizes_4310_reload sc_in sc_lv 32 signal 4 } 
	{ bucket_sizes_4309_reload sc_in sc_lv 32 signal 5 } 
	{ bucket_sizes_4308_reload sc_in sc_lv 32 signal 6 } 
	...
	{ input_11_address0 sc_out sc_lv 17 signal 9 } 
	{ input_11_ce0 sc_out sc_logic 1 signal 9 } 
	{ input_11_q0 sc_in sc_lv 32 signal 9 } 
	{ bucket_sizes_4330_out_i sc_in sc_lv 32 signal 10 } 
	{ bucket_sizes_4330_out_o sc_out sc_lv 32 signal 10 } 
	{ bucket_sizes_4330_out_o_ap_vld sc_out sc_logic 1 outvld 10 } 
	{ bucket_sizes_4329_out_i sc_in sc_lv 32 signal 11 } 
	{ bucket_sizes_4329_out_o sc_out sc_lv 32 signal 11 } 
	{ bucket_sizes_4329_out_o_ap_vld sc_out sc_logic 1 outvld 11 } 
	{ bucket_sizes_4328_out_i sc_in sc_lv 32 signal 12 } 
	{ bucket_sizes_4328_out_o sc_out sc_lv 32 signal 12 } 
	{ bucket_sizes_4328_out_o_ap_vld sc_out sc_logic 1 outvld 12 } 
	{ bucket_sizes_4327_out_i sc_in sc_lv 32 signal 13 } 
	{ bucket_sizes_4327_out_o sc_out sc_lv 32 signal 13 } 
	{ bucket_sizes_4327_out_o_ap_vld sc_out sc_logic 1 outvld 13 } 
	{ bucket_sizes_4326_out_i sc_in sc_lv 32 signal 14 } 
	{ bucket_sizes_4326_out_o sc_out sc_lv 32 signal 14 } 
	{ bucket_sizes_4326_out_o_ap_vld sc_out sc_logic 1 outvld 14 } 
	{ bucket_sizes_4325_out_i sc_in sc_lv 32 signal 15 } 
	{ bucket_sizes_4325_out_o sc_out sc_lv 32 signal 15 } 
	{ bucket_sizes_4325_out_o_ap_vld sc_out sc_logic 1 outvld 15 } 
	{ bucket_sizes_4324_out_i sc_in sc_lv 32 signal 16 } 
	{ bucket_sizes_4324_out_o sc_out sc_lv 32 signal 16 } 
	{ bucket_sizes_4324_out_o_ap_vld sc_out sc_logic 1 outvld 16 } 
	{ bucket_sizes_4323_out_i sc_in sc_lv 32 signal 17 } 
	{ bucket_sizes_4323_out_o sc_out sc_lv 32 signal 17 } 
	{ bucket_sizes_4323_out_o_ap_vld sc_out sc_logic 1 outvld 17 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "bucket_sizes_4314_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_sizes_4314_reload", "role": "default" }} , 
 	{ "name": "bucket_sizes_4313_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_sizes_4313_reload", "role": "default" }} , 
 	{ "name": "bucket_sizes_4312_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_sizes_4312_reload", "role": "default" }} , 
 	{ "name": "bucket_sizes_4311_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_sizes_4311_reload", "role": "default" }} , 
 	{ "name": "bucket_sizes_4310_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_sizes_4310_reload", "role": "default" }} , 
 	{ "name": "bucket_sizes_4309_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_sizes_4309_reload", "role": "default" }} , 
 	{ "name": "bucket_sizes_4308_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_sizes_4308_reload", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		"CDFG" : "radix_sort_oct_batch_12_1_Pipeline_initialization",
		"Protocol" : "ap_ctrl_hs",
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "bucket_sizes_4314_reload", "Type" : "None", "Direction" : "I"},
			{"Name" : "bucket_sizes_4313_reload", "Type" : "None", "Direction" : "I"},
			{"Name" : "bucket_sizes_4312_reload", "Type" : "None", "Direction" : "I"},
			{"Name" : "bucket_sizes_4311_reload", "Type" : "None", "Direction" : "I"},
			{"Name" : "bucket_sizes_4310_reload", "Type" : "None", "Direction" : "I"},
			{"Name" : "bucket_sizes_4309_reload", "Type" : "None", "Direction" : "I"},
			{"Name" : "bucket_sizes_4308_reload", "Type" : "None", "Direction" : "I"},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_83_32_1_1_U1166", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.flow_control_loop_pipe_sequential_init_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	radix_sort_oct_batch_12_1_Pipeline_initialization {
		bucket_sizes_4314_reload {Type I LastRead 0 FirstWrite -1}
		bucket_sizes_4313_reload {Type I LastRead 0 FirstWrite -1}
		bucket_sizes_4312_reload {Type I LastRead 0 FirstWrite -1}
		bucket_sizes_4311_reload {Type I LastRead 0 FirstWrite -1}
		bucket_sizes_4310_reload {Type I LastRead 0 FirstWrite -1}
		bucket_sizes_4309_reload {Type I LastRead 0 FirstWrite -1}
		bucket_sizes_4308_reload {Type I LastRead 0 FirstWrite -1}
...
set Spec2ImplPortList { 
	bucket_sizes_4314_reload { ap_none {  { bucket_sizes_4314_reload in_data 0 32 } } }
	bucket_sizes_4313_reload { ap_none {  { bucket_sizes_4313_reload in_data 0 32 } } }
	bucket_sizes_4312_reload { ap_none {  { bucket_sizes_4312_reload in_data 0 32 } } }
	bucket_sizes_4311_reload { ap_none {  { bucket_sizes_4311_reload in_data 0 32 } } }
	bucket_sizes_4310_reload { ap_none {  { bucket_sizes_4310_reload in_data 0 32 } } }
	bucket_sizes_4309_reload { ap_none {  { bucket_sizes_4309_reload in_data 0 32 } } }
	bucket_sizes_4308_reload { ap_none {  { bucket_sizes_4308_reload in_data 0 32 } } }
	...
	input_11 { ap_memory {  { input_11_address0 mem_address 1 17 }  { input_11_ce0 mem_ce 1 1 }  { input_11_q0 in_data 0 32 } } }
