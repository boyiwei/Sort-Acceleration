set moduleName single_heap_sort_Pipeline_VITIS_LOOP_44_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {single_heap_sort_Pipeline_VITIS_LOOP_44_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ zext_ln75 int 22 regular  }
	{ input_r int 32 regular {array 5000000 { 2 1 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "zext_ln75", "interface" : "wire", "bitwidth" : 22, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ zext_ln75 sc_in sc_lv 22 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln75", "direction": "in", "datatype": "sc_lv", "bitwidth":22, "type": "signal", "bundle":{"name": "zext_ln75", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "single_heap_sort_Pipeline_VITIS_LOOP_44_1",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "9", "EstimateLatencyMax" : "25000004",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
...
set ArgLastReadFirstWriteLatency {
	single_heap_sort_Pipeline_VITIS_LOOP_44_1 {
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "9", "Max" : "25000004"}
	, {"Name" : "Interval", "Min" : "9", "Max" : "25000004"}
]}
...
set Spec2ImplPortList { 
	zext_ln75 { ap_none {  { zext_ln75 in_data 0 22 } } }
	input_r { ap_memory {  { input_r_address0 mem_address 1 23 }  { input_r_ce0 mem_ce 1 1 }  { input_r_we0 mem_we 1 1 }  { input_r_d0 mem_din 1 32 }  { input_r_q0 in_data 0 32 }  { input_r_address1 MemPortADDR2 1 23 }  { input_r_ce1 MemPortCE2 1 1 }  { input_r_q1 in_data 0 32 } } }
}
