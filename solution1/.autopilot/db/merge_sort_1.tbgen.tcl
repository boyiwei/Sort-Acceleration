...
set hasInterrupt 0
set C_modelName {merge_sort.1}
set C_modelType { void 0 }
set C_modelArgList {
	{ input1 int 32 regular {array 500000 { 1 3 } 1 1 }  }
	{ input2 int 32 regular {array 500000 { 1 3 } 1 1 }  }
...
set portList { 
	...
	{ output_r_address0 sc_out sc_lv 20 signal 2 } 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "2000002", "Max" : "2000002"}
	, {"Name" : "Interval", "Min" : "2000002", "Max" : "2000002"}
]}
...
set Spec2ImplPortList { 
	...
	output_r { ap_memory {  { output_r_address0 mem_address 1 20 }  { output_r_ce0 mem_ce 1 1 }  { output_r_we0 mem_we 1 1 }  { output_r_d0 mem_din 1 32 } } }
}
