set moduleName radix_sort_unified_bucket_pingpong_18_1_Pipeline_bucket_pointer_initialization
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {radix_sort_unified_bucket_pingpong.18.1_Pipeline_bucket_pointer_initialization}
