set moduleName radix_sort_hex_batch_53_1_Pipeline_bucket_pointer_initialization
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {radix_sort_hex_batch.53.1_Pipeline_bucket_pointer_initialization}
set C_modelType { void 0 }
set C_modelArgList {
	{ bucket_sizes_2110 int 32 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "bucket_sizes_2110", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ bucket_sizes_2110 sc_in sc_lv 32 signal 0 } 
	{ bucket_sizes_2109 sc_in sc_lv 32 signal 1 } 
	{ bucket_sizes_2108 sc_in sc_lv 32 signal 2 } 
	{ bucket_sizes_2107 sc_in sc_lv 32 signal 3 } 
	{ bucket_sizes_2106 sc_in sc_lv 32 signal 4 } 
	{ bucket_sizes_2105 sc_in sc_lv 32 signal 5 } 
	{ bucket_sizes_2104 sc_in sc_lv 32 signal 6 } 
	{ bucket_sizes_2103 sc_in sc_lv 32 signal 7 } 
	{ bucket_sizes_2102 sc_in sc_lv 32 signal 8 } 
	{ bucket_sizes_2101 sc_in sc_lv 32 signal 9 } 
	{ bucket_sizes_2100 sc_in sc_lv 32 signal 10 } 
	{ bucket_sizes_2099 sc_in sc_lv 32 signal 11 } 
	{ bucket_sizes_2098 sc_in sc_lv 32 signal 12 } 
	{ bucket_sizes_2097 sc_in sc_lv 32 signal 13 } 
	{ bucket_sizes_2096 sc_in sc_lv 32 signal 14 } 
	{ bucket_sizes_2095 sc_in sc_lv 32 signal 15 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "bucket_sizes_2110", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bucket_sizes_2110", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		"CDFG" : "radix_sort_hex_batch_53_1_Pipeline_bucket_pointer_initialization",
		"Protocol" : "ap_ctrl_hs",
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "bucket_sizes_2110", "Type" : "None", "Direction" : "I"},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_164_32_1_1_U10090", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.flow_control_loop_pipe_sequential_init_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	radix_sort_hex_batch_53_1_Pipeline_bucket_pointer_initialization {
		bucket_sizes_2110 {Type I LastRead 0 FirstWrite -1}
...
set Spec2ImplPortList { 
	bucket_sizes_2110 { ap_none {  { bucket_sizes_2110 in_data 0 32 } } }
