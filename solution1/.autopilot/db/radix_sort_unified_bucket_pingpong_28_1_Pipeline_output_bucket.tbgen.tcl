set moduleName radix_sort_unified_bucket_pingpong_28_1_Pipeline_output_bucket
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {radix_sort_unified_bucket_pingpong.28.1_Pipeline_output_bucket}
