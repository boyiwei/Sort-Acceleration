...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler sort_top_64_radix_sort_unified_bucket_pingpong_40_1_bucket_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
