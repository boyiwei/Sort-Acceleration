...
reg[17:0] multi_radix_oct_kmerge_temp1_22_address0;
reg multi_radix_oct_kmerge_temp1_22_ce0;
reg[17:0] multi_radix_oct_kmerge_temp1_23_address0;
...
reg   [18:0] multi_radix_oct_kmerge_temp2_11_addr_reg_292;
...
wire    ap_loop_init;
reg   [18:0] ap_sig_allocacmp_i_152;
reg   [31:0] k_fu_38;
...
assign add_ln127_fu_132_p2 = (ap_sig_allocacmp_i_152 + 19'd1);
...
assign icmp_ln127_fu_126_p2 = ((ap_sig_allocacmp_i_152 == 19'd312500) ? 1'b1 : 1'b0);

assign icmp_ln129_9_fu_149_p2 = (($signed(ap_sig_allocacmp_k_134) < $signed(32'd156250)) ? 1'b1 : 1'b0);

assign icmp_ln129_fu_143_p2 = (($signed(ap_sig_allocacmp_j_136) < $signed(32'd156250)) ? 1'b1 : 1'b0);
...
assign icmp_ln140_fu_161_p2 = ((ap_sig_allocacmp_j_136 == 32'd156250) ? 1'b1 : 1'b0);
