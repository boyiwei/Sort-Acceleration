...
module multi_radix_hex_kmerge_radix_sort_batch_13_1_Pipeline_output_bucket (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg multi_radix_hex_kmerge_temp0_12_we0;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        multi_radix_hex_kmerge_temp0_12_we0 = 1'b1;
    end else begin
        multi_radix_hex_kmerge_temp0_12_we0 = 1'b0;
    end
end
...
assign multi_radix_hex_kmerge_temp0_12_address0 = k_cast_i_fu_103_p1;

assign multi_radix_hex_kmerge_temp0_12_d0 = bucket_q0;

assign zext_ln54_59_fu_93_p1 = add_ln54_fu_87_p2;

assign zext_ln54_fu_83_p1 = ap_sig_allocacmp_k_59;

endmodule //multi_radix_hex_kmerge_radix_sort_batch_13_1_Pipeline_output_bucket
