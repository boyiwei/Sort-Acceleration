...
module sort_top_32_merge_sort_35 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire    ap_loop_init;
reg   [19:0] ap_sig_allocacmp_i_70;
reg   [31:0] k_02_fu_38;
...
assign add_ln9_fu_116_p2 = (ap_sig_allocacmp_i_70 + 20'd1);
...
assign icmp_ln12_27_fu_143_p2 = (($signed(ap_sig_allocacmp_k_86) < $signed(32'd312500)) ? 1'b1 : 1'b0);

assign icmp_ln12_fu_137_p2 = (($signed(ap_sig_allocacmp_j_86) < $signed(32'd312500)) ? 1'b1 : 1'b0);

assign icmp_ln13_fu_199_p2 = (($signed(input1_q0) < $signed(input2_q0)) ? 1'b1 : 1'b0);

assign icmp_ln25_fu_155_p2 = ((ap_sig_allocacmp_j_86 == 32'd312500) ? 1'b1 : 1'b0);

assign icmp_ln9_fu_110_p2 = ((ap_sig_allocacmp_i_70 == 20'd625000) ? 1'b1 : 1'b0);
...
assign zext_ln10_27_fu_132_p1 = ap_sig_allocacmp_k_86;

assign zext_ln10_fu_127_p1 = ap_sig_allocacmp_j_86;

assign zext_ln9_fu_122_p1 = ap_sig_allocacmp_i_70;

endmodule //sort_top_32_merge_sort_35
