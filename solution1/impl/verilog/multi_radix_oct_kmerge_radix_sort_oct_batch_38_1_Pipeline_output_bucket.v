...
module multi_radix_oct_kmerge_radix_sort_oct_batch_38_1_Pipeline_output_bucket (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg multi_radix_oct_kmerge_temp0_37_we0;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        multi_radix_oct_kmerge_temp0_37_we0 = 1'b1;
    end else begin
        multi_radix_oct_kmerge_temp0_37_we0 = 1'b0;
    end
end
...
assign multi_radix_oct_kmerge_temp0_37_address0 = k_cast_i_reg_101;
