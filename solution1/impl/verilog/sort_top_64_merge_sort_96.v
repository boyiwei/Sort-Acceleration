...
module sort_top_64_merge_sort_96 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg    ap_ready_int;
reg   [18:0] i_79_reg_249;
reg    ap_block_pp0_stage0_11001;
reg   [31:0] k_72_reg_254;
reg   [31:0] j_72_reg_259;
...
assign add_ln9_fu_117_p2 = (ap_sig_allocacmp_i_79 + 19'd1);
...
assign icmp_ln12_4_fu_139_p2 = (($signed(ap_sig_allocacmp_k_72) < $signed(32'd156250)) ? 1'b1 : 1'b0);

assign icmp_ln12_fu_133_p2 = (($signed(ap_sig_allocacmp_j_72) < $signed(32'd156250)) ? 1'b1 : 1'b0);

assign icmp_ln13_fu_199_p2 = (($signed(input1_q0) < $signed(input2_q0)) ? 1'b1 : 1'b0);

assign icmp_ln25_fu_151_p2 = ((ap_sig_allocacmp_j_72 == 32'd156250) ? 1'b1 : 1'b0);

assign icmp_ln9_fu_111_p2 = ((ap_sig_allocacmp_i_79 == 19'd312500) ? 1'b1 : 1'b0);

assign input1_address0 = zext_ln10_fu_123_p1;

assign input2_address0 = zext_ln10_4_fu_128_p1;

assign j_73_fu_163_p2 = (ap_sig_allocacmp_j_72 + 32'd1);

assign j_fu_215_p2 = (j_72_reg_259 + 32'd1);

assign k_73_fu_174_p2 = (ap_sig_allocacmp_k_72 + 32'd1);

assign k_fu_205_p2 = (k_72_reg_254 + 32'd1);

assign sorted_data_address0 = zext_ln9_fu_195_p1;

assign zext_ln10_4_fu_128_p1 = ap_sig_allocacmp_k_72;

assign zext_ln10_fu_123_p1 = ap_sig_allocacmp_j_72;

assign zext_ln9_fu_195_p1 = i_79_reg_249;

endmodule //sort_top_64_merge_sort_96
