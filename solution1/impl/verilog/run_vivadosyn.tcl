...
set ip_vlnv xilinx.com:hls:single_heap_sort:1.0
set ip_repo_path ../ip
...
dict set report_options hls_project sort_seperate_bucket
...
dict set report_options bindmodules single_heap_sort_flow_control_loop_pipe_sequential_init
