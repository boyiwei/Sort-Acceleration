...
module multi_radix_bin_kmerge_merge_sort_batch1_101 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output   multi_radix_bin_kmerge_temp2_6_we0;
output  [31:0] multi_radix_bin_kmerge_temp2_6_d0;
output  [18:0] multi_radix_bin_kmerge_temp1_12_address0;
output   multi_radix_bin_kmerge_temp1_12_ce0;
input  [31:0] multi_radix_bin_kmerge_temp1_12_q0;
output  [18:0] multi_radix_bin_kmerge_temp1_13_address0;
output   multi_radix_bin_kmerge_temp1_13_ce0;
input  [31:0] multi_radix_bin_kmerge_temp1_13_q0;

reg ap_idle;
reg multi_radix_bin_kmerge_temp2_6_ce0;
reg multi_radix_bin_kmerge_temp2_6_we0;
reg[31:0] multi_radix_bin_kmerge_temp2_6_d0;
reg[18:0] multi_radix_bin_kmerge_temp1_12_address0;
reg multi_radix_bin_kmerge_temp1_12_ce0;
reg[18:0] multi_radix_bin_kmerge_temp1_13_address0;
...
reg   [19:0] multi_radix_bin_kmerge_temp2_6_addr_reg_292;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln127_fu_126_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        multi_radix_bin_kmerge_temp2_6_addr_reg_292 <= zext_ln127_fu_138_p1;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_condition_113)) begin
        if ((1'd1 == and_ln129_fu_155_p2)) begin
            multi_radix_bin_kmerge_temp1_12_address0 = zext_ln130_fu_210_p1;
        end else if (((1'd0 == and_ln140_fu_167_p2) & (1'd0 == and_ln129_fu_155_p2))) begin
            multi_radix_bin_kmerge_temp1_12_address0 = zext_ln145_fu_173_p1;
        end else begin
            multi_radix_bin_kmerge_temp1_12_address0 = 'bx;
        end
    end else begin
        multi_radix_bin_kmerge_temp1_12_address0 = 'bx;
    end
...
always @ (*) begin
    if ((1'b1 == ap_condition_113)) begin
        if ((1'd1 == and_ln129_fu_155_p2)) begin
            multi_radix_bin_kmerge_temp1_13_address0 = zext_ln130_14_fu_215_p1;
        end else if (((1'd0 == and_ln129_fu_155_p2) & (1'd1 == and_ln140_fu_167_p2))) begin
            multi_radix_bin_kmerge_temp1_13_address0 = zext_ln141_fu_189_p1;
        end else begin
            multi_radix_bin_kmerge_temp1_13_address0 = 'bx;
        end
    end else begin
        multi_radix_bin_kmerge_temp1_13_address0 = 'bx;
    end
...
always @ (*) begin
    if ((((1'd0 == and_ln129_reg_288) & (1'd1 == and_ln140_reg_297) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)) | ((1'd1 == and_ln129_reg_288) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln130_fu_225_p2 == 1'd0)))) begin
        ...
        multi_radix_bin_kmerge_temp2_6_d0 = 'bx;
    end
end

always @ (*) begin
    if ((((1'd0 == and_ln140_reg_297) & (1'd0 == and_ln129_reg_288) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)) | ((1'd0 == and_ln129_reg_288) & (1'd1 == and_ln140_reg_297) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)) | ((1'd1 == and_ln129_reg_288) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln130_fu_225_p2 == 1'd1)) | ((1'd1 == and_ln129_reg_288) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln130_fu_225_p2 == 1'd0)))) begin
        multi_radix_bin_kmerge_temp2_6_we0 = 1'b1;
    end else begin
        multi_radix_bin_kmerge_temp2_6_we0 = 1'b0;
    end
end
...
assign icmp_ln130_fu_225_p2 = (($signed(multi_radix_bin_kmerge_temp1_12_q0) < $signed(multi_radix_bin_kmerge_temp1_13_q0)) ? 1'b1 : 1'b0);
...
assign multi_radix_bin_kmerge_temp2_6_address0 = multi_radix_bin_kmerge_temp2_6_addr_reg_292;
...
endmodule //multi_radix_bin_kmerge_merge_sort_batch1_101
