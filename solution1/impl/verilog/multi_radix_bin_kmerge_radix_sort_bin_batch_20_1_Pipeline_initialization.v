...
module multi_radix_bin_kmerge_radix_sort_bin_batch_20_1_Pipeline_initialization (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg    ap_ready_int;
reg   [17:0] j_52_reg_194;
wire    ap_block_pp0_stage0_11001;
wire   [63:0] j_cast_i_fu_107_p1;
wire    ap_block_pp0_stage0;
wire   [63:0] zext_ln21_51_fu_134_p1;
wire   [31:0] bucket_sizes_404_fu_159_p3;
wire    ap_loop_init;
wire   [31:0] bucket_sizes_405_fu_167_p3;
reg   [17:0] j_fu_44;
...
assign add_ln20_fu_101_p2 = (ap_sig_allocacmp_j_52 + 18'd1);
...
assign bucket_address0 = zext_ln21_51_fu_134_p1;

assign bucket_d0 = input_19_q0;

assign bucket_sizes_404_fu_159_p3 = ((trunc_ln23_fu_139_p1[0:0] == 1'b1) ? bucket_sizes_fu_153_p2 : bucket_sizes_751_out_i);

assign bucket_sizes_405_fu_167_p3 = ((trunc_ln23_fu_139_p1[0:0] == 1'b1) ? bucket_sizes_out_i : bucket_sizes_fu_153_p2);

assign bucket_sizes_fu_153_p2 = (tmp_i_fu_143_p4 + 32'd1);

assign icmp_ln20_fu_95_p2 = ((ap_sig_allocacmp_j_52 == 18'd156250) ? 1'b1 : 1'b0);

assign input_19_address0 = j_cast_i_fu_107_p1;

assign j_cast_i_fu_107_p1 = ap_sig_allocacmp_j_52;

assign trunc_ln23_fu_139_p1 = input_19_q0[0:0];

assign zext_ln21_51_fu_134_p1 = add_ln21_fu_128_p2;

assign zext_ln21_fu_125_p1 = j_52_reg_194;

endmodule //multi_radix_bin_kmerge_radix_sort_bin_batch_20_1_Pipeline_initialization
