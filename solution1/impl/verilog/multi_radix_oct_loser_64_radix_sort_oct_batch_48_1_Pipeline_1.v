...
module multi_radix_oct_loser_64_radix_sort_oct_batch_48_1_Pipeline_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
        ap_idle,
        ap_ready,
        bucket_sizes_1467_out,
        bucket_sizes_1467_out_ap_vld,
        bucket_sizes_1466_out,
        bucket_sizes_1466_out_ap_vld,
...
output   ap_idle;
output   ap_ready;
output  [31:0] bucket_sizes_1467_out;
output   bucket_sizes_1467_out_ap_vld;
output  [31:0] bucket_sizes_1466_out;
output   bucket_sizes_1466_out_ap_vld;
...
reg ap_idle;
reg bucket_sizes_1467_out_ap_vld;
reg bucket_sizes_1466_out_ap_vld;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1))) begin
        if ((exitcond116_i_fu_152_p2 == 1'd0)) begin
            empty_fu_52 <= empty_138_fu_158_p2;
...
always @ (*) begin
    if (((exitcond116_i_fu_152_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1))) begin
        bucket_sizes_1466_out_ap_vld = 1'b1;
    end else begin
        bucket_sizes_1466_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((exitcond116_i_fu_152_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1))) begin
        bucket_sizes_1467_out_ap_vld = 1'b1;
    end else begin
        bucket_sizes_1467_out_ap_vld = 1'b0;
    end
end
...
assign bucket_sizes_1466_out = 32'd0;

assign bucket_sizes_1467_out = 32'd0;

assign bucket_sizes_out = 32'd0;

assign empty_138_fu_158_p2 = (ap_sig_allocacmp_p_load + 4'd1);

assign exitcond116_i_fu_152_p2 = ((ap_sig_allocacmp_p_load == 4'd8) ? 1'b1 : 1'b0);

endmodule //multi_radix_oct_loser_64_radix_sort_oct_batch_48_1_Pipeline_1
