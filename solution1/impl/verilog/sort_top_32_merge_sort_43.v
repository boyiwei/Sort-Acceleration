...
module sort_top_32_merge_sort_43 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg    ap_ready_int;
reg   [31:0] k_70_reg_249;
reg    ap_block_pp0_stage0_11001;
reg   [31:0] j_70_reg_254;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        j_70_reg_254 <= ap_sig_allocacmp_j_70;
        k_70_reg_249 <= ap_sig_allocacmp_k_70;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        ap_sig_allocacmp_i_62 = 20'd0;
    end else begin
        ap_sig_allocacmp_i_62 = i_fu_34;
    end
end
...
assign add_ln9_fu_116_p2 = (ap_sig_allocacmp_i_62 + 20'd1);
...
assign icmp_ln12_19_fu_143_p2 = (($signed(ap_sig_allocacmp_k_70) < $signed(32'd312500)) ? 1'b1 : 1'b0);

assign icmp_ln12_fu_137_p2 = (($signed(ap_sig_allocacmp_j_70) < $signed(32'd312500)) ? 1'b1 : 1'b0);

assign icmp_ln13_fu_199_p2 = (($signed(input1_q0) < $signed(input2_q0)) ? 1'b1 : 1'b0);

assign icmp_ln25_fu_155_p2 = ((ap_sig_allocacmp_j_70 == 32'd312500) ? 1'b1 : 1'b0);

assign icmp_ln9_fu_110_p2 = ((ap_sig_allocacmp_i_62 == 20'd625000) ? 1'b1 : 1'b0);

assign input1_address0 = zext_ln10_fu_127_p1;

assign input2_address0 = zext_ln10_19_fu_132_p1;

assign j_71_fu_167_p2 = (ap_sig_allocacmp_j_70 + 32'd1);

assign j_fu_215_p2 = (j_70_reg_254 + 32'd1);

assign k_71_fu_178_p2 = (ap_sig_allocacmp_k_70 + 32'd1);

assign k_fu_205_p2 = (k_70_reg_249 + 32'd1);

assign sorted_data_address0 = sorted_data_addr_reg_276;

assign zext_ln10_19_fu_132_p1 = ap_sig_allocacmp_k_70;

assign zext_ln10_fu_127_p1 = ap_sig_allocacmp_j_70;

assign zext_ln9_fu_122_p1 = ap_sig_allocacmp_i_62;

endmodule //sort_top_32_merge_sort_43
