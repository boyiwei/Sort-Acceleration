...
module radix_sort_seperate_bucket_parallel_input_bucket_1_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [31:0] zext_ln101_fu_101_p1;
reg   [31:0] zext_ln101_reg_183;
wire    ap_CS_fsm_state2;
wire   [0:0] icmp_ln101_fu_118_p2;
...
wire   [63:0] zext_ln101_1_fu_113_p1;
wire   [63:0] zext_ln104_fu_148_p1;
wire   [63:0] zext_ln104_2_fu_163_p1;
wire    ap_CS_fsm_state6;
reg   [4:0] j_fu_44;
wire   [4:0] add_ln101_fu_124_p2;
reg    ap_block_state1;
...
radix_sort_seperate_bucket_parallel_mac_muladd_4ns_5ns_9ns_9_4_1 #(
    .ID( 1 ),
    .NUM_STAGE( 4 ),
    .din0_WIDTH( 4 ),
    .din1_WIDTH( 5 ),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((icmp_ln101_fu_118_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((~((ap_done_reg == 1'b1) | (ap_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        j_fu_44 <= 5'd0;
    end else if (((icmp_ln101_fu_118_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        bucket_pointer_addr_reg_211 <= zext_ln104_fu_148_p1;
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state1)) begin
        zext_ln101_reg_183[4 : 2] <= zext_ln101_fu_101_p1[4 : 2];
    end
end
...
always @ (*) begin
    if (((icmp_ln101_fu_118_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state5)) begin
        ...
        bucket_pointer_address0 = zext_ln104_fu_148_p1;
    end else begin
...
assign add_ln101_fu_124_p2 = (j_fu_44 + 5'd1);
...
assign bucket_address0 = zext_ln104_2_fu_163_p1;
...
assign icmp_ln101_fu_118_p2 = ((j_fu_44 == 5'd25) ? 1'b1 : 1'b0);

assign ith_radix_fu_140_p1 = shifted_fu_135_p2[3:0];

assign mul_fu_93_p3 = {{i}, {2'd0}};

assign shifted_fu_135_p2 = $signed(sorted_data_q0) >>> zext_ln101_reg_183;

assign sorted_data_address0 = zext_ln101_1_fu_113_p1;

assign zext_ln101_1_fu_113_p1 = j_fu_44;

assign zext_ln101_fu_101_p1 = mul_fu_93_p3;

assign zext_ln104_2_fu_163_p1 = grp_fu_167_p3;

assign zext_ln104_fu_148_p1 = ith_radix_reg_201;

always @ (posedge ap_clk) begin
    zext_ln101_reg_183[1:0] <= 2'b00;
    zext_ln101_reg_183[31:5] <= 27'b000000000000000000000000000;
end

endmodule //radix_sort_seperate_bucket_parallel_input_bucket_1_1
