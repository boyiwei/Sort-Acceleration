...
module multi_radix_bin_kmerge_radix_sort_bin_batch_18_1_Pipeline_input_bucket (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
        ap_idle,
        ap_ready,
        bucket_sizes_803_reload,
        bucket_sizes_802_reload,
        bucket_pointer_534_reload,
        bucket_pointer_533_reload,
        mul_ln41,
        bucket_address0,
        bucket_ce0,
        bucket_we0,
        ...
        bucket_sizes_807_out_o,
        bucket_sizes_807_out_o_ap_vld,
        bucket_sizes_806_out_i,
        bucket_sizes_806_out_o,
        bucket_sizes_806_out_o_ap_vld,
        bucket_pointer_536_out_i,
        bucket_pointer_536_out_o,
        bucket_pointer_536_out_o_ap_vld,
        bucket_pointer_535_out_i,
        bucket_pointer_535_out_o,
        bucket_pointer_535_out_o_ap_vld
);
...
output   ap_idle;
output   ap_ready;
input  [31:0] bucket_sizes_803_reload;
input  [31:0] bucket_sizes_802_reload;
input  [31:0] bucket_pointer_534_reload;
input  [31:0] bucket_pointer_533_reload;
input  [18:0] mul_ln41;
...
input  [4:0] zext_ln27;
input  [18:0] mul_ln43;
input  [31:0] bucket_sizes_807_out_i;
output  [31:0] bucket_sizes_807_out_o;
output   bucket_sizes_807_out_o_ap_vld;
input  [31:0] bucket_sizes_806_out_i;
output  [31:0] bucket_sizes_806_out_o;
output   bucket_sizes_806_out_o_ap_vld;
input  [31:0] bucket_pointer_536_out_i;
output  [31:0] bucket_pointer_536_out_o;
output   bucket_pointer_536_out_o_ap_vld;
input  [31:0] bucket_pointer_535_out_i;
output  [31:0] bucket_pointer_535_out_o;
output   bucket_pointer_535_out_o_ap_vld;

reg ap_idle;
reg bucket_ce0;
reg bucket_we0;
reg bucket_ce1;
reg[31:0] bucket_sizes_807_out_o;
reg bucket_sizes_807_out_o_ap_vld;
reg[31:0] bucket_sizes_806_out_o;
reg bucket_sizes_806_out_o_ap_vld;
reg[31:0] bucket_pointer_536_out_o;
reg bucket_pointer_536_out_o_ap_vld;
reg[31:0] bucket_pointer_535_out_o;
reg bucket_pointer_535_out_o_ap_vld;
...
wire   [63:0] zext_ln41_54_fu_209_p1;
reg   [63:0] zext_ln41_54_reg_418;
wire    ap_block_pp0_stage0;
wire   [63:0] zext_ln43_fu_283_p1;
wire   [31:0] bucket_sizes_426_fu_344_p3;
wire    ap_loop_init;
wire   [31:0] bucket_sizes_427_fu_352_p3;
wire   [31:0] bucket_pointer_265_fu_304_p3;
wire   [31:0] bucket_pointer_266_fu_312_p3;
...
wire   [31:0] tmp_92_i_fu_264_p4;
wire   [18:0] trunc_ln43_54_fu_274_p1;
wire   [18:0] add_ln43_fu_278_p2;
wire   [31:0] bucket_pointer_fu_298_p2;
wire   [0:0] tmp_93_i_fu_328_p3;
wire   [0:0] tmp_fu_320_p3;
wire   [31:0] tmp_93_i_fu_328_p4;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln40_fu_187_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        zext_ln41_54_reg_418[18 : 0] <= zext_ln41_54_fu_209_p1[18 : 0];
    end
end
...
always @ (*) begin
    if ((((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)) | ((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1)))) begin
        bucket_pointer_535_out_o_ap_vld = 1'b1;
    end else begin
        bucket_pointer_535_out_o_ap_vld = 1'b0;
    end
end
...
always @ (*) begin
    if ((((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)) | ((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1)))) begin
        bucket_pointer_536_out_o_ap_vld = 1'b1;
    end else begin
        bucket_pointer_536_out_o_ap_vld = 1'b0;
    end
end
...
always @ (*) begin
    if ((((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)) | ((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1)))) begin
        bucket_sizes_806_out_o_ap_vld = 1'b1;
    end else begin
        bucket_sizes_806_out_o_ap_vld = 1'b0;
    end
end
...
always @ (*) begin
    if ((((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)) | ((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1)))) begin
        bucket_sizes_807_out_o_ap_vld = 1'b1;
    end else begin
        bucket_sizes_807_out_o_ap_vld = 1'b0;
    end
end
...
assign add_ln43_fu_278_p2 = (mul_ln43 + trunc_ln43_54_fu_274_p1);

assign addr_cmp_fu_241_p2 = ((reuse_addr_reg_fu_62 == zext_ln41_54_reg_418) ? 1'b1 : 1'b0);
...
assign bucket_address1 = zext_ln41_54_fu_209_p1;

assign bucket_d0 = reuse_select_fu_246_p3;

assign bucket_pointer_265_fu_304_p3 = ((trunc_ln43_fu_260_p1[0:0] == 1'b1) ? bucket_pointer_fu_298_p2 : bucket_pointer_536_out_i);

assign bucket_pointer_266_fu_312_p3 = ((trunc_ln43_fu_260_p1[0:0] == 1'b1) ? bucket_pointer_535_out_i : bucket_pointer_fu_298_p2);

assign bucket_pointer_fu_298_p2 = (tmp_92_i_fu_264_p4 + 32'd1);

assign bucket_sizes_426_fu_344_p3 = ((tmp_fu_320_p3[0:0] == 1'b1) ? bucket_sizes_fu_338_p2 : bucket_sizes_807_out_i);

assign bucket_sizes_427_fu_352_p3 = ((tmp_fu_320_p3[0:0] == 1'b1) ? bucket_sizes_806_out_i : bucket_sizes_fu_338_p2);

assign bucket_sizes_fu_338_p2 = (tmp_93_i_fu_328_p4 + 32'd1);
...
assign tmp_93_i_fu_328_p3 = shifted_fu_255_p2[32'd1];

assign tmp_fu_320_p3 = shifted_fu_255_p2[32'd1];

assign trunc_ln43_54_fu_274_p1 = tmp_92_i_fu_264_p4[18:0];

assign trunc_ln43_fu_260_p1 = shifted_fu_255_p2[0:0];

assign zext_ln27_cast_fu_141_p1 = zext_ln27;

assign zext_ln41_54_fu_209_p1 = add_ln41_fu_203_p2;
...
always @ (posedge ap_clk) begin
    ...
    zext_ln41_54_reg_418[63:19] <= 45'b000000000000000000000000000000000000000000000;
end

endmodule //multi_radix_bin_kmerge_radix_sort_bin_batch_18_1_Pipeline_input_bucket
