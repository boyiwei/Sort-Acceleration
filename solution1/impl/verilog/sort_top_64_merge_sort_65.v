...
module sort_top_64_merge_sort_65 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg    ap_ready_int;
reg   [31:0] k_134_reg_249;
reg    ap_block_pp0_stage0_11001;
reg   [31:0] j_134_reg_254;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        j_134_reg_254 <= ap_sig_allocacmp_j_134;
        k_134_reg_249 <= ap_sig_allocacmp_k_134;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        ap_sig_allocacmp_i_110 = 19'd0;
    end else begin
        ap_sig_allocacmp_i_110 = i_fu_34;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_start_int == 1'b1) & (ap_loop_init == 1'b1))) begin
            ap_sig_allocacmp_j_134 = 32'd0;
        end else if ((1'b1 == ap_condition_259)) begin
            ap_sig_allocacmp_j_134 = j_fu_215_p2;
        end else begin
            ap_sig_allocacmp_j_134 = j_01_fu_42;
        end
    end else begin
        ap_sig_allocacmp_j_134 = j_01_fu_42;
    end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_start_int == 1'b1) & (ap_loop_init == 1'b1))) begin
            ...
            ap_sig_allocacmp_k_134 = k_fu_205_p2;
        end else begin
            ap_sig_allocacmp_k_134 = k_02_fu_38;
        end
    end else begin
        ap_sig_allocacmp_k_134 = k_02_fu_38;
    end
...
assign add_ln9_fu_116_p2 = (ap_sig_allocacmp_i_110 + 19'd1);

assign and_ln12_fu_149_p2 = (icmp_ln12_fu_137_p2 & icmp_ln12_35_fu_143_p2);

assign and_ln25_fu_161_p2 = (icmp_ln25_fu_155_p2 & icmp_ln12_35_fu_143_p2);
...
assign icmp_ln12_35_fu_143_p2 = (($signed(ap_sig_allocacmp_k_134) < $signed(32'd156250)) ? 1'b1 : 1'b0);

assign icmp_ln12_fu_137_p2 = (($signed(ap_sig_allocacmp_j_134) < $signed(32'd156250)) ? 1'b1 : 1'b0);

assign icmp_ln13_fu_199_p2 = (($signed(input1_q0) < $signed(input2_q0)) ? 1'b1 : 1'b0);

assign icmp_ln25_fu_155_p2 = ((ap_sig_allocacmp_j_134 == 32'd156250) ? 1'b1 : 1'b0);

assign icmp_ln9_fu_110_p2 = ((ap_sig_allocacmp_i_110 == 19'd312500) ? 1'b1 : 1'b0);

assign input1_address0 = zext_ln10_fu_127_p1;

assign input2_address0 = zext_ln10_35_fu_132_p1;

assign j_135_fu_167_p2 = (ap_sig_allocacmp_j_134 + 32'd1);

assign j_fu_215_p2 = (j_134_reg_254 + 32'd1);

assign k_135_fu_178_p2 = (ap_sig_allocacmp_k_134 + 32'd1);

assign k_fu_205_p2 = (k_134_reg_249 + 32'd1);

assign sorted_data_address0 = sorted_data_addr_reg_276;

assign zext_ln10_35_fu_132_p1 = ap_sig_allocacmp_k_134;

assign zext_ln10_fu_127_p1 = ap_sig_allocacmp_j_134;

assign zext_ln9_fu_122_p1 = ap_sig_allocacmp_i_110;

endmodule //sort_top_64_merge_sort_65
