...
module sort_top_32_merge_sort_34 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [63:0] zext_ln10_28_fu_132_p1;
wire   [63:0] zext_ln9_fu_122_p1;
reg   [19:0] i_fu_34;
wire   [19:0] add_ln9_fu_116_p2;
wire    ap_loop_init;
reg   [19:0] ap_sig_allocacmp_i_71;
reg   [31:0] k_02_fu_38;
...
wire   [0:0] icmp_ln12_28_fu_143_p2;
...
assign add_ln9_fu_116_p2 = (ap_sig_allocacmp_i_71 + 20'd1);

assign and_ln12_fu_149_p2 = (icmp_ln12_fu_137_p2 & icmp_ln12_28_fu_143_p2);

assign and_ln25_fu_161_p2 = (icmp_ln25_fu_155_p2 & icmp_ln12_28_fu_143_p2);
...
assign icmp_ln12_28_fu_143_p2 = (($signed(ap_sig_allocacmp_k_88) < $signed(32'd312500)) ? 1'b1 : 1'b0);

assign icmp_ln12_fu_137_p2 = (($signed(ap_sig_allocacmp_j_88) < $signed(32'd312500)) ? 1'b1 : 1'b0);

assign icmp_ln13_fu_199_p2 = (($signed(input1_q0) < $signed(input2_q0)) ? 1'b1 : 1'b0);

assign icmp_ln25_fu_155_p2 = ((ap_sig_allocacmp_j_88 == 32'd312500) ? 1'b1 : 1'b0);

assign icmp_ln9_fu_110_p2 = ((ap_sig_allocacmp_i_71 == 20'd625000) ? 1'b1 : 1'b0);

assign input1_address0 = zext_ln10_fu_127_p1;

assign input2_address0 = zext_ln10_28_fu_132_p1;
...
assign zext_ln10_28_fu_132_p1 = ap_sig_allocacmp_k_88;

assign zext_ln10_fu_127_p1 = ap_sig_allocacmp_j_88;

assign zext_ln9_fu_122_p1 = ap_sig_allocacmp_i_71;

endmodule //sort_top_32_merge_sort_34
