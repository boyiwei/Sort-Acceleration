...
module sort_top_32_merge_sort_61 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg    ap_ready_int;
reg   [19:0] i_44_reg_249;
reg    ap_block_pp0_stage0_11001;
reg   [31:0] k_33_reg_254;
reg   [31:0] j_34_reg_259;
...
wire    ap_loop_init;
reg   [19:0] ap_sig_allocacmp_i_44;
reg   [31:0] k_fu_38;
wire   [31:0] k_34_fu_205_p2;
wire   [31:0] k_35_fu_174_p2;
wire   [0:0] icmp_ln13_fu_199_p2;
reg   [31:0] ap_sig_allocacmp_k_33;
reg   [31:0] j_01_fu_42;
wire   [31:0] j_fu_215_p2;
wire   [31:0] j_35_fu_163_p2;
...
assign add_ln9_fu_117_p2 = (ap_sig_allocacmp_i_44 + 20'd1);
...
assign icmp_ln12_1_fu_139_p2 = (($signed(ap_sig_allocacmp_k_33) < $signed(32'd312500)) ? 1'b1 : 1'b0);

assign icmp_ln12_fu_133_p2 = (($signed(ap_sig_allocacmp_j_34) < $signed(32'd312500)) ? 1'b1 : 1'b0);

assign icmp_ln13_fu_199_p2 = (($signed(input1_q0) < $signed(input2_q0)) ? 1'b1 : 1'b0);

assign icmp_ln25_fu_151_p2 = ((ap_sig_allocacmp_j_34 == 32'd312500) ? 1'b1 : 1'b0);

assign icmp_ln9_fu_111_p2 = ((ap_sig_allocacmp_i_44 == 20'd625000) ? 1'b1 : 1'b0);

assign input1_address0 = zext_ln10_fu_123_p1;

assign input2_address0 = zext_ln10_1_fu_128_p1;

assign j_35_fu_163_p2 = (ap_sig_allocacmp_j_34 + 32'd1);

assign j_fu_215_p2 = (j_34_reg_259 + 32'd1);

assign k_34_fu_205_p2 = (k_33_reg_254 + 32'd1);

assign k_35_fu_174_p2 = (ap_sig_allocacmp_k_33 + 32'd1);

assign sorted_data_address0 = zext_ln9_fu_195_p1;

assign zext_ln10_1_fu_128_p1 = ap_sig_allocacmp_k_33;

assign zext_ln10_fu_123_p1 = ap_sig_allocacmp_j_34;

assign zext_ln9_fu_195_p1 = i_44_reg_249;

endmodule //sort_top_32_merge_sort_61
