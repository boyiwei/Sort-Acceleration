...
module sort_top_64_merge_sort_77 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg    ap_ready_int;
reg   [31:0] k_110_reg_249;
reg    ap_block_pp0_stage0_11001;
reg   [31:0] j_110_reg_254;
...
wire    ap_loop_init;
reg   [18:0] ap_sig_allocacmp_i_98;
reg   [31:0] k_02_fu_38;
wire   [31:0] k_fu_205_p2;
wire   [31:0] k_111_fu_178_p2;
wire   [0:0] icmp_ln13_fu_199_p2;
reg   [31:0] ap_sig_allocacmp_k_110;
reg   [31:0] j_01_fu_42;
wire   [31:0] j_fu_215_p2;
wire   [31:0] j_111_fu_167_p2;
reg   [31:0] ap_sig_allocacmp_j_110;
...
assign add_ln9_fu_116_p2 = (ap_sig_allocacmp_i_98 + 19'd1);
...
assign icmp_ln12_23_fu_143_p2 = (($signed(ap_sig_allocacmp_k_110) < $signed(32'd156250)) ? 1'b1 : 1'b0);

assign icmp_ln12_fu_137_p2 = (($signed(ap_sig_allocacmp_j_110) < $signed(32'd156250)) ? 1'b1 : 1'b0);

assign icmp_ln13_fu_199_p2 = (($signed(input1_q0) < $signed(input2_q0)) ? 1'b1 : 1'b0);

assign icmp_ln25_fu_155_p2 = ((ap_sig_allocacmp_j_110 == 32'd156250) ? 1'b1 : 1'b0);

assign icmp_ln9_fu_110_p2 = ((ap_sig_allocacmp_i_98 == 19'd312500) ? 1'b1 : 1'b0);

assign input1_address0 = zext_ln10_fu_127_p1;

assign input2_address0 = zext_ln10_23_fu_132_p1;

assign j_111_fu_167_p2 = (ap_sig_allocacmp_j_110 + 32'd1);

assign j_fu_215_p2 = (j_110_reg_254 + 32'd1);

assign k_111_fu_178_p2 = (ap_sig_allocacmp_k_110 + 32'd1);

assign k_fu_205_p2 = (k_110_reg_249 + 32'd1);

assign sorted_data_address0 = sorted_data_addr_reg_276;

assign zext_ln10_23_fu_132_p1 = ap_sig_allocacmp_k_110;

assign zext_ln10_fu_127_p1 = ap_sig_allocacmp_j_110;

assign zext_ln9_fu_122_p1 = ap_sig_allocacmp_i_98;

endmodule //sort_top_64_merge_sort_77
