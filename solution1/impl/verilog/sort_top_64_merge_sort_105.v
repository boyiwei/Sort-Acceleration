...
module sort_top_64_merge_sort_105 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg    ap_ready_int;
reg   [18:0] i_132_reg_249;
reg    ap_block_pp0_stage0_11001;
reg   [31:0] k_178_reg_254;
reg   [31:0] j_178_reg_259;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        i_132_reg_249 <= ap_sig_allocacmp_i_132;
        j_178_reg_259 <= ap_sig_allocacmp_j_178;
        k_178_reg_254 <= ap_sig_allocacmp_k_178;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_start_int == 1'b1) & (ap_loop_init == 1'b1))) begin
            ...
            ap_sig_allocacmp_j_178 = j_fu_215_p2;
        end else begin
            ap_sig_allocacmp_j_178 = j_01_fu_42;
        end
    end else begin
        ap_sig_allocacmp_j_178 = j_01_fu_42;
    end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_start_int == 1'b1) & (ap_loop_init == 1'b1))) begin
            ap_sig_allocacmp_k_178 = 32'd0;
        end else if ((1'b1 == ap_condition_261)) begin
            ap_sig_allocacmp_k_178 = k_fu_205_p2;
        end else begin
            ap_sig_allocacmp_k_178 = k_02_fu_38;
        end
    end else begin
        ap_sig_allocacmp_k_178 = k_02_fu_38;
    end
...
assign add_ln9_fu_117_p2 = (ap_sig_allocacmp_i_132 + 19'd1);

assign and_ln12_fu_145_p2 = (icmp_ln12_fu_133_p2 & icmp_ln12_57_fu_139_p2);

assign and_ln25_fu_157_p2 = (icmp_ln25_fu_151_p2 & icmp_ln12_57_fu_139_p2);
...
assign icmp_ln12_57_fu_139_p2 = (($signed(ap_sig_allocacmp_k_178) < $signed(32'd156250)) ? 1'b1 : 1'b0);

assign icmp_ln12_fu_133_p2 = (($signed(ap_sig_allocacmp_j_178) < $signed(32'd156250)) ? 1'b1 : 1'b0);

assign icmp_ln13_fu_199_p2 = (($signed(input1_q0) < $signed(input2_q0)) ? 1'b1 : 1'b0);

assign icmp_ln25_fu_151_p2 = ((ap_sig_allocacmp_j_178 == 32'd156250) ? 1'b1 : 1'b0);

assign icmp_ln9_fu_111_p2 = ((ap_sig_allocacmp_i_132 == 19'd312500) ? 1'b1 : 1'b0);

assign input1_address0 = zext_ln10_fu_123_p1;

assign input2_address0 = zext_ln10_57_fu_128_p1;

assign j_179_fu_163_p2 = (ap_sig_allocacmp_j_178 + 32'd1);

assign j_fu_215_p2 = (j_178_reg_259 + 32'd1);

assign k_179_fu_174_p2 = (ap_sig_allocacmp_k_178 + 32'd1);

assign k_fu_205_p2 = (k_178_reg_254 + 32'd1);

assign sorted_data_address0 = zext_ln9_fu_195_p1;

assign zext_ln10_57_fu_128_p1 = ap_sig_allocacmp_k_178;

assign zext_ln10_fu_123_p1 = ap_sig_allocacmp_j_178;

assign zext_ln9_fu_195_p1 = i_132_reg_249;

endmodule //sort_top_64_merge_sort_105
