...
module multi_radix_oct_kmerge_merge_sort_batch1_97 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
        ...
        multi_radix_oct_kmerge_temp2_2_we0,
        multi_radix_oct_kmerge_temp2_2_d0,
        multi_radix_oct_kmerge_temp1_4_address0,
        multi_radix_oct_kmerge_temp1_4_ce0,
        multi_radix_oct_kmerge_temp1_4_q0,
        multi_radix_oct_kmerge_temp1_5_address0,
        multi_radix_oct_kmerge_temp1_5_ce0,
        multi_radix_oct_kmerge_temp1_5_q0
);
...
output   multi_radix_oct_kmerge_temp2_2_we0;
output  [31:0] multi_radix_oct_kmerge_temp2_2_d0;
output  [17:0] multi_radix_oct_kmerge_temp1_4_address0;
output   multi_radix_oct_kmerge_temp1_4_ce0;
input  [31:0] multi_radix_oct_kmerge_temp1_4_q0;
output  [17:0] multi_radix_oct_kmerge_temp1_5_address0;
output   multi_radix_oct_kmerge_temp1_5_ce0;
input  [31:0] multi_radix_oct_kmerge_temp1_5_q0;

reg ap_idle;
reg multi_radix_oct_kmerge_temp2_2_ce0;
reg multi_radix_oct_kmerge_temp2_2_we0;
reg[31:0] multi_radix_oct_kmerge_temp2_2_d0;
reg[17:0] multi_radix_oct_kmerge_temp1_4_address0;
reg multi_radix_oct_kmerge_temp1_4_ce0;
reg[17:0] multi_radix_oct_kmerge_temp1_5_address0;
reg multi_radix_oct_kmerge_temp1_5_ce0;
...
reg   [18:0] multi_radix_oct_kmerge_temp2_2_addr_reg_292;
...
wire   [63:0] zext_ln130_3_fu_215_p1;
reg   [18:0] i_fu_34;
wire   [18:0] add_ln127_fu_132_p2;
wire    ap_loop_init;
reg   [18:0] ap_sig_allocacmp_i_146;
reg   [31:0] k_fu_38;
...
wire   [0:0] icmp_ln129_3_fu_149_p2;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln127_fu_126_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        multi_radix_oct_kmerge_temp2_2_addr_reg_292 <= zext_ln127_fu_138_p1;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_condition_113)) begin
        if ((1'd1 == and_ln129_fu_155_p2)) begin
            multi_radix_oct_kmerge_temp1_4_address0 = zext_ln130_fu_210_p1;
        end else if (((1'd0 == and_ln140_fu_167_p2) & (1'd0 == and_ln129_fu_155_p2))) begin
            multi_radix_oct_kmerge_temp1_4_address0 = zext_ln145_fu_173_p1;
        end else begin
            multi_radix_oct_kmerge_temp1_4_address0 = 'bx;
        end
    end else begin
        multi_radix_oct_kmerge_temp1_4_address0 = 'bx;
    end
...
always @ (*) begin
    if ((1'b1 == ap_condition_113)) begin
        if ((1'd1 == and_ln129_fu_155_p2)) begin
            multi_radix_oct_kmerge_temp1_5_address0 = zext_ln130_3_fu_215_p1;
        end else if (((1'd0 == and_ln129_fu_155_p2) & (1'd1 == and_ln140_fu_167_p2))) begin
            multi_radix_oct_kmerge_temp1_5_address0 = zext_ln141_fu_189_p1;
        end else begin
            multi_radix_oct_kmerge_temp1_5_address0 = 'bx;
        end
    end else begin
        multi_radix_oct_kmerge_temp1_5_address0 = 'bx;
    end
...
always @ (*) begin
    if ((((1'd0 == and_ln129_fu_155_p2) & (1'd1 == and_ln140_fu_167_p2) & (icmp_ln127_fu_126_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)) | ((1'd1 == and_ln129_fu_155_p2) & (icmp_ln127_fu_126_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
        multi_radix_oct_kmerge_temp1_5_ce0 = 1'b1;
    end else begin
        multi_radix_oct_kmerge_temp1_5_ce0 = 1'b0;
    end
end
...
always @ (*) begin
    if ((((1'd0 == and_ln129_reg_288) & (1'd1 == and_ln140_reg_297) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)) | ((1'd1 == and_ln129_reg_288) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln130_fu_225_p2 == 1'd0)))) begin
        multi_radix_oct_kmerge_temp2_2_d0 = multi_radix_oct_kmerge_temp1_5_q0;
        ...
        multi_radix_oct_kmerge_temp2_2_d0 = multi_radix_oct_kmerge_temp1_4_q0;
    end else begin
        multi_radix_oct_kmerge_temp2_2_d0 = 'bx;
    end
end

always @ (*) begin
    if ((((1'd0 == and_ln140_reg_297) & (1'd0 == and_ln129_reg_288) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)) | ((1'd0 == and_ln129_reg_288) & (1'd1 == and_ln140_reg_297) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)) | ((1'd1 == and_ln129_reg_288) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln130_fu_225_p2 == 1'd1)) | ((1'd1 == and_ln129_reg_288) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln130_fu_225_p2 == 1'd0)))) begin
        multi_radix_oct_kmerge_temp2_2_we0 = 1'b1;
    end else begin
        multi_radix_oct_kmerge_temp2_2_we0 = 1'b0;
    end
end
...
assign add_ln127_fu_132_p2 = (ap_sig_allocacmp_i_146 + 19'd1);

assign and_ln129_fu_155_p2 = (icmp_ln129_fu_143_p2 & icmp_ln129_3_fu_149_p2);

assign and_ln140_fu_167_p2 = (icmp_ln140_fu_161_p2 & icmp_ln129_3_fu_149_p2);
...
assign icmp_ln127_fu_126_p2 = ((ap_sig_allocacmp_i_146 == 19'd312500) ? 1'b1 : 1'b0);

assign icmp_ln129_3_fu_149_p2 = (($signed(ap_sig_allocacmp_k_116) < $signed(32'd156250)) ? 1'b1 : 1'b0);

assign icmp_ln129_fu_143_p2 = (($signed(ap_sig_allocacmp_j_118) < $signed(32'd156250)) ? 1'b1 : 1'b0);

assign icmp_ln130_fu_225_p2 = (($signed(multi_radix_oct_kmerge_temp1_4_q0) < $signed(multi_radix_oct_kmerge_temp1_5_q0)) ? 1'b1 : 1'b0);

assign icmp_ln140_fu_161_p2 = ((ap_sig_allocacmp_j_118 == 32'd156250) ? 1'b1 : 1'b0);
...
assign multi_radix_oct_kmerge_temp2_2_address0 = multi_radix_oct_kmerge_temp2_2_addr_reg_292;

assign zext_ln127_fu_138_p1 = ap_sig_allocacmp_i_146;

assign zext_ln130_3_fu_215_p1 = ap_sig_allocacmp_k_116;

assign zext_ln130_fu_210_p1 = ap_sig_allocacmp_j_118;

assign zext_ln141_fu_189_p1 = ap_sig_allocacmp_k_116;

assign zext_ln145_fu_173_p1 = ap_sig_allocacmp_j_118;

endmodule //multi_radix_oct_kmerge_merge_sort_batch1_97
