...
output  [18:0] multi_radix_oct_kmerge_temp1_5_address0;
...
reg[18:0] multi_radix_oct_kmerge_temp1_4_address0;
reg multi_radix_oct_kmerge_temp1_4_ce0;
reg[18:0] multi_radix_oct_kmerge_temp1_5_address0;
...
reg   [19:0] multi_radix_oct_kmerge_temp2_2_addr_reg_292;
...
wire    ap_loop_init;
reg   [19:0] ap_sig_allocacmp_i_146;
reg   [31:0] k_fu_38;
...
assign add_ln127_fu_132_p2 = (ap_sig_allocacmp_i_146 + 20'd1);
...
assign icmp_ln127_fu_126_p2 = ((ap_sig_allocacmp_i_146 == 20'd625000) ? 1'b1 : 1'b0);

assign icmp_ln129_3_fu_149_p2 = (($signed(ap_sig_allocacmp_k_116) < $signed(32'd312500)) ? 1'b1 : 1'b0);

assign icmp_ln129_fu_143_p2 = (($signed(ap_sig_allocacmp_j_118) < $signed(32'd312500)) ? 1'b1 : 1'b0);

assign icmp_ln130_fu_225_p2 = (($signed(multi_radix_oct_kmerge_temp1_4_q0) < $signed(multi_radix_oct_kmerge_temp1_5_q0)) ? 1'b1 : 1'b0);

assign icmp_ln140_fu_161_p2 = ((ap_sig_allocacmp_j_118 == 32'd312500) ? 1'b1 : 1'b0);
