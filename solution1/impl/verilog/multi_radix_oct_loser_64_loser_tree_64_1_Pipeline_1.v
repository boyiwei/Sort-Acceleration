...
module multi_radix_oct_loser_64_loser_tree_64_1_Pipeline_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] exitcond222_i_fu_992_p2;
reg    ap_condition_exit_pp0_iter0_stage0;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
reg   [6:0] empty_fu_276;
wire   [6:0] empty_271_fu_998_p2;
wire    ap_loop_init;
...
always @ (posedge ap_clk) begin
    if (((ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        if ((exitcond222_i_fu_992_p2 == 1'd0)) begin
            empty_fu_276 <= empty_271_fu_998_p2;
...
always @ (*) begin
    if (((ap_start_int == 1'b1) & (exitcond222_i_fu_992_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1))) begin
...
assign empty_271_fu_998_p2 = (ap_sig_allocacmp_p_load + 7'd1);

assign exitcond222_i_fu_992_p2 = ((ap_sig_allocacmp_p_load == 7'd64) ? 1'b1 : 1'b0);

endmodule //multi_radix_oct_loser_64_loser_tree_64_1_Pipeline_1
