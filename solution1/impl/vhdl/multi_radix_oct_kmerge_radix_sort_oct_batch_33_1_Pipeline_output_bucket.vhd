...
entity multi_radix_oct_kmerge_radix_sort_oct_batch_33_1_Pipeline_output_bucket is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of multi_radix_oct_kmerge_radix_sort_oct_batch_33_1_Pipeline_output_bucket is 
...
begin
    ...
    multi_radix_oct_kmerge_temp0_32_d0 <= bucket_q0;

    multi_radix_oct_kmerge_temp0_32_we0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            multi_radix_oct_kmerge_temp0_32_we0 <= ap_const_logic_1;
        else 
            multi_radix_oct_kmerge_temp0_32_we0 <= ap_const_logic_0;
        end if; 
    end process;
