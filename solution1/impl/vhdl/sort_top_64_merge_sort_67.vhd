...
entity sort_top_64_merge_sort_67 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of sort_top_64_merge_sort_67 is 
...
attribute shreg_extract : string;
    ...
    signal k_130_reg_249 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal j_130_reg_254 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal zext_ln10_33_fu_132_p1 : STD_LOGIC_VECTOR (63 downto 0);
...
begin
    ...
    add_ln9_fu_116_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_108) + unsigned(ap_const_lv19_1));
    and_ln12_fu_149_p2 <= (icmp_ln12_fu_137_p2 and icmp_ln12_33_fu_143_p2);
    and_ln25_fu_161_p2 <= (icmp_ln25_fu_155_p2 and icmp_ln12_33_fu_143_p2);
    ...
    ap_sig_allocacmp_i_108_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, i_fu_34, ap_loop_init, ap_start_int)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
            ap_sig_allocacmp_i_108 <= ap_const_lv19_0;
        else 
    ...
    ap_sig_allocacmp_j_130_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, ap_loop_init, j_01_fu_42, j_fu_215_p2, ap_start_int, ap_condition_259)
    begin
    ...
    ap_sig_allocacmp_k_130_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, ap_loop_init, k_02_fu_38, k_fu_205_p2, ap_start_int, ap_condition_263)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
            if (((ap_start_int = ap_const_logic_1) and (ap_loop_init = ap_const_logic_1))) then 
                ap_sig_allocacmp_k_130 <= ap_const_lv32_0;
            elsif ((ap_const_boolean_1 = ap_condition_263)) then 
    ...
    icmp_ln12_33_fu_143_p2 <= "1" when (signed(ap_sig_allocacmp_k_130) < signed(ap_const_lv32_2625A)) else "0";
    icmp_ln12_fu_137_p2 <= "1" when (signed(ap_sig_allocacmp_j_130) < signed(ap_const_lv32_2625A)) else "0";
    icmp_ln13_fu_199_p2 <= "1" when (signed(input1_q0) < signed(input2_q0)) else "0";
    icmp_ln25_fu_155_p2 <= "1" when (ap_sig_allocacmp_j_130 = ap_const_lv32_2625A) else "0";
    icmp_ln9_fu_110_p2 <= "1" when (ap_sig_allocacmp_i_108 = ap_const_lv19_4C4B4) else "0";
    ...
    input2_address0 <= zext_ln10_33_fu_132_p1(18 - 1 downto 0);
    ...
    j_131_fu_167_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_j_130) + unsigned(ap_const_lv32_1));
    j_fu_215_p2 <= std_logic_vector(unsigned(j_130_reg_254) + unsigned(ap_const_lv32_1));
    k_131_fu_178_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_k_130) + unsigned(ap_const_lv32_1));
    k_fu_205_p2 <= std_logic_vector(unsigned(k_130_reg_249) + unsigned(ap_const_lv32_1));
    ...
    zext_ln10_33_fu_132_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_k_130),64));
    zext_ln10_fu_127_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_j_130),64));
    zext_ln9_fu_122_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_i_108),64));
end behav;
