...
attribute shreg_extract : string;
    ...
    signal j_45_fu_136 : STD_LOGIC_VECTOR (16 downto 0);
    ...
    signal trunc_ln43_46_fu_512_p1 : STD_LOGIC_VECTOR (17 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln40_fu_397_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                    zext_ln41_45_reg_742(17 downto 0) <= zext_ln41_45_fu_419_p1(17 downto 0);
            end if;
        end if;
    end process;
    zext_ln41_45_reg_742(63 downto 18) <= "0000000000000000000000000000000000000000000000";
    ...
    bucket_address1 <= zext_ln41_45_fu_419_p1(18 - 1 downto 0);
    ...
    trunc_ln43_46_fu_512_p1 <= tmp_74_i_fu_490_p10(18 - 1 downto 0);
