...
entity sort_top_radix_sort_unified_bucket_1_1_Pipeline_output_bucket is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of sort_top_radix_sort_unified_bucket_1_1_Pipeline_output_bucket is 
...
attribute shreg_extract : string;
    ...
    signal ap_sig_allocacmp_k_2 : STD_LOGIC_VECTOR (19 downto 0);
...
begin
    ...
    add_ln50_fu_75_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_k_2) + unsigned(ap_const_lv20_1));
    ...
    begin
        if (((ap_loop_init = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            ap_sig_allocacmp_k_2 <= ap_const_lv20_0;
        else 
    ...
    icmp_ln50_fu_69_p2 <= "1" when (ap_sig_allocacmp_k_2 = ap_const_lv20_F4240) else "0";
    k_cast_fu_81_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_k_2),64));
