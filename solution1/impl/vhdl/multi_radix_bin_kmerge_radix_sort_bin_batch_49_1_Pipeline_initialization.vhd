...
entity multi_radix_bin_kmerge_radix_sort_bin_batch_49_1_Pipeline_initialization is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of multi_radix_bin_kmerge_radix_sort_bin_batch_49_1_Pipeline_initialization is 
...
attribute shreg_extract : string;
    ...
    signal j_21_reg_194 : STD_LOGIC_VECTOR (17 downto 0);
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal j_cast_i_fu_107_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_pp0_stage0 : BOOLEAN;
    signal zext_ln21_20_fu_134_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal bucket_sizes_156_fu_159_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal bucket_sizes_157_fu_167_p3 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    mux_21_32_1_1_U1683 : component multi_radix_bin_kmerge_mux_21_32_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 32,
    ...
    add_ln20_fu_101_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_j_21) + unsigned(ap_const_lv18_1));
    ...
    ap_sig_allocacmp_j_21_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, ap_loop_init, j_fu_44)
    begin
    ...
    bucket_address0 <= zext_ln21_20_fu_134_p1(19 - 1 downto 0);
    ...
    bucket_sizes_156_fu_159_p3 <= 
        bucket_sizes_fu_153_p2 when (trunc_ln23_fu_139_p1(0) = '1') else 
        bucket_sizes_286_out_i;
    bucket_sizes_157_fu_167_p3 <= 
        bucket_sizes_out_i when (trunc_ln23_fu_139_p1(0) = '1') else 
        bucket_sizes_fu_153_p2;

    bucket_sizes_286_out_o_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, bucket_sizes_286_out_i, ap_block_pp0_stage0, bucket_sizes_156_fu_159_p3, ap_loop_init)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
            if ((ap_loop_init = ap_const_logic_1)) then 
                bucket_sizes_286_out_o <= ap_const_lv32_0;
    ...
    bucket_sizes_286_out_o_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001, ap_loop_init)
    begin
        if ((((ap_loop_init = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0)) or ((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0)))) then 
            bucket_sizes_286_out_o_ap_vld <= ap_const_logic_1;
        else 
            bucket_sizes_286_out_o_ap_vld <= ap_const_logic_0;
        end if; 
    end process;

    bucket_sizes_fu_153_p2 <= std_logic_vector(unsigned(tmp_i_fu_143_p4) + unsigned(ap_const_lv32_1));

    bucket_sizes_out_o_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, bucket_sizes_out_i, ap_block_pp0_stage0, ap_loop_init, bucket_sizes_157_fu_167_p3)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
            if ((ap_loop_init = ap_const_logic_1)) then 
    ...
    icmp_ln20_fu_95_p2 <= "1" when (ap_sig_allocacmp_j_21 = ap_const_lv18_2625A) else "0";
    input_48_address0 <= j_cast_i_fu_107_p1(18 - 1 downto 0);
    ...
    j_cast_i_fu_107_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_j_21),64));
    trunc_ln23_fu_139_p1 <= input_48_q0(1 - 1 downto 0);
    zext_ln21_20_fu_134_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln21_fu_128_p2),64));
    zext_ln21_fu_125_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(j_21_reg_194),19));
end behav;
