...
attribute shreg_extract : string;
    ...
    signal multi_radix_oct_kmerge_temp2_9_addr_reg_292 : STD_LOGIC_VECTOR (18 downto 0);
    ...
    signal ap_sig_allocacmp_i_154 : STD_LOGIC_VECTOR (18 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln127_fu_126_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                multi_radix_oct_kmerge_temp2_9_addr_reg_292 <= zext_ln127_fu_138_p1(19 - 1 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    add_ln127_fu_132_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_154) + unsigned(ap_const_lv19_1));
    ...
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
            ap_sig_allocacmp_i_154 <= ap_const_lv19_0;
        else 
    ...
    icmp_ln127_fu_126_p2 <= "1" when (ap_sig_allocacmp_i_154 = ap_const_lv19_4C4B4) else "0";
    icmp_ln129_11_fu_149_p2 <= "1" when (signed(ap_sig_allocacmp_k_140) < signed(ap_const_lv32_2625A)) else "0";
    icmp_ln129_fu_143_p2 <= "1" when (signed(ap_sig_allocacmp_j_142) < signed(ap_const_lv32_2625A)) else "0";
    icmp_ln130_fu_225_p2 <= "1" when (signed(multi_radix_oct_kmerge_temp1_18_q0) < signed(multi_radix_oct_kmerge_temp1_19_q0)) else "0";
    icmp_ln140_fu_161_p2 <= "1" when (ap_sig_allocacmp_j_142 = ap_const_lv32_2625A) else "0";
    ...
    begin
        if ((ap_const_boolean_1 = ap_condition_113)) then
            if ((ap_const_lv1_1 = and_ln129_fu_155_p2)) then 
                multi_radix_oct_kmerge_temp1_18_address0 <= zext_ln130_fu_210_p1(18 - 1 downto 0);
            elsif (((ap_const_lv1_0 = and_ln140_fu_167_p2) and (ap_const_lv1_0 = and_ln129_fu_155_p2))) then 
                multi_radix_oct_kmerge_temp1_18_address0 <= zext_ln145_fu_173_p1(18 - 1 downto 0);
            else 
                multi_radix_oct_kmerge_temp1_18_address0 <= "XXXXXXXXXXXXXXXXXX";
            end if;
        else 
            multi_radix_oct_kmerge_temp1_18_address0 <= "XXXXXXXXXXXXXXXXXX";
        end if; 
    ...
    begin
        if ((ap_const_boolean_1 = ap_condition_113)) then
            if ((ap_const_lv1_1 = and_ln129_fu_155_p2)) then 
                multi_radix_oct_kmerge_temp1_19_address0 <= zext_ln130_11_fu_215_p1(18 - 1 downto 0);
            elsif (((ap_const_lv1_0 = and_ln129_fu_155_p2) and (ap_const_lv1_1 = and_ln140_fu_167_p2))) then 
                multi_radix_oct_kmerge_temp1_19_address0 <= zext_ln141_fu_189_p1(18 - 1 downto 0);
            else 
                multi_radix_oct_kmerge_temp1_19_address0 <= "XXXXXXXXXXXXXXXXXX";
            end if;
        else 
            multi_radix_oct_kmerge_temp1_19_address0 <= "XXXXXXXXXXXXXXXXXX";
        end if; 
