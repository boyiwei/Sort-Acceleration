...
entity multi_radix_bin_kmerge_merge_sort_batch0_93 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
    ...
    multi_radix_bin_kmerge_temp0_58_address0 : OUT STD_LOGIC_VECTOR (17 downto 0);
    multi_radix_bin_kmerge_temp0_58_ce0 : OUT STD_LOGIC;
    multi_radix_bin_kmerge_temp0_58_q0 : IN STD_LOGIC_VECTOR (31 downto 0);
    multi_radix_bin_kmerge_temp0_59_address0 : OUT STD_LOGIC_VECTOR (17 downto 0);
    multi_radix_bin_kmerge_temp0_59_ce0 : OUT STD_LOGIC;
    multi_radix_bin_kmerge_temp0_59_q0 : IN STD_LOGIC_VECTOR (31 downto 0);
    ...
    multi_radix_bin_kmerge_temp1_29_we0 : OUT STD_LOGIC;
    multi_radix_bin_kmerge_temp1_29_d0 : OUT STD_LOGIC_VECTOR (31 downto 0) );
end;


architecture behav of multi_radix_bin_kmerge_merge_sort_batch0_93 is 
...
attribute shreg_extract : string;
    ...
    signal k_161_reg_275 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal j_163_reg_280 : STD_LOGIC_VECTOR (31 downto 0);
    signal and_ln101_fu_155_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal and_ln101_reg_288 : STD_LOGIC_VECTOR (0 downto 0);
    signal multi_radix_bin_kmerge_temp1_29_addr_reg_292 : STD_LOGIC_VECTOR (18 downto 0);
    ...
    signal zext_ln102_2_fu_215_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal i_fu_34 : STD_LOGIC_VECTOR (18 downto 0);
    signal add_ln99_fu_132_p2 : STD_LOGIC_VECTOR (18 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_sig_allocacmp_i_161 : STD_LOGIC_VECTOR (18 downto 0);
    signal k_fu_38 : STD_LOGIC_VECTOR (31 downto 0);
    signal k_162_fu_231_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal k_163_fu_194_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal icmp_ln102_fu_225_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_sig_allocacmp_k_161 : STD_LOGIC_VECTOR (31 downto 0);
    signal j_fu_42 : STD_LOGIC_VECTOR (31 downto 0);
    signal j_164_fu_241_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal j_165_fu_178_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_sig_allocacmp_j_163 : STD_LOGIC_VECTOR (31 downto 0);
    signal icmp_ln101_fu_143_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln101_2_fu_149_p2 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln99_fu_126_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                multi_radix_bin_kmerge_temp1_29_addr_reg_292 <= zext_ln99_fu_138_p1(19 - 1 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    add_ln99_fu_132_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_161) + unsigned(ap_const_lv19_1));
    and_ln101_fu_155_p2 <= (icmp_ln101_fu_143_p2 and icmp_ln101_2_fu_149_p2);
    and_ln112_fu_167_p2 <= (icmp_ln112_fu_161_p2 and icmp_ln101_2_fu_149_p2);
    ...
    ap_sig_allocacmp_i_161_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, i_fu_34, ap_loop_init, ap_start_int)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
            ap_sig_allocacmp_i_161 <= ap_const_lv19_0;
        else 
    ...
    ap_sig_allocacmp_j_163_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, ap_loop_init, j_fu_42, j_164_fu_241_p2, ap_start_int, ap_condition_278)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
            if (((ap_start_int = ap_const_logic_1) and (ap_loop_init = ap_const_logic_1))) then 
                ap_sig_allocacmp_j_163 <= ap_const_lv32_0;
            elsif ((ap_const_boolean_1 = ap_condition_278)) then 
    ...
    ap_sig_allocacmp_k_161_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, ap_loop_init, k_fu_38, k_162_fu_231_p2, ap_start_int, ap_condition_282)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
            if (((ap_start_int = ap_const_logic_1) and (ap_loop_init = ap_const_logic_1))) then 
                ap_sig_allocacmp_k_161 <= ap_const_lv32_0;
            elsif ((ap_const_boolean_1 = ap_condition_282)) then 
    ...
    icmp_ln101_2_fu_149_p2 <= "1" when (signed(ap_sig_allocacmp_k_161) < signed(ap_const_lv32_2625A)) else "0";
    icmp_ln101_fu_143_p2 <= "1" when (signed(ap_sig_allocacmp_j_163) < signed(ap_const_lv32_2625A)) else "0";
    icmp_ln102_fu_225_p2 <= "1" when (signed(multi_radix_bin_kmerge_temp0_58_q0) < signed(multi_radix_bin_kmerge_temp0_59_q0)) else "0";
    icmp_ln112_fu_161_p2 <= "1" when (ap_sig_allocacmp_j_163 = ap_const_lv32_2625A) else "0";
    icmp_ln99_fu_126_p2 <= "1" when (ap_sig_allocacmp_i_161 = ap_const_lv19_4C4B4) else "0";
    j_164_fu_241_p2 <= std_logic_vector(unsigned(j_163_reg_280) + unsigned(ap_const_lv32_1));
    j_165_fu_178_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_j_163) + unsigned(ap_const_lv32_1));
    k_162_fu_231_p2 <= std_logic_vector(unsigned(k_161_reg_275) + unsigned(ap_const_lv32_1));
    k_163_fu_194_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_k_161) + unsigned(ap_const_lv32_1));

    multi_radix_bin_kmerge_temp0_58_address0_assign_proc : process(and_ln101_fu_155_p2, and_ln112_fu_167_p2, zext_ln117_fu_173_p1, zext_ln102_fu_210_p1, ap_condition_113)
    begin
        if ((ap_const_boolean_1 = ap_condition_113)) then
            if ((ap_const_lv1_1 = and_ln101_fu_155_p2)) then 
                multi_radix_bin_kmerge_temp0_58_address0 <= zext_ln102_fu_210_p1(18 - 1 downto 0);
            elsif (((ap_const_lv1_0 = and_ln112_fu_167_p2) and (ap_const_lv1_0 = and_ln101_fu_155_p2))) then 
                multi_radix_bin_kmerge_temp0_58_address0 <= zext_ln117_fu_173_p1(18 - 1 downto 0);
            else 
                multi_radix_bin_kmerge_temp0_58_address0 <= "XXXXXXXXXXXXXXXXXX";
            end if;
        else 
            multi_radix_bin_kmerge_temp0_58_address0 <= "XXXXXXXXXXXXXXXXXX";
        end if; 
    ...
    multi_radix_bin_kmerge_temp0_58_ce0_assign_proc : process(ap_CS_fsm_pp0_stage0, icmp_ln99_fu_126_p2, ap_block_pp0_stage0_11001, and_ln101_fu_155_p2, and_ln112_fu_167_p2, ap_start_int)
    begin
        if ((((ap_const_lv1_0 = and_ln112_fu_167_p2) and (ap_const_lv1_0 = and_ln101_fu_155_p2) and (icmp_ln99_fu_126_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0)) or ((ap_const_lv1_1 = and_ln101_fu_155_p2) and (icmp_ln99_fu_126_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0)))) then 
            multi_radix_bin_kmerge_temp0_58_ce0 <= ap_const_logic_1;
        else 
            multi_radix_bin_kmerge_temp0_58_ce0 <= ap_const_logic_0;
        end if; 
    end process;


    multi_radix_bin_kmerge_temp0_59_address0_assign_proc : process(and_ln101_fu_155_p2, and_ln112_fu_167_p2, zext_ln113_fu_189_p1, zext_ln102_2_fu_215_p1, ap_condition_113)
    begin
        if ((ap_const_boolean_1 = ap_condition_113)) then
            if ((ap_const_lv1_1 = and_ln101_fu_155_p2)) then 
                multi_radix_bin_kmerge_temp0_59_address0 <= zext_ln102_2_fu_215_p1(18 - 1 downto 0);
            elsif (((ap_const_lv1_0 = and_ln101_fu_155_p2) and (ap_const_lv1_1 = and_ln112_fu_167_p2))) then 
                multi_radix_bin_kmerge_temp0_59_address0 <= zext_ln113_fu_189_p1(18 - 1 downto 0);
            else 
                multi_radix_bin_kmerge_temp0_59_address0 <= "XXXXXXXXXXXXXXXXXX";
            end if;
        else 
            multi_radix_bin_kmerge_temp0_59_address0 <= "XXXXXXXXXXXXXXXXXX";
        end if; 
    ...
    multi_radix_bin_kmerge_temp0_59_ce0_assign_proc : process(ap_CS_fsm_pp0_stage0, icmp_ln99_fu_126_p2, ap_block_pp0_stage0_11001, and_ln101_fu_155_p2, and_ln112_fu_167_p2, ap_start_int)
    begin
        if ((((ap_const_lv1_0 = and_ln101_fu_155_p2) and (ap_const_lv1_1 = and_ln112_fu_167_p2) and (icmp_ln99_fu_126_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0)) or ((ap_const_lv1_1 = and_ln101_fu_155_p2) and (icmp_ln99_fu_126_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0)))) then 
            multi_radix_bin_kmerge_temp0_59_ce0 <= ap_const_logic_1;
        else 
            multi_radix_bin_kmerge_temp0_59_ce0 <= ap_const_logic_0;
        end if; 
    end process;

    multi_radix_bin_kmerge_temp1_29_address0 <= multi_radix_bin_kmerge_temp1_29_addr_reg_292;

    multi_radix_bin_kmerge_temp1_29_ce0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001, and_ln101_reg_288, and_ln112_reg_297, icmp_ln102_fu_225_p2)
    begin
    ...
    multi_radix_bin_kmerge_temp1_29_d0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, multi_radix_bin_kmerge_temp0_58_q0, multi_radix_bin_kmerge_temp0_59_q0, and_ln101_reg_288, and_ln112_reg_297, ap_block_pp0_stage0, icmp_ln102_fu_225_p2)
    begin
        if ((((ap_const_lv1_0 = and_ln101_reg_288) and (ap_const_lv1_1 = and_ln112_reg_297) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0)) or ((ap_const_lv1_1 = and_ln101_reg_288) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln102_fu_225_p2 = ap_const_lv1_0)))) then 
            ...
            multi_radix_bin_kmerge_temp1_29_d0 <= "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX";
        end if; 
    end process;


    multi_radix_bin_kmerge_temp1_29_we0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001, and_ln101_reg_288, and_ln112_reg_297, icmp_ln102_fu_225_p2)
    begin
        if ((((ap_const_lv1_0 = and_ln112_reg_297) and (ap_const_lv1_0 = and_ln101_reg_288) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0)) or ((ap_const_lv1_0 = and_ln101_reg_288) and (ap_const_lv1_1 = and_ln112_reg_297) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0)) or ((ap_const_lv1_1 = and_ln101_reg_288) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln102_fu_225_p2 = ap_const_lv1_1)) or ((ap_const_lv1_1 = and_ln101_reg_288) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln102_fu_225_p2 = ap_const_lv1_0)))) then 
            multi_radix_bin_kmerge_temp1_29_we0 <= ap_const_logic_1;
        else 
            multi_radix_bin_kmerge_temp1_29_we0 <= ap_const_logic_0;
        end if; 
    end process;

    zext_ln102_2_fu_215_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_k_161),64));
    zext_ln102_fu_210_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_j_163),64));
    zext_ln113_fu_189_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_k_161),64));
    zext_ln117_fu_173_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_j_163),64));
    zext_ln99_fu_138_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_i_161),64));
end behav;
