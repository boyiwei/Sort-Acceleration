...
attribute shreg_extract : string;
    ...
    signal multi_radix_oct_kmerge_temp2_14_addr_reg_292 : STD_LOGIC_VECTOR (19 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln127_fu_126_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                multi_radix_oct_kmerge_temp2_14_addr_reg_292 <= zext_ln127_fu_138_p1(20 - 1 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if ((ap_const_boolean_1 = ap_condition_113)) then
            if ((ap_const_lv1_1 = and_ln129_fu_155_p2)) then 
                multi_radix_oct_kmerge_temp1_28_address0 <= zext_ln130_fu_210_p1(19 - 1 downto 0);
            elsif (((ap_const_lv1_0 = and_ln140_fu_167_p2) and (ap_const_lv1_0 = and_ln129_fu_155_p2))) then 
                multi_radix_oct_kmerge_temp1_28_address0 <= zext_ln145_fu_173_p1(19 - 1 downto 0);
            else 
                multi_radix_oct_kmerge_temp1_28_address0 <= "XXXXXXXXXXXXXXXXXXX";
            end if;
        else 
            multi_radix_oct_kmerge_temp1_28_address0 <= "XXXXXXXXXXXXXXXXXXX";
        end if; 
    ...
    begin
        if ((ap_const_boolean_1 = ap_condition_113)) then
            if ((ap_const_lv1_1 = and_ln129_fu_155_p2)) then 
                multi_radix_oct_kmerge_temp1_29_address0 <= zext_ln130_6_fu_215_p1(19 - 1 downto 0);
            elsif (((ap_const_lv1_0 = and_ln129_fu_155_p2) and (ap_const_lv1_1 = and_ln140_fu_167_p2))) then 
                multi_radix_oct_kmerge_temp1_29_address0 <= zext_ln141_fu_189_p1(19 - 1 downto 0);
            else 
                multi_radix_oct_kmerge_temp1_29_address0 <= "XXXXXXXXXXXXXXXXXXX";
            end if;
        else 
            multi_radix_oct_kmerge_temp1_29_address0 <= "XXXXXXXXXXXXXXXXXXX";
        end if; 
