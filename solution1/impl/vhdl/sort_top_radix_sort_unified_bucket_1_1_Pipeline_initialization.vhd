...
entity sort_top_radix_sort_unified_bucket_1_1_Pipeline_initialization is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of sort_top_radix_sort_unified_bucket_1_1_Pipeline_initialization is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln17_fu_118_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_condition_exit_pp0_iter0_stage0 : STD_LOGIC;
    signal ap_loop_exit_ready : STD_LOGIC;
    signal ap_ready_int : STD_LOGIC;
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal j_cast_fu_130_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal j_cast_reg_210 : STD_LOGIC_VECTOR (63 downto 0);
    signal bucket_sizes_addr_reg_220 : STD_LOGIC_VECTOR (3 downto 0);
    signal addr_cmp_fu_152_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal addr_cmp_reg_226 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                bucket_sizes_addr_reg_220 <= zext_ln20_fu_144_p1(4 - 1 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln17_fu_118_p2)
    begin
        if (((icmp_ln17_fu_118_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    bucket_sizes_address0 <= bucket_sizes_addr_reg_220;
    bucket_sizes_address1 <= zext_ln20_fu_144_p1(4 - 1 downto 0);
    ...
    bucket_sizes_d0 <= std_logic_vector(unsigned(reuse_select_fu_166_p3) + unsigned(ap_const_lv32_1));
    ...
    j_cast_fu_130_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_j_3),64));
    next_ith_radix_fu_140_p1 <= input_r_q0(4 - 1 downto 0);
    reuse_select_fu_166_p3 <= 
        reuse_reg_fu_48 when (addr_cmp_reg_226(0) = '1') else 
        bucket_sizes_q1;
    sorted_data_address0 <= j_cast_reg_210(19 - 1 downto 0);
    ...
    zext_ln20_fu_144_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(next_ith_radix_fu_140_p1),64));
end behav;
