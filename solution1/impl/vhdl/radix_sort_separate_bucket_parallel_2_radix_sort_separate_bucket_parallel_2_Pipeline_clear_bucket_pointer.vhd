...
entity radix_sort_separate_bucket_parallel_2_radix_sort_separate_bucket_parallel_2_Pipeline_clear_bucket_pointer is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of radix_sort_separate_bucket_parallel_2_radix_sort_separate_bucket_parallel_2_Pipeline_clear_bucket_pointer is 
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                if ((icmp_ln59_fu_72_p2 = ap_const_lv1_0)) then 
                    n_fu_32 <= add_ln59_fu_78_p2;
    ...
    add_ln59_fu_78_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_n_1) + unsigned(ap_const_lv5_1));
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_state1, icmp_ln59_fu_72_p2, ap_start_int)
    begin
        if (((ap_start_int = ap_const_logic_1) and (icmp_ln59_fu_72_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    bucket_pointer1_we0_assign_proc : process(ap_CS_fsm_state1, icmp_ln59_fu_72_p2, ap_start_int)
    begin
        if (((ap_start_int = ap_const_logic_1) and (icmp_ln59_fu_72_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    bucket_pointer2_we0_assign_proc : process(ap_CS_fsm_state1, icmp_ln59_fu_72_p2, ap_start_int)
    begin
        if (((ap_start_int = ap_const_logic_1) and (icmp_ln59_fu_72_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    icmp_ln59_fu_72_p2 <= "1" when (ap_sig_allocacmp_n_1 = ap_const_lv5_10) else "0";
