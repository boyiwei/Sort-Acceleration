...
entity sort_top_32_merge_sort_35 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of sort_top_32_merge_sort_35 is 
...
attribute shreg_extract : string;
    ...
    signal ap_sig_allocacmp_i_70 : STD_LOGIC_VECTOR (19 downto 0);
...
begin
    ...
    add_ln9_fu_116_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_70) + unsigned(ap_const_lv20_1));
    ...
    ap_sig_allocacmp_i_70_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, i_fu_34, ap_loop_init, ap_start_int)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
            ap_sig_allocacmp_i_70 <= ap_const_lv20_0;
        else 
            ap_sig_allocacmp_i_70 <= i_fu_34;
        end if; 
    end process;
    ...
    icmp_ln12_27_fu_143_p2 <= "1" when (signed(ap_sig_allocacmp_k_86) < signed(ap_const_lv32_4C4B4)) else "0";
    icmp_ln12_fu_137_p2 <= "1" when (signed(ap_sig_allocacmp_j_86) < signed(ap_const_lv32_4C4B4)) else "0";
    icmp_ln13_fu_199_p2 <= "1" when (signed(input1_q0) < signed(input2_q0)) else "0";
    icmp_ln25_fu_155_p2 <= "1" when (ap_sig_allocacmp_j_86 = ap_const_lv32_4C4B4) else "0";
    icmp_ln9_fu_110_p2 <= "1" when (ap_sig_allocacmp_i_70 = ap_const_lv20_98968) else "0";
    ...
    input2_address0 <= zext_ln10_27_fu_132_p1(19 - 1 downto 0);
    ...
    zext_ln10_27_fu_132_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_k_86),64));
    zext_ln10_fu_127_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_j_86),64));
    zext_ln9_fu_122_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_i_70),64));
end behav;
