...
entity multi_radix_oct_loser_64_radix_sort_oct_batch_9_1_Pipeline_output_bucket is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of multi_radix_oct_loser_64_radix_sort_oct_batch_9_1_Pipeline_output_bucket is 
...
begin
    ...
    add_ln53_fu_75_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_k_1) + unsigned(ap_const_lv18_1));
    ...
    icmp_ln53_fu_69_p2 <= "1" when (ap_sig_allocacmp_k_1 = ap_const_lv18_2625A) else "0";
    k_cast_i_fu_81_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_k_1),64));
    multi_radix_oct_loser_64_temp0_8_address0 <= k_cast_i_reg_101(18 - 1 downto 0);
    ...
    multi_radix_oct_loser_64_temp0_8_d0 <= bucket_q0;

    multi_radix_oct_loser_64_temp0_8_we0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            multi_radix_oct_loser_64_temp0_8_we0 <= ap_const_logic_1;
        else 
            multi_radix_oct_loser_64_temp0_8_we0 <= ap_const_logic_0;
        end if; 
    end process;
