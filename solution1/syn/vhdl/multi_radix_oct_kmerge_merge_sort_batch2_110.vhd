...
attribute shreg_extract : string;
    ...
    signal multi_radix_oct_kmerge_temp3_0_addr_reg_292 : STD_LOGIC_VECTOR (20 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln155_fu_126_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                multi_radix_oct_kmerge_temp3_0_addr_reg_292 <= zext_ln155_fu_138_p1(21 - 1 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if ((ap_const_boolean_1 = ap_condition_113)) then
            if ((ap_const_lv1_1 = and_ln157_fu_155_p2)) then 
                multi_radix_oct_kmerge_temp2_0_address0 <= zext_ln158_fu_210_p1(20 - 1 downto 0);
            elsif (((ap_const_lv1_0 = and_ln168_fu_167_p2) and (ap_const_lv1_0 = and_ln157_fu_155_p2))) then 
                multi_radix_oct_kmerge_temp2_0_address0 <= zext_ln173_fu_173_p1(20 - 1 downto 0);
            else 
                multi_radix_oct_kmerge_temp2_0_address0 <= "XXXXXXXXXXXXXXXXXXXX";
            end if;
        else 
            multi_radix_oct_kmerge_temp2_0_address0 <= "XXXXXXXXXXXXXXXXXXXX";
        end if; 
    ...
    begin
        if ((ap_const_boolean_1 = ap_condition_113)) then
            if ((ap_const_lv1_1 = and_ln157_fu_155_p2)) then 
                multi_radix_oct_kmerge_temp2_1_address0 <= zext_ln158_7_fu_215_p1(20 - 1 downto 0);
            elsif (((ap_const_lv1_0 = and_ln157_fu_155_p2) and (ap_const_lv1_1 = and_ln168_fu_167_p2))) then 
                multi_radix_oct_kmerge_temp2_1_address0 <= zext_ln169_fu_189_p1(20 - 1 downto 0);
            else 
                multi_radix_oct_kmerge_temp2_1_address0 <= "XXXXXXXXXXXXXXXXXXXX";
            end if;
        else 
            multi_radix_oct_kmerge_temp2_1_address0 <= "XXXXXXXXXXXXXXXXXXXX";
        end if; 
