...
begin
    ...
    add_ln53_fu_75_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_k_1) + unsigned(ap_const_lv17_1));
    ...
    icmp_ln53_fu_69_p2 <= "1" when (ap_sig_allocacmp_k_1 = ap_const_lv17_1312D) else "0";
    k_cast_i_fu_81_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_k_1),64));
    multi_radix_oct_kmerge_temp0_8_address0 <= k_cast_i_reg_101(17 - 1 downto 0);
