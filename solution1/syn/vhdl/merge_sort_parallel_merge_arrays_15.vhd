...
entity merge_sort_parallel_merge_arrays_15 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of merge_sort_parallel_merge_arrays_15 is 
...
attribute shreg_extract : string;
    ...
    signal i3_70_reg_376 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal i_17_reg_384 : STD_LOGIC_VECTOR (23 downto 0);
    signal f2_53_reg_389 : STD_LOGIC_VECTOR (31 downto 0);
    signal f1_70_reg_395 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal i2_74_fu_306_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_loop_init_pp0_iter1_reg : STD_LOGIC;
    signal ap_sig_allocacmp_i2_72 : STD_LOGIC_VECTOR (31 downto 0);
    signal f1_69_fu_40 : STD_LOGIC_VECTOR (31 downto 0);
    signal i3_69_fu_314_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_sig_allocacmp_i3_70 : STD_LOGIC_VECTOR (31 downto 0);
    signal i_fu_44 : STD_LOGIC_VECTOR (23 downto 0);
    signal add_ln47_fu_165_p2 : STD_LOGIC_VECTOR (23 downto 0);
    signal ap_sig_allocacmp_i_17 : STD_LOGIC_VECTOR (23 downto 0);
    signal f2_01_fu_48 : STD_LOGIC_VECTOR (31 downto 0);
    signal f2_55_fu_291_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_sig_allocacmp_f2_53 : STD_LOGIC_VECTOR (31 downto 0);
    signal f1_02_fu_52 : STD_LOGIC_VECTOR (31 downto 0);
    signal f1_72_fu_299_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_sig_allocacmp_f1_70 : STD_LOGIC_VECTOR (31 downto 0);
    signal icmp_ln51_17_fu_205_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal icmp_ln60_17_fu_241_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal i2_75_fu_269_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal i3_68_fu_283_p3 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((ap_start_int = ap_const_logic_1) and (ap_loop_init = ap_const_logic_1))) then 
                    ...
                    f1_02_fu_52 <= f1_72_fu_299_p3;
                end if;
            end if; 
        end if;
    end process;

    f1_69_fu_40_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((ap_start_int = ap_const_logic_1) and (ap_loop_init = ap_const_logic_1))) then 
                    f1_69_fu_40 <= ap_const_lv32_8000;
                elsif (((icmp_ln47_reg_402 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1))) then 
                    f1_69_fu_40 <= i3_69_fu_314_p3;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((ap_start_int = ap_const_logic_1) and (ap_loop_init = ap_const_logic_1))) then 
                    f2_01_fu_48 <= ap_const_lv32_4000;
                elsif (((icmp_ln47_reg_402 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1))) then 
                    f2_01_fu_48 <= f2_55_fu_291_p3;
                end if;
            end if; 
        end if;
    end process;
        ...
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_1 = ap_condition_101)) then
                if ((icmp_ln47_reg_402 = ap_const_lv1_0)) then 
                    i2_13_fu_36 <= i2_74_fu_306_p3;
                elsif ((ap_loop_init_pp0_iter1_reg = ap_const_logic_1)) then 
                    i2_13_fu_36 <= ap_const_lv32_4000;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                f1_70_reg_395 <= ap_sig_allocacmp_f1_70;
                f2_53_reg_389 <= ap_sig_allocacmp_f2_53;
                i3_70_reg_376 <= ap_sig_allocacmp_i3_70;
                i_17_reg_384 <= ap_sig_allocacmp_i_17;
    ...
    add_ln47_fu_165_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_17) + unsigned(ap_const_lv24_1));
    and_ln51_fu_217_p2 <= (xor_ln51_fu_211_p2 and icmp_ln51_fu_200_p2);
    and_ln60_fu_246_p2 <= (icmp_ln60_fu_235_p2 and icmp_ln60_17_fu_241_p2);
    ...
    ap_phi_mux_f1_1_phi_fu_116_p4_assign_proc : process(f1_70_reg_395, icmp_ln47_reg_402, icmp_ln50_reg_411, and_ln51_fu_217_p2, f1_fu_229_p2, ap_phi_reg_pp0_iter1_f1_1_reg_113)
    begin
        if (((icmp_ln50_reg_411 = ap_const_lv1_0) and (ap_const_lv1_0 = and_ln51_fu_217_p2) and (icmp_ln47_reg_402 = ap_const_lv1_0))) then 
            ap_phi_mux_f1_1_phi_fu_116_p4 <= f1_70_reg_395;
    ...
    ap_phi_mux_f2_1_phi_fu_107_p4_assign_proc : process(f2_53_reg_389, icmp_ln47_reg_402, icmp_ln50_reg_411, ap_phi_reg_pp0_iter1_f2_1_reg_104, and_ln51_fu_217_p2, f2_fu_223_p2)
    begin
        if (((icmp_ln50_reg_411 = ap_const_lv1_0) and (ap_const_lv1_0 = and_ln51_fu_217_p2) and (icmp_ln47_reg_402 = ap_const_lv1_0))) then 
            ap_phi_mux_f2_1_phi_fu_107_p4 <= f2_fu_223_p2;
        elsif ((((icmp_ln50_reg_411 = ap_const_lv1_1) and (icmp_ln47_reg_402 = ap_const_lv1_0)) or ((icmp_ln47_reg_402 = ap_const_lv1_0) and (ap_const_lv1_1 = and_ln51_fu_217_p2)))) then 
            ap_phi_mux_f2_1_phi_fu_107_p4 <= f2_53_reg_389;
        else 
    ...
    ap_sig_allocacmp_f1_70_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, icmp_ln47_reg_402, ap_block_pp0_stage0, ap_loop_init, f1_02_fu_52, f1_72_fu_299_p3, ap_start_int)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
            if (((ap_start_int = ap_const_logic_1) and (ap_loop_init = ap_const_logic_1))) then 
                ap_sig_allocacmp_f1_70 <= ap_const_lv32_0;
            elsif (((icmp_ln47_reg_402 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1))) then 
                ap_sig_allocacmp_f1_70 <= f1_72_fu_299_p3;
            else 
                ap_sig_allocacmp_f1_70 <= f1_02_fu_52;
            end if;
        else 
            ap_sig_allocacmp_f1_70 <= f1_02_fu_52;
        end if; 
    ...
    ap_sig_allocacmp_f2_53_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, icmp_ln47_reg_402, ap_block_pp0_stage0, ap_loop_init, f2_01_fu_48, f2_55_fu_291_p3, ap_start_int)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
            if (((ap_start_int = ap_const_logic_1) and (ap_loop_init = ap_const_logic_1))) then 
                ap_sig_allocacmp_f2_53 <= ap_const_lv32_4000;
            elsif (((icmp_ln47_reg_402 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1))) then 
                ap_sig_allocacmp_f2_53 <= f2_55_fu_291_p3;
            else 
                ap_sig_allocacmp_f2_53 <= f2_01_fu_48;
            end if;
        else 
            ap_sig_allocacmp_f2_53 <= f2_01_fu_48;
        end if; 
    ...
    ap_sig_allocacmp_i2_72_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, i2_13_fu_36, ap_loop_init_pp0_iter1_reg)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init_pp0_iter1_reg = ap_const_logic_1))) then 
            ap_sig_allocacmp_i2_72 <= ap_const_lv32_4000;
        else 
            ap_sig_allocacmp_i2_72 <= i2_13_fu_36;
        end if; 
    end process;


    ap_sig_allocacmp_i3_70_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, icmp_ln47_reg_402, ap_block_pp0_stage0, ap_loop_init, f1_69_fu_40, i3_69_fu_314_p3, ap_start_int)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
            if (((ap_start_int = ap_const_logic_1) and (ap_loop_init = ap_const_logic_1))) then 
                ap_sig_allocacmp_i3_70 <= ap_const_lv32_8000;
            elsif (((icmp_ln47_reg_402 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1))) then 
                ap_sig_allocacmp_i3_70 <= i3_69_fu_314_p3;
            else 
                ap_sig_allocacmp_i3_70 <= f1_69_fu_40;
            end if;
        else 
            ap_sig_allocacmp_i3_70 <= f1_69_fu_40;
        end if; 
    ...
    ap_sig_allocacmp_i_17_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, ap_loop_init, i_fu_44, ap_start_int)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
            ap_sig_allocacmp_i_17 <= ap_const_lv24_0;
        else 
    ...
    f1_72_fu_299_p3 <= 
        i3_70_reg_376 when (and_ln60_fu_246_p2(0) = '1') else 
        ap_phi_mux_f1_1_phi_fu_116_p4;
    f1_fu_229_p2 <= std_logic_vector(unsigned(f1_70_reg_395) + unsigned(ap_const_lv32_1));
    f2_55_fu_291_p3 <= 
        i2_75_fu_269_p3 when (and_ln60_fu_246_p2(0) = '1') else 
        ap_phi_mux_f2_1_phi_fu_107_p4;
    f2_fu_223_p2 <= std_logic_vector(unsigned(f2_53_reg_389) + unsigned(ap_const_lv32_1));
    i2_74_fu_306_p3 <= 
        i2_75_fu_269_p3 when (and_ln60_fu_246_p2(0) = '1') else 
        ap_sig_allocacmp_i2_72;
    i2_75_fu_269_p3 <= 
        i2_fu_252_p2 when (icmp_ln64_fu_263_p2(0) = '1') else 
        ap_const_lv32_989680;
    i2_fu_252_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i2_72) + unsigned(ap_const_lv32_8000));
    i3_68_fu_283_p3 <= 
        i3_fu_258_p2 when (icmp_ln66_fu_277_p2(0) = '1') else 
        ap_const_lv32_989680;
    i3_69_fu_314_p3 <= 
        i3_68_fu_283_p3 when (and_ln60_fu_246_p2(0) = '1') else 
        i3_70_reg_376;
    i3_fu_258_p2 <= std_logic_vector(unsigned(i3_70_reg_376) + unsigned(ap_const_lv32_8000));
    icmp_ln47_fu_159_p2 <= "1" when (ap_sig_allocacmp_i_17 = ap_const_lv24_989680) else "0";
    icmp_ln50_fu_176_p2 <= "1" when (ap_sig_allocacmp_f2_53 = ap_sig_allocacmp_i3_70) else "0";
    icmp_ln51_17_fu_205_p2 <= "1" when (signed(in_r_q0) < signed(in_r_q1)) else "0";
    icmp_ln51_fu_200_p2 <= "1" when (signed(f1_70_reg_395) < signed(ap_sig_allocacmp_i2_72)) else "0";
    icmp_ln60_17_fu_241_p2 <= "1" when (ap_phi_mux_f2_1_phi_fu_107_p4 = i3_70_reg_376) else "0";
    icmp_ln60_fu_235_p2 <= "1" when (ap_phi_mux_f1_1_phi_fu_116_p4 = ap_sig_allocacmp_i2_72) else "0";
    ...
    xor_ln51_fu_211_p2 <= (icmp_ln51_17_fu_205_p2 xor ap_const_lv1_1);
    zext_ln47_fu_195_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_17_reg_384),64));
    zext_ln49_fu_171_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_f1_70),64));
    zext_ln50_fu_182_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_f2_53),64));
end behav;
