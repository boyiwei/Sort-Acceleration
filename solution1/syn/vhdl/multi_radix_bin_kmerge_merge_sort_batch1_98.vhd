...
entity multi_radix_bin_kmerge_merge_sort_batch1_98 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of multi_radix_bin_kmerge_merge_sort_batch1_98 is 
...
attribute shreg_extract : string;
    ...
    signal multi_radix_bin_kmerge_temp2_3_addr_reg_292 : STD_LOGIC_VECTOR (19 downto 0);
    ...
    signal zext_ln130_2_fu_215_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal i_fu_34 : STD_LOGIC_VECTOR (19 downto 0);
    signal add_ln127_fu_132_p2 : STD_LOGIC_VECTOR (19 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_sig_allocacmp_i_145 : STD_LOGIC_VECTOR (19 downto 0);
    ...
    signal icmp_ln129_2_fu_149_p2 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln127_fu_126_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                multi_radix_bin_kmerge_temp2_3_addr_reg_292 <= zext_ln127_fu_138_p1(20 - 1 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    add_ln127_fu_132_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_145) + unsigned(ap_const_lv20_1));
    and_ln129_fu_155_p2 <= (icmp_ln129_fu_143_p2 and icmp_ln129_2_fu_149_p2);
    and_ln140_fu_167_p2 <= (icmp_ln140_fu_161_p2 and icmp_ln129_2_fu_149_p2);
    ...
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
            ap_sig_allocacmp_i_145 <= ap_const_lv20_0;
        else 
    ...
    icmp_ln127_fu_126_p2 <= "1" when (ap_sig_allocacmp_i_145 = ap_const_lv20_98968) else "0";
    icmp_ln129_2_fu_149_p2 <= "1" when (signed(ap_sig_allocacmp_k_113) < signed(ap_const_lv32_4C4B4)) else "0";
    icmp_ln129_fu_143_p2 <= "1" when (signed(ap_sig_allocacmp_j_115) < signed(ap_const_lv32_4C4B4)) else "0";
    icmp_ln130_fu_225_p2 <= "1" when (signed(multi_radix_bin_kmerge_temp1_6_q0) < signed(multi_radix_bin_kmerge_temp1_7_q0)) else "0";
    icmp_ln140_fu_161_p2 <= "1" when (ap_sig_allocacmp_j_115 = ap_const_lv32_4C4B4) else "0";
    ...
    multi_radix_bin_kmerge_temp1_6_address0_assign_proc : process(and_ln129_fu_155_p2, and_ln140_fu_167_p2, zext_ln145_fu_173_p1, zext_ln130_fu_210_p1, ap_condition_113)
    begin
        if ((ap_const_boolean_1 = ap_condition_113)) then
            if ((ap_const_lv1_1 = and_ln129_fu_155_p2)) then 
                multi_radix_bin_kmerge_temp1_6_address0 <= zext_ln130_fu_210_p1(19 - 1 downto 0);
            elsif (((ap_const_lv1_0 = and_ln140_fu_167_p2) and (ap_const_lv1_0 = and_ln129_fu_155_p2))) then 
                multi_radix_bin_kmerge_temp1_6_address0 <= zext_ln145_fu_173_p1(19 - 1 downto 0);
            else 
                multi_radix_bin_kmerge_temp1_6_address0 <= "XXXXXXXXXXXXXXXXXXX";
            end if;
        else 
            multi_radix_bin_kmerge_temp1_6_address0 <= "XXXXXXXXXXXXXXXXXXX";
        end if; 
    ...
    multi_radix_bin_kmerge_temp1_6_ce0_assign_proc : process(ap_CS_fsm_pp0_stage0, icmp_ln127_fu_126_p2, ap_block_pp0_stage0_11001, and_ln129_fu_155_p2, and_ln140_fu_167_p2, ap_start_int)
    begin
    ...
    multi_radix_bin_kmerge_temp1_7_address0_assign_proc : process(and_ln129_fu_155_p2, and_ln140_fu_167_p2, zext_ln141_fu_189_p1, zext_ln130_2_fu_215_p1, ap_condition_113)
    begin
        if ((ap_const_boolean_1 = ap_condition_113)) then
            if ((ap_const_lv1_1 = and_ln129_fu_155_p2)) then 
                multi_radix_bin_kmerge_temp1_7_address0 <= zext_ln130_2_fu_215_p1(19 - 1 downto 0);
            elsif (((ap_const_lv1_0 = and_ln129_fu_155_p2) and (ap_const_lv1_1 = and_ln140_fu_167_p2))) then 
                multi_radix_bin_kmerge_temp1_7_address0 <= zext_ln141_fu_189_p1(19 - 1 downto 0);
            else 
                multi_radix_bin_kmerge_temp1_7_address0 <= "XXXXXXXXXXXXXXXXXXX";
            end if;
        else 
            multi_radix_bin_kmerge_temp1_7_address0 <= "XXXXXXXXXXXXXXXXXXX";
        end if; 
    ...
    multi_radix_bin_kmerge_temp1_7_ce0_assign_proc : process(ap_CS_fsm_pp0_stage0, icmp_ln127_fu_126_p2, ap_block_pp0_stage0_11001, and_ln129_fu_155_p2, and_ln140_fu_167_p2, ap_start_int)
    begin
    ...
    multi_radix_bin_kmerge_temp2_3_address0 <= multi_radix_bin_kmerge_temp2_3_addr_reg_292;

    multi_radix_bin_kmerge_temp2_3_ce0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001, and_ln129_reg_288, and_ln140_reg_297, icmp_ln130_fu_225_p2)
    begin
        if ((((ap_const_lv1_0 = and_ln140_reg_297) and (ap_const_lv1_0 = and_ln129_reg_288) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0)) or ((ap_const_lv1_0 = and_ln129_reg_288) and (ap_const_lv1_1 = and_ln140_reg_297) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0)) or ((ap_const_lv1_1 = and_ln129_reg_288) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln130_fu_225_p2 = ap_const_lv1_1)) or ((ap_const_lv1_1 = and_ln129_reg_288) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln130_fu_225_p2 = ap_const_lv1_0)))) then 
            multi_radix_bin_kmerge_temp2_3_ce0 <= ap_const_logic_1;
        else 
            multi_radix_bin_kmerge_temp2_3_ce0 <= ap_const_logic_0;
        end if; 
    end process;


    multi_radix_bin_kmerge_temp2_3_d0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, multi_radix_bin_kmerge_temp1_6_q0, multi_radix_bin_kmerge_temp1_7_q0, and_ln129_reg_288, and_ln140_reg_297, ap_block_pp0_stage0, icmp_ln130_fu_225_p2)
    begin
        if ((((ap_const_lv1_0 = and_ln129_reg_288) and (ap_const_lv1_1 = and_ln140_reg_297) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0)) or ((ap_const_lv1_1 = and_ln129_reg_288) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln130_fu_225_p2 = ap_const_lv1_0)))) then 
            multi_radix_bin_kmerge_temp2_3_d0 <= multi_radix_bin_kmerge_temp1_7_q0;
            ...
            multi_radix_bin_kmerge_temp2_3_d0 <= multi_radix_bin_kmerge_temp1_6_q0;
        else 
            multi_radix_bin_kmerge_temp2_3_d0 <= "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX";
        end if; 
    end process;


    multi_radix_bin_kmerge_temp2_3_we0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001, and_ln129_reg_288, and_ln140_reg_297, icmp_ln130_fu_225_p2)
    begin
        if ((((ap_const_lv1_0 = and_ln140_reg_297) and (ap_const_lv1_0 = and_ln129_reg_288) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0)) or ((ap_const_lv1_0 = and_ln129_reg_288) and (ap_const_lv1_1 = and_ln140_reg_297) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0)) or ((ap_const_lv1_1 = and_ln129_reg_288) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln130_fu_225_p2 = ap_const_lv1_1)) or ((ap_const_lv1_1 = and_ln129_reg_288) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln130_fu_225_p2 = ap_const_lv1_0)))) then 
            multi_radix_bin_kmerge_temp2_3_we0 <= ap_const_logic_1;
        else 
            multi_radix_bin_kmerge_temp2_3_we0 <= ap_const_logic_0;
        end if; 
    end process;

    zext_ln127_fu_138_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_i_145),64));
    zext_ln130_2_fu_215_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_k_113),64));
    zext_ln130_fu_210_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_j_115),64));
    zext_ln141_fu_189_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_k_113),64));
    zext_ln145_fu_173_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_j_115),64));
end behav;
