...
entity multi_radix_bin_kmerge_radix_sort_bin_batch_24_1_Pipeline_input_bucket is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of multi_radix_bin_kmerge_radix_sort_bin_batch_24_1_Pipeline_input_bucket is 
...
attribute shreg_extract : string;
    ...
    signal zext_ln41_47_fu_209_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal zext_ln41_47_reg_418 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_pp0_stage0 : BOOLEAN;
    signal zext_ln43_fu_283_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal bucket_sizes_370_fu_344_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal bucket_sizes_371_fu_352_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal bucket_pointer_230_fu_304_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal bucket_pointer_231_fu_312_p3 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal j_47_fu_70 : STD_LOGIC_VECTOR (17 downto 0);
    ...
    signal tmp_78_i_fu_264_p4 : STD_LOGIC_VECTOR (31 downto 0);
    signal trunc_ln43_47_fu_274_p1 : STD_LOGIC_VECTOR (18 downto 0);
    signal add_ln43_fu_278_p2 : STD_LOGIC_VECTOR (18 downto 0);
    signal bucket_pointer_fu_298_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_79_i_fu_328_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_fu_320_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_79_i_fu_328_p4 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    mux_21_32_1_1_U822 : component multi_radix_bin_kmerge_mux_21_32_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 32,
    ...
    mux_21_32_1_1_U823 : component multi_radix_bin_kmerge_mux_21_32_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 32,
    ...
    j_47_fu_70_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln40_fu_187_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                    zext_ln41_47_reg_418(18 downto 0) <= zext_ln41_47_fu_209_p1(18 downto 0);
            end if;
        end if;
    end process;
    zext_ln27_cast_reg_410(31 downto 5) <= "000000000000000000000000000";
    zext_ln41_47_reg_418(63 downto 19) <= "000000000000000000000000000000000000000000000";
    ...
    add_ln43_fu_278_p2 <= std_logic_vector(unsigned(mul_ln43) + unsigned(trunc_ln43_47_fu_274_p1));
    addr_cmp_fu_241_p2 <= "1" when (reuse_addr_reg_fu_62 = zext_ln41_47_reg_418) else "0";
    ...
    ap_sig_allocacmp_j_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, ap_loop_init, j_47_fu_70)
    begin
    ...
    bucket_address1 <= zext_ln41_47_fu_209_p1(19 - 1 downto 0);
    ...
    bucket_pointer_230_fu_304_p3 <= 
        bucket_pointer_fu_298_p2 when (trunc_ln43_fu_260_p1(0) = '1') else 
        bucket_pointer_466_out_i;
    bucket_pointer_231_fu_312_p3 <= 
        bucket_pointer_465_out_i when (trunc_ln43_fu_260_p1(0) = '1') else 
        bucket_pointer_fu_298_p2;

    bucket_pointer_465_out_o_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, bucket_pointer_463_reload, bucket_pointer_465_out_i, ap_block_pp0_stage0, ap_loop_init, bucket_pointer_231_fu_312_p3)
    begin
    ...
    bucket_pointer_465_out_o_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001, ap_loop_init)
    begin
        if ((((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0)) or ((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1)))) then 
            bucket_pointer_465_out_o_ap_vld <= ap_const_logic_1;
        else 
            bucket_pointer_465_out_o_ap_vld <= ap_const_logic_0;
        end if; 
    end process;


    bucket_pointer_466_out_o_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, bucket_pointer_464_reload, bucket_pointer_466_out_i, ap_block_pp0_stage0, ap_loop_init, bucket_pointer_230_fu_304_p3)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
            if ((ap_loop_init = ap_const_logic_1)) then 
    ...
    bucket_pointer_466_out_o_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001, ap_loop_init)
    begin
        if ((((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0)) or ((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1)))) then 
            bucket_pointer_466_out_o_ap_vld <= ap_const_logic_1;
        else 
            bucket_pointer_466_out_o_ap_vld <= ap_const_logic_0;
        end if; 
    end process;

    bucket_pointer_fu_298_p2 <= std_logic_vector(unsigned(tmp_78_i_fu_264_p4) + unsigned(ap_const_lv32_1));
    bucket_sizes_370_fu_344_p3 <= 
        bucket_sizes_fu_338_p2 when (tmp_fu_320_p3(0) = '1') else 
        bucket_sizes_702_out_i;
    bucket_sizes_371_fu_352_p3 <= 
        bucket_sizes_701_out_i when (tmp_fu_320_p3(0) = '1') else 
        bucket_sizes_fu_338_p2;

    bucket_sizes_701_out_o_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, bucket_sizes_697_reload, bucket_sizes_701_out_i, ap_block_pp0_stage0, ap_loop_init, bucket_sizes_371_fu_352_p3)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
            if ((ap_loop_init = ap_const_logic_1)) then 
    ...
    bucket_sizes_701_out_o_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001, ap_loop_init)
    begin
        if ((((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0)) or ((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1)))) then 
    ...
    bucket_sizes_702_out_o_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, bucket_sizes_698_reload, bucket_sizes_702_out_i, ap_block_pp0_stage0, bucket_sizes_370_fu_344_p3, ap_loop_init)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
            if ((ap_loop_init = ap_const_logic_1)) then 
    ...
    bucket_sizes_702_out_o_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001, ap_loop_init)
    begin
        if ((((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0)) or ((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1)))) then 
    ...
    bucket_sizes_fu_338_p2 <= std_logic_vector(unsigned(tmp_79_i_fu_328_p4) + unsigned(ap_const_lv32_1));
    ...
    tmp_79_i_fu_328_p3 <= shifted_fu_255_p2(1 downto 1);
    tmp_fu_320_p3 <= shifted_fu_255_p2(1 downto 1);
    trunc_ln43_47_fu_274_p1 <= tmp_78_i_fu_264_p4(19 - 1 downto 0);
    ...
    zext_ln41_47_fu_209_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln41_fu_203_p2),64));
