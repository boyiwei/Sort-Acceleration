...
entity sort_top_radix_sort_unified_bucket_1_1_Pipeline_input_bucket is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of sort_top_radix_sort_unified_bucket_1_1_Pipeline_input_bucket is 
...
attribute shreg_extract : string;
    ...
    signal j_2_fu_62 : STD_LOGIC_VECTOR (18 downto 0);
    signal add_ln39_fu_170_p2 : STD_LOGIC_VECTOR (18 downto 0);
    ...
    signal next_ith_radix_2_fu_214_p4 : STD_LOGIC_VECTOR (3 downto 0);
...
begin
    ...
    add_ln39_fu_170_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_j) + unsigned(ap_const_lv19_1));
    ...
    bucket_address0 <= zext_ln42_2_fu_253_p1(19 - 1 downto 0);
    ...
    icmp_ln39_fu_164_p2 <= "1" when (ap_sig_allocacmp_j = ap_const_lv19_7A120) else "0";
    ith_radix_fu_191_p1 <= shifted_fu_186_p2(4 - 1 downto 0);
    j_2_cast_fu_176_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_j),64));
    next_ith_radix_2_fu_214_p4 <= shifted_fu_186_p2(7 downto 4);
    ...
    sorted_data_address0 <= j_2_cast_fu_176_p1(19 - 1 downto 0);
    ...
    zext_ln42_2_fu_253_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(reuse_select10_fu_246_p3),64));
    zext_ln42_fu_195_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ith_radix_fu_191_p1),64));
    zext_ln46_fu_224_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(next_ith_radix_2_fu_214_p4),64));
end behav;
