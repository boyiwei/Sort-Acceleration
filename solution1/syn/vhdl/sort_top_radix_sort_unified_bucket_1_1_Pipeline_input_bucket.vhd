...
attribute shreg_extract : string;
    ...
    signal j_2_fu_62 : STD_LOGIC_VECTOR (19 downto 0);
    signal add_ln39_fu_170_p2 : STD_LOGIC_VECTOR (19 downto 0);
    signal ap_sig_allocacmp_j : STD_LOGIC_VECTOR (19 downto 0);
...
begin
    ...
    add_ln39_fu_170_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_j) + unsigned(ap_const_lv20_1));
    ...
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
            ap_sig_allocacmp_j <= ap_const_lv20_0;
        else 
            ap_sig_allocacmp_j <= j_2_fu_62;
        end if; 
    end process;

    bucket_address0 <= zext_ln42_2_fu_253_p1(20 - 1 downto 0);
    ...
    icmp_ln39_fu_164_p2 <= "1" when (ap_sig_allocacmp_j = ap_const_lv20_F4240) else "0";
