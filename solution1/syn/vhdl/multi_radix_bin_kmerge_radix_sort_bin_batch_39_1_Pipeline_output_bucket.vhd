...
entity multi_radix_bin_kmerge_radix_sort_bin_batch_39_1_Pipeline_output_bucket is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of multi_radix_bin_kmerge_radix_sort_bin_batch_39_1_Pipeline_output_bucket is 
...
attribute shreg_extract : string;
    ...
    signal k_31_reg_114 : STD_LOGIC_VECTOR (17 downto 0);
...
begin
    ...
    add_ln53_fu_77_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_k_31) + unsigned(ap_const_lv18_1));
    ...
    bucket_address0 <= zext_ln54_31_fu_93_p1(19 - 1 downto 0);
    ...
    icmp_ln53_fu_71_p2 <= "1" when (ap_sig_allocacmp_k_31 = ap_const_lv18_2625A) else "0";
    k_cast_i_fu_103_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(k_31_reg_114),64));
    multi_radix_bin_kmerge_temp0_38_address0 <= k_cast_i_fu_103_p1(18 - 1 downto 0);

    multi_radix_bin_kmerge_temp0_38_ce0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001)
    begin
    ...
    multi_radix_bin_kmerge_temp0_38_d0 <= bucket_q0;

    multi_radix_bin_kmerge_temp0_38_we0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            multi_radix_bin_kmerge_temp0_38_we0 <= ap_const_logic_1;
        else 
            multi_radix_bin_kmerge_temp0_38_we0 <= ap_const_logic_0;
        end if; 
    end process;

    zext_ln54_31_fu_93_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln54_fu_87_p2),64));
    zext_ln54_fu_83_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_k_31),19));
end behav;
