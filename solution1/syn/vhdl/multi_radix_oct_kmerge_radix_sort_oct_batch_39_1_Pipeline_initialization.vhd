...
attribute shreg_extract : string;
    ...
    signal j_32_reg_378 : STD_LOGIC_VECTOR (16 downto 0);
    ...
    signal ap_sig_allocacmp_j_32 : STD_LOGIC_VECTOR (16 downto 0);
...
begin
    ...
    add_ln20_fu_229_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_j_32) + unsigned(ap_const_lv17_1));
    ...
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
            ap_sig_allocacmp_j_32 <= ap_const_lv17_0;
        else 
            ap_sig_allocacmp_j_32 <= j_fu_88;
        end if; 
    end process;

    bucket_address0 <= zext_ln21_31_fu_286_p1(18 - 1 downto 0);
    ...
    icmp_ln20_fu_223_p2 <= "1" when (ap_sig_allocacmp_j_32 = ap_const_lv17_1312D) else "0";
    input_38_address0 <= j_cast_i_fu_235_p1(17 - 1 downto 0);
    ...
    zext_ln21_fu_277_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(j_32_reg_378),18));
end behav;
