...
begin
    ...
    add_ln50_fu_75_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_k_2) + unsigned(ap_const_lv19_1));
    ...
    icmp_ln50_fu_69_p2 <= "1" when (ap_sig_allocacmp_k_2 = ap_const_lv19_7A120) else "0";
