...
module multi_radix_hex_kmerge_radix_sort_batch_39_1_Pipeline_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
always @ (posedge ap_clk) begin
    if (((ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        if ((exitcond116_i_fu_272_p2 == 1'd0)) begin
            empty_fu_84 <= empty_203_fu_278_p2;
...
assign empty_203_fu_278_p2 = (ap_sig_allocacmp_p_load + 5'd1);

assign exitcond116_i_fu_272_p2 = ((ap_sig_allocacmp_p_load == 5'd16) ? 1'b1 : 1'b0);

endmodule //multi_radix_hex_kmerge_radix_sort_batch_39_1_Pipeline_1
