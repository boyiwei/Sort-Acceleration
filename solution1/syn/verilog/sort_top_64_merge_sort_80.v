...
module sort_top_64_merge_sort_80 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg    ap_ready_int;
reg   [31:0] k_104_reg_249;
reg    ap_block_pp0_stage0_11001;
reg   [31:0] j_104_reg_254;
...
wire    ap_loop_init;
reg   [18:0] ap_sig_allocacmp_i_95;
reg   [31:0] k_02_fu_38;
wire   [31:0] k_fu_205_p2;
wire   [31:0] k_105_fu_178_p2;
wire   [0:0] icmp_ln13_fu_199_p2;
reg   [31:0] ap_sig_allocacmp_k_104;
reg   [31:0] j_01_fu_42;
wire   [31:0] j_fu_215_p2;
wire   [31:0] j_105_fu_167_p2;
reg   [31:0] ap_sig_allocacmp_j_104;
...
assign add_ln9_fu_116_p2 = (ap_sig_allocacmp_i_95 + 19'd1);
...
assign icmp_ln12_20_fu_143_p2 = (($signed(ap_sig_allocacmp_k_104) < $signed(32'd156250)) ? 1'b1 : 1'b0);

assign icmp_ln12_fu_137_p2 = (($signed(ap_sig_allocacmp_j_104) < $signed(32'd156250)) ? 1'b1 : 1'b0);

assign icmp_ln13_fu_199_p2 = (($signed(input1_q0) < $signed(input2_q0)) ? 1'b1 : 1'b0);

assign icmp_ln25_fu_155_p2 = ((ap_sig_allocacmp_j_104 == 32'd156250) ? 1'b1 : 1'b0);

assign icmp_ln9_fu_110_p2 = ((ap_sig_allocacmp_i_95 == 19'd312500) ? 1'b1 : 1'b0);

assign input1_address0 = zext_ln10_fu_127_p1;

assign input2_address0 = zext_ln10_20_fu_132_p1;

assign j_105_fu_167_p2 = (ap_sig_allocacmp_j_104 + 32'd1);

assign j_fu_215_p2 = (j_104_reg_254 + 32'd1);

assign k_105_fu_178_p2 = (ap_sig_allocacmp_k_104 + 32'd1);

assign k_fu_205_p2 = (k_104_reg_249 + 32'd1);

assign sorted_data_address0 = sorted_data_addr_reg_276;

assign zext_ln10_20_fu_132_p1 = ap_sig_allocacmp_k_104;

assign zext_ln10_fu_127_p1 = ap_sig_allocacmp_j_104;

assign zext_ln9_fu_122_p1 = ap_sig_allocacmp_i_95;

endmodule //sort_top_64_merge_sort_80
