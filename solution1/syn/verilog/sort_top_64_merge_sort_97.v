...
module sort_top_64_merge_sort_97 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg    ap_ready_int;
reg   [18:0] i_78_reg_249;
reg    ap_block_pp0_stage0_11001;
reg   [31:0] k_70_reg_254;
reg   [31:0] j_70_reg_259;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        i_78_reg_249 <= ap_sig_allocacmp_i_78;
        j_70_reg_259 <= ap_sig_allocacmp_j_70;
        k_70_reg_254 <= ap_sig_allocacmp_k_70;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        ap_sig_allocacmp_i_78 = 19'd0;
    end else begin
        ap_sig_allocacmp_i_78 = i_fu_34;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_start_int == 1'b1) & (ap_loop_init == 1'b1))) begin
            ...
            ap_sig_allocacmp_j_70 = j_fu_215_p2;
        end else begin
            ap_sig_allocacmp_j_70 = j_01_fu_42;
        end
    end else begin
        ap_sig_allocacmp_j_70 = j_01_fu_42;
    end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_start_int == 1'b1) & (ap_loop_init == 1'b1))) begin
            ap_sig_allocacmp_k_70 = 32'd0;
        end else if ((1'b1 == ap_condition_261)) begin
            ap_sig_allocacmp_k_70 = k_fu_205_p2;
        end else begin
            ap_sig_allocacmp_k_70 = k_02_fu_38;
        end
    end else begin
        ap_sig_allocacmp_k_70 = k_02_fu_38;
    end
...
assign add_ln9_fu_117_p2 = (ap_sig_allocacmp_i_78 + 19'd1);

assign and_ln12_fu_145_p2 = (icmp_ln12_fu_133_p2 & icmp_ln12_3_fu_139_p2);

assign and_ln25_fu_157_p2 = (icmp_ln25_fu_151_p2 & icmp_ln12_3_fu_139_p2);
...
assign icmp_ln12_3_fu_139_p2 = (($signed(ap_sig_allocacmp_k_70) < $signed(32'd156250)) ? 1'b1 : 1'b0);

assign icmp_ln12_fu_133_p2 = (($signed(ap_sig_allocacmp_j_70) < $signed(32'd156250)) ? 1'b1 : 1'b0);

assign icmp_ln13_fu_199_p2 = (($signed(input1_q0) < $signed(input2_q0)) ? 1'b1 : 1'b0);

assign icmp_ln25_fu_151_p2 = ((ap_sig_allocacmp_j_70 == 32'd156250) ? 1'b1 : 1'b0);

assign icmp_ln9_fu_111_p2 = ((ap_sig_allocacmp_i_78 == 19'd312500) ? 1'b1 : 1'b0);

assign input1_address0 = zext_ln10_fu_123_p1;

assign input2_address0 = zext_ln10_3_fu_128_p1;

assign j_71_fu_163_p2 = (ap_sig_allocacmp_j_70 + 32'd1);

assign j_fu_215_p2 = (j_70_reg_259 + 32'd1);

assign k_71_fu_174_p2 = (ap_sig_allocacmp_k_70 + 32'd1);

assign k_fu_205_p2 = (k_70_reg_254 + 32'd1);

assign sorted_data_address0 = zext_ln9_fu_195_p1;

assign zext_ln10_3_fu_128_p1 = ap_sig_allocacmp_k_70;

assign zext_ln10_fu_123_p1 = ap_sig_allocacmp_j_70;

assign zext_ln9_fu_195_p1 = i_78_reg_249;

endmodule //sort_top_64_merge_sort_97
