...
module multi_radix_oct_loser_64_radix_sort_oct_batch_38_1_Pipeline_output_bucket (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg multi_radix_oct_loser_64_temp0_37_we0;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        multi_radix_oct_loser_64_temp0_37_we0 = 1'b1;
    end else begin
        multi_radix_oct_loser_64_temp0_37_we0 = 1'b0;
    end
end
...
assign multi_radix_oct_loser_64_temp0_37_address0 = k_cast_i_reg_101;

assign multi_radix_oct_loser_64_temp0_37_d0 = bucket_q0;

always @ (posedge ap_clk) begin
    k_cast_i_reg_101[63:18] <= 46'b0000000000000000000000000000000000000000000000;
end

endmodule //multi_radix_oct_loser_64_radix_sort_oct_batch_38_1_Pipeline_output_bucket
