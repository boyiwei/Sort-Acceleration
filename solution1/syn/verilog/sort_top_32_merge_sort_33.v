...
module sort_top_32_merge_sort_33 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg    ap_ready_int;
reg   [31:0] k_90_reg_249;
reg    ap_block_pp0_stage0_11001;
reg   [31:0] j_90_reg_254;
...
wire   [63:0] zext_ln10_29_fu_132_p1;
wire   [63:0] zext_ln9_fu_122_p1;
reg   [19:0] i_fu_34;
wire   [19:0] add_ln9_fu_116_p2;
wire    ap_loop_init;
reg   [19:0] ap_sig_allocacmp_i_72;
reg   [31:0] k_02_fu_38;
wire   [31:0] k_fu_205_p2;
wire   [31:0] k_91_fu_178_p2;
wire   [0:0] icmp_ln13_fu_199_p2;
reg   [31:0] ap_sig_allocacmp_k_90;
reg   [31:0] j_01_fu_42;
wire   [31:0] j_fu_215_p2;
wire   [31:0] j_91_fu_167_p2;
reg   [31:0] ap_sig_allocacmp_j_90;
wire   [0:0] icmp_ln12_fu_137_p2;
wire   [0:0] icmp_ln12_29_fu_143_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        j_90_reg_254 <= ap_sig_allocacmp_j_90;
        k_90_reg_249 <= ap_sig_allocacmp_k_90;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        ap_sig_allocacmp_i_72 = 20'd0;
    end else begin
        ap_sig_allocacmp_i_72 = i_fu_34;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_start_int == 1'b1) & (ap_loop_init == 1'b1))) begin
            ap_sig_allocacmp_j_90 = 32'd0;
        end else if ((1'b1 == ap_condition_259)) begin
            ap_sig_allocacmp_j_90 = j_fu_215_p2;
        end else begin
            ap_sig_allocacmp_j_90 = j_01_fu_42;
        end
    end else begin
        ap_sig_allocacmp_j_90 = j_01_fu_42;
    end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_start_int == 1'b1) & (ap_loop_init == 1'b1))) begin
            ap_sig_allocacmp_k_90 = 32'd0;
        end else if ((1'b1 == ap_condition_263)) begin
            ap_sig_allocacmp_k_90 = k_fu_205_p2;
        end else begin
            ap_sig_allocacmp_k_90 = k_02_fu_38;
        end
    end else begin
        ap_sig_allocacmp_k_90 = k_02_fu_38;
    end
...
assign add_ln9_fu_116_p2 = (ap_sig_allocacmp_i_72 + 20'd1);

assign and_ln12_fu_149_p2 = (icmp_ln12_fu_137_p2 & icmp_ln12_29_fu_143_p2);

assign and_ln25_fu_161_p2 = (icmp_ln25_fu_155_p2 & icmp_ln12_29_fu_143_p2);
...
assign icmp_ln12_29_fu_143_p2 = (($signed(ap_sig_allocacmp_k_90) < $signed(32'd312500)) ? 1'b1 : 1'b0);

assign icmp_ln12_fu_137_p2 = (($signed(ap_sig_allocacmp_j_90) < $signed(32'd312500)) ? 1'b1 : 1'b0);

assign icmp_ln13_fu_199_p2 = (($signed(input1_q0) < $signed(input2_q0)) ? 1'b1 : 1'b0);

assign icmp_ln25_fu_155_p2 = ((ap_sig_allocacmp_j_90 == 32'd312500) ? 1'b1 : 1'b0);

assign icmp_ln9_fu_110_p2 = ((ap_sig_allocacmp_i_72 == 20'd625000) ? 1'b1 : 1'b0);

assign input1_address0 = zext_ln10_fu_127_p1;

assign input2_address0 = zext_ln10_29_fu_132_p1;

assign j_91_fu_167_p2 = (ap_sig_allocacmp_j_90 + 32'd1);

assign j_fu_215_p2 = (j_90_reg_254 + 32'd1);

assign k_91_fu_178_p2 = (ap_sig_allocacmp_k_90 + 32'd1);

assign k_fu_205_p2 = (k_90_reg_249 + 32'd1);

assign sorted_data_address0 = sorted_data_addr_reg_276;

assign zext_ln10_29_fu_132_p1 = ap_sig_allocacmp_k_90;

assign zext_ln10_fu_127_p1 = ap_sig_allocacmp_j_90;

assign zext_ln9_fu_122_p1 = ap_sig_allocacmp_i_72;

endmodule //sort_top_32_merge_sort_33
